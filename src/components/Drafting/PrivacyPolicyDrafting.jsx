...
const PrivacyPolicyDrafting = () => {
  ...
  <a
    href="https://legal251.com/privacy-policy-drafting-online-hindi"
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      <div className="row">
        <div className="col-md-6">
          <p className="serviceamainheading">Privacy Policy</p>
          <p
            style={{
              fontFamily: '"Roboto"',
              marginTop: 18,
          ...
          >
            While running an online business showcasing a strict Privacy Policy
            is essential. So get your Privacy Policy (PRP) done with the experts
            at Legal251.
          </p>
          <br />
          <a href="#formpricediv">
              ...
              <div className="row">
                  ...
                  <center>
                    ...
                    >
                      <option
                        className="cities"
                        data-value=""
                        data-select2-id="select2-data-2-xj7m"
                      />
                    ...
                    <span
                      ...
                      dir="ltr"
                      data-select2-id="select2-data-1-ovfs"
                ...
                <div className="col-md-6">
                  <center>
                    ...
                    >
                      <sup style={{ lineHeight: "1.5" }} />₹ 2251.00
                    </p>
                    <p
                      style={{
                        fontFamily: '"Roboto"',
      ...
      <p className="aboutustext">
        A Privacy Policy is a set of statements that explains how an
        organization, institution, website, or mobile app will handle the
        personal information or data of the employee, client/customer, or users.
        If you are looking for someone to make Privacy Policies for you, we can
        certainly help!
        <br />
        Privacy Policy explains how an organization or agency will gather, use,
        disclose, and manage a customer or client's data or personal information
        in easy-to-understand language. As per the Privacy Act, every
        organization must have a clear and easy-to-understand privacy policy.
        And especially, if you are running a website or app that collects user's
        data such as name, DOB (date of birth), gender, email id, and more, the
        user shares online with you knowingly (or sometimes unknowingly). So, as
        a website or mobile app owner, you must do your part by having a
        detailed and easily accessible privacy policy.
        <br />
        However, regulating privacy policy is a big challenge with new websites
        popping up daily and customers located worldwide, and the privacy policy
        laws may vary from country to country. That's why you need expert
        guidance for drafting a privacy policy for your company, website or app.
      </p>
      <br />
      <br />
    </div>
  ...
  <div id="Howtoapply" className="page-section">
    ...
    <center>
      <img
        src="https://legal251.com/images/nda/Privacy Policy.png"
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Maintains Social Boundaries </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Limit Power</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Privacy Protection</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Respect for Individuals</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Reputation Management </p>
            </center>
          </div>
        </div>
      </div>
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Spreads Awareness </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Prevent Abuses</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Third-Party Compliances</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Higher Search Rankings</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Returning Visitors</p>
            </center>
          </div>
        </div>
      </div>
            ...
            <div className="col-md-2 Registrationprocesscol2">
              <center>
                <p className="Registrationprocesstext2 gstrtext2">
                  Our best legal experts are here to help you with document
            ...
            <div className="col-md-2 Registrationprocesscol3">
              <center>
                <p className="Registrationprocesstext3 gstrtext3">
                  ...
                  documents to draft your Privacy Policy.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol4">
              <center>
                <p className="Registrationprocesstext4 gstrtext4">
                  After eliminating all of the document necessities &amp;
                  required information, we will draft your Privacy Policy on
                  your behalf.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol5">
              <center>
                <p className="Registrationprocesstext5 gstrtext5">
                  We will share the Privacy Policy document after drafting. You
                  are supposed to wait until our expert reaches out to notify
                  you of completing the Privacy Policy.
                </p>
              </center>
            </div>
          </div>
          ...
          <div className="col-md-6 servicefaqcol1">
            ...
            >
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    A Privacy Policy is a legal document that outlines data
                    protection practices, including information such as: <br />
                    <li>Categories and types of personal data collected.</li>
                    <li>Methods of storage and security of the data.</li>
                    <li>If third parties have access to the data.</li>
                    <li>Reasons for the collection.</li>
                    <li>Method of collection used.</li>
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse2"
                    >
                      Q2. Do my websites need to have a privacy policy?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, you need to have a privacy policy for your website.
                    Users care about their privacy. If you collect personal
                    information from users, that the third-party services
                    require. That's why you need to include many laws in a
                    privacy policy explaining your data-handling practices on
                    your site.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse3"
                    >
                      Q3. Can I request a customer's email address without a
                      privacy policy?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    If you want to request a customer's email address, you must
                    have a privacy policy with details of what you will do with
                    the email address, as it also comes under users' personal
                    data.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse4"
                    >
                      Q4. Do I require a Lawyer to write my Privacy Policies?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    You don't necessarily require a lawyer to write privacy
                    policies for your company/website/app. You can do it
                    yourself with the help of available resources, data, and
                    expertise (online 'how-to' guide). However, you can take
                    help from a lawyer to write your privacy policies and having
                    a lawyer by your side will be more beneficial for your
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse5"
                    >
                      Q5. Do I need a Privacy Policy for my Small Business?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, as an owner, you need a privacy policy for your small
                    business to comply with privacy policy while protecting the
          ...
          <div className="col-md-6 servicefaqcol2">
            <div className="panel-group" id="accordion2">
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse21"
                    >
                      Q6. Where on my website can I post my privacy policy?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20192.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    There are many places to post your privacy policy on your
                    website, including sections like Legal Policies, Website
                    Footer, Banners and Pop-ups, Sign-up, Check-out, Top Level
                    Navigation, Landing Page, and Informational Section.
                    However, keep it visible, easy to find, and read.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse22"
                    >
                      Q7. Can I copy someone else's Privacy Policy?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    No. As two businesses cannot be the same, they have their
                    specialities and ways of doing business and dealing with
                    customers, which similarly goes with the privacy policies.
                    Also, a privacy policy is a copyright document, so you must
                    draft a unique privacy policy for your business.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse23"
                    >
                      Q8. Do I need to inform the users if I have changed the
                      privacy policies of my website?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, you have to inform the users of your website about the
                    changes you make in the website privacy policies so that
                    they can provide their consent or decline to do so.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse24"
                    >
                      Q9. How to notify the users about the change in the
                      privacy policies?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    You don't have to send them a ten-page message to inform
                    them about the changes you recently made in your privacy
                    policies. Instead, you can: <br />
                    <li>
                      Add a relevant update clause to your privacy policy.
                    </li>
                    <li>Use a pop-up notice on your website.</li>
                    <li>Send an email to announce the update</li>
                    <li>
                      Sending an email also works for businesses without a
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse25"
                    >
                      Q10. Do I need a privacy policy if I don't collect users'
                      data?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, because it's in the policy that your website or app
                    doesn't collect personal data. A privacy policy informs
                    users what data you collect or do not collect.
                  </div>
                </div>
              </div>
            </div>
