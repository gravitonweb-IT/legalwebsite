...
import PrivacyPolicyImg from "../../assests/images/DraftingImg/PrivacyPolicyImg.png";
...
const faqs = [
  {
    id: 1,
    question: "Q1. What is a Privacy Policy?",
    answer:
      "A privacy policy is a document that outlines how an organization collects, uses, and protects users' personal information on their website",
  },
  {
    id: 2,
    question: "Q2. Do my websites need to have a privacy policy?",
    answer:
      "Yes, you need to have a privacy policy for your website. Users care about their privacy. If you collect personal information from users, that the third-party services require.",
  },
  {
    id: 3,
    question: "Q3. Do I require a Lawyer to write my Privacy Policies?",
    answer:
      "You don't necessarily require a lawyer to write privacy policies for your company/website/app. You can do it yourself with the help of available resources, data, and expertise (online 'how-to' guide).",
  },
  {
    id: 4,
    question: "Q4. Do I need a Privacy Policy for my Small Business?",
    answer:
      "Yes, as an owner, you need a privacy policy for your small business to comply with privacy policy while protecting the rights of your users.",
  },
  {
    id: 5,
    question:
      "Q5. How to notify the users about the change in the privacy policies?",
    answer:
      "Send email notifications, update website banners, and provide clear information about changes in privacy policies to users.",
  },
  {
    id: 6,
    question:
      "Q6. Do I need to inform the users if I have changed the privacy policies of my website?",
    answer:
      "Yes, because it's in the policy that your website or app doesn't collect personal data. A privacy policy informs users what data you collect or do not collect.",
  },
];
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            ...
            obtained from individuals. It discloses data handling practices,
            consent mechanisms, and individuals' rights regarding their
            information. Privacy Policies are essential for legal compliance,
            fostering transparency, and establishing trust with users or
            customers by clearly communicating how their privacy is safeguarded.
          </p>
          <div className="mt-5">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          <div className="">
            ...
            <Check formType={"Privacy Policy Drafting"}/>
          </div>
          ...
          <div className="">
            ...
            <img src={PrivacyPolicyImg} className="w-3/4 h-auto"></img>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-10 mx-5 md:mx-20 lg:mx-28 mt-10 md:mt-14">
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Maintains Social Boundaries</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Limit Power</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Privacy Protection</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Respect for Individuals</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Reputation Management</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Spreads Awareness</h1>
        </div>
        ...
        <div className="bg-white shadow-lg p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Prevent Abuses</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Third-Party Compliances</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Higher Search Rankings</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Returning Visitors</h1>
        </div>
      </div>
      ...
      <div className="hidden lg:block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              After eliminating all of the document necessities & required
              information, we will draft your Privacy Policy on your behalf.
            </p>
          </div>
          <div class="flex  justify-center items-center col-span-3">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              We will share the Privacy Policy document after drafting. You are
              supposed to wait until our expert reaches out to notify you of
              completing the Privacy Policy.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                ...
                are supposed to wait until our expert reaches out to notify you
                of completing the Privacy Policy.
              </p>
            </div>
          </div>
        </div>
