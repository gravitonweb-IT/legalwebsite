...
import RentAgreementImg from "../../assests/images/DraftingImg/RentAgreementImg.png";
...
const faqs = [
  {
    id: 1,
    question:
      "Q1. What is a rent agreement?",
    answer:
      "A Rent Agreement is a legal contract between the landlord/lady and the tenant. It leads to a relationship related to renting a specific premise for a period of time.",
  },
  {
    id: 2,
    question:
    ...
    answer:
      "Rent review is the process in which the rent is reviewed every year.",
  },
  {
    id: 3,
    question: "Q3. What is a security deposit?",
    answer:
      "A security deposit is a lump sum amount mandatory to pay under the rent agreement as a token of guarantee that the tenant will be adhering to the timeline of the rent agreement and can be used to pay for any damage caused by the renter. ",
  },
  {
    id: 4,
    question: "Q4. Is Police Verification mandatory?",
    answer:
      "It is the legal duty of all the landlords/ladies to get the police verification done for the tenants following the Indian Penal Code-Section 188.",
  },
  {
    id: 5,
    question: "Q5. Should the Rent Agreement be notarized?",
    answer:
      "No, it is not compulsory to notarize the rental agreement in India.",
  },
  {
    id: 6,
    question: "Q6. Is insurance adopted in rent agreements?",
    answer:
      "Yes, generally, insurance in a rent agreement includes the insurance taken out for the agreement by the landlord.",
  },
];
const RentAgreement = () => {
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            A Rent Agreement consists of security deposits, information
            regarding the property, i.e., size, address, type, and duration of
            the agreement, and your monthly rent. Therefore, before signing it,
            you must make/read it carefully, including all the rules and
            clauses.So if you are new in town and moving into a rented property,
            or you are someone renting out your property for the first time and
            want someone to help you make your rental agreement, you are in the
            right place then! Let us know your requirements, and the aces of
            Legal257 will get it done for you.
          </p>
          <div className="mt-5">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          ...
          <div className="">
            ...
            <img src={RentAgreementImg} className="w-3/4 h-auto"></img>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-10 mx-5 md:mx-20 lg:mx-28 mt-10 md:mt-14">
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Minimizes Conflicts</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Acts As Address Proof</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Vehicle Registration</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Identity Proof</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Passport Making</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Legal Evidence</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Liquidity</h1>
        </div>
        ...
        <div className="bg-white shadow-lg p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Legal Security</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Suitability</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Immediate Effect</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Budget-Friendly</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28 mt-5 md:mt-14">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium ">
              ...
              to apply for your Rent Agreement at the Sub-registrar's office.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              ...
              Agreement will be provided to the applicant within 3-5 working
              days or early.
            </p>
          </div>
          <div class="flex  justify-center items-center col-span-3">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              ...
              let you know your agreement has been issued.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                ...
                to let you know your agreement has been issued.
              </p>
            </div>
          </div>
        </div>
