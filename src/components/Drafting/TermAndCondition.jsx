...
import Terms_ConditionImg from "../../assests/images/DraftingImg/Terms_Condition.png";
...
const faqs = [
  {
    id: 1,
    question: "Q1. What do you mean by Terms and Conditions?",
    answer:
      "Terms and Conditions are legal guidelines outlining rules, responsibilities, and agreements between parties, often on a website or service.",
  },
  {
    id: 2,
    question: "Q2. What type of businesses require Terms and Conditions?",
    answer:
      "All businesses benefit from Terms and Conditions, specifying rules, obligations, and user agreements, especially those operating online or providing services.",
  },
  {
    id: 3,
    question: "Q3. Are Terms and Conditions Legally Binding?",
    answer:
      "Yes, the Terms and Conditions are legally binding.",
  },
  {
    id: 4,
    question: "Q4. Can an employee refuse to change their contract?",
    answer:
      "No, Terms and Conditions are not legally required or mandatory. Hence they are optional.",
  },
  {
    id: 5,
    question: "Q5. Are Terms and Conditions a compulsory legal requirement?",
    answer:
  ...
  {
    id: 6,
    question: "Q6. Can Terms and Conditions be protected by copyright?",
    answer:
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            Terms and Conditions are a legal agreement that outlines the rules,
            rights, and responsibilities governing the use of a service or
            product. This document specifies user obligations, limitations of
            liability, dispute resolution mechanisms, and other key provisions.
            By accepting these terms, users agree to abide by the established
            rules, ensuring legal clarity, and protecting the interests of both
            parties involved in a transaction or interaction.
          </p>
          <div className="mt-5">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          ...
          <div className="">
            ...
            <img src={Terms_ConditionImg}></img>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-10 mx-5 md:mx-20 lg:mx-28 mt-10 md:mt-14">
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Avoid Legal Disputes</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Limitation of Liability</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Gives Clarity</h1>
        </div>
        ...
        <div className="bg-white shadow-lg p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Regulate User Behavior & Conduct</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Protect Business & Legal Rights</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Enforcement of Agreement</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28 mt-5 md:mt-14">
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              Our legal team will review all the documents you submit to lessen
              the chances of incorrect or misleading information to make the
              process smooth.
            </p>
          </div>
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium ">
              ...
              to apply for your Terms and Conditions document.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              ...
              you about completing your required document.
            </p>
          </div>
        </div>
      </div>
