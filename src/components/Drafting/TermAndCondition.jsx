...
const TermAndCondition = () => {
  ...
  <a
    href="https://legal251.com/terms-and-conditions-drafting-online-hindi"
  ...
  <div>
    ...
    >
      <hr className="animationhr" style={{ top: "-35px", height: "33.5px" }} />
    </div>
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      <div className="row">
        <div className="col-md-6">
          <p className="serviceamainheading">Terms and conditions</p>
          <p
            style={{
              fontFamily: '"Roboto"',
              marginTop: 18,
          ...
          >
            Let Legal251 tackle your Terms and Conditions (TNC), drafted and
            approved by experts covering all essential terms so that you can
            focus more on your business and not on the side hustles.
          </p>
          <br />
          <a href="#formpricediv">
                  ...
                  <center>
                    ...
                    >
                      <option
                        className="cities"
                        data-value=""
                        data-select2-id="select2-data-2-i10m"
                      />
                    ...
                    <span
                      ...
                      dir="ltr"
                      data-select2-id="select2-data-1-uie4"
      ...
      <p className="aboutustext">
        The Terms and Conditions Agreement is a contract between you and your
        customers regarding the usage of your services. If you want your
        customer to follow your service guidelines, you must be clear about it
        from the beginning. Get help from our legal experts to prepare the best
        T&amp;C Agreement today!
        <br />
        The Terms and Conditions agreement is also known as "General
        Conditions," "Legal Notes, "Terms of Use," or EULA ("End-User License
        Agreement"). A T&amp;C agreement acts as legal for you and your
        customers. Though having a terms &amp; conditions agreement is entirely
        optional, it can still be advantageous in building belief and mutual
        understanding between you and your customers/employees/users/. Also, it
        gives you the right to have the upper hand in any legal issue. So, with
        the help of our best legal experts, be future-ready according to your
        Terms &amp; Conditions!
      </p>
      <br />
      <br />
        ...
        <div className="col-md-2 col-xs-4  firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              ...
              />
              <p className="benefitscardtext"> Avoid Legal Disputes</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Limitation of Liability</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Gives Clarity</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Enforcement of Agreement</p>
            </center>
          </div>
        </div>
      </div>
            ...
            <div className="col-md-2 Registrationprocesscol1">
              <center>
                <p className="Registrationprocesstext1 gstrtext1">
                  Our legal team will review all the documents you submit to
            ...
            <div className="col-md-2 Registrationprocesscol3">
              <center>
                <p className="Registrationprocesstext3 gstrtext3">
                  ...
                  documents to apply for your Terms and Conditions document.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol4">
              <center>
                <p className="Registrationprocesstext4 gstrtext4">
                  After completion, we will provide you with all the documents
                  online.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol5">
              <center>
                <p className="Registrationprocesstext5 gstrtext5">
                  ...
                  inform you about completing your required document.
                </p>
              </center>
            </div>
          </div>
          ...
          <div className="col-md-6 servicefaqcol1">
            ...
            >
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse1"
                    >
                      1. What do you mean by "Terms and Conditions"?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    businesses and their customers. There are two main things a
                    T&amp;C agreement consists of: <br />
                    <li>
                      What customers can expect from the business, and What
                      businesses can expect from their customers
                    </li>
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse2"
                    >
                      Q2. What type of businesses require Terms and Conditions?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    While businesses can have the Terms &amp; Conditions
                    agreement, online businesses frequently use it, such as a
                    website, an app, a service and a SaaS (Software as a
                    Service) product.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse3"
                    >
                      Q3. Is there any difference between "Terms and Conditions"
                      and "Terms of Use"?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    <li>
                      Yes. "Terms and Conditions" and "Terms of Use" are mostly
                      the same but appear in different contexts.
                    </li>
                    <li>
                      While "Terms and Conditions" refer to an agreement that
                      governs the provisions of an ongoing service, the name
                      "Terms of Use" is commonly used for agreements governing
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse4"
                    >
                      Q4. Are Terms and Conditions a compulsory legal
                      requirement?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    No, Terms and Conditions are not legally required or
                    mandatory. Hence they are optional.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse5"
                    >
                      Q5. What should I include while writing my Terms and
                      Conditions?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The motive of having a Terms and Conditions agreement is to
                    protect your business and to allow you to set the rules
                    related to the usage of your product, including things like
                    governing law of contract, copyright conditions, and age
                    limit.
                  </div>
                </div>
              </div>
          ...
          <div className="col-md-6 servicefaqcol2">
            <div className="panel-group" id="accordion2">
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse21"
                    >
                      Q6. Can I change my Terms and Conditions?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20192.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    In some cases, yes. But, one cannot make changes frequently
                    in the Terms and Conditions unilaterally unless it is in the
                    contract. There's a clause that needs to be added in the
                    agreement about contract variation, requiring agreement by
                    both parties before making a change. Sometimes, a clause
                    already mentioned within the terms allows unilateral
                    amendments.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse22"
                    >
                      Q7. Where should I display Terms and Conditions on my
                      website?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    You must display the Terms and Conditions on your website to
                    be easily visible to the audience/users. It can be: <br />
                    <li>In the main menu</li>
                    <li>In the website footer</li>
                    <li>On check-out process</li>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse23"
                    >
                      Q8. Can Terms and Conditions be protected by copyright?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Terms and Conditions rely upon the nature of the business an
                    individual seeks to run, and they can fall under the
                    copyright. However, if anyone else reproduces the Terms and
                    Conditions, it's a copyright infringement.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse24"
                    >
                      Q9. Can an employee refuse to change their contract?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, you can refuse to accept a change or variation in your
                    contract's terms and conditions as an employee.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse25"
                    >
                      Q10. Are Terms and Conditions Legally Binding?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
