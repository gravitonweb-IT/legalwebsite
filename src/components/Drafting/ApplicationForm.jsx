...
import ApplicationImg from "../../assests/images/DraftingImg/ApplicationImg.png";
...
const faqs = [
  {
    id: 1,
    question:
      "Q1. What are the tips for optimizing the employment application form?",
    answer:
      "One can optimize the employment application form using tips like Highlighting job requirements, Use of proper formatting, and Optimizing your application forms for mobile devices.",
  },
  {
    id: 2,
    question: "Q2. Should employers use applications or resumes?",
    answer:
      "Employers may use both applications and resumes for a comprehensive evaluation of candidates' qualifications, skills, and experiences.",
  },
];
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            An application form in the legal context is a standardized document
            used to collect information for various legal purposes, such as
            employment, permits, or legal proceedings. It typically requests
            essential details from individuals, ensuring accurate and
            comprehensive data for assessment. Proper completion of an
            application form is crucial for legal compliance and the efficient
            processing of requests or applications in diverse legal scenarios.
          </p>
          <div className="mt-5">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          <div className="">
            ...
            <Check formType={"Application Form"}/>
          </div>
          ...
          <div className="">
            ...
            <img src={ApplicationImg} className="w-3/4 h-auto"></img>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-10 mx-5 md:mx-20 lg:mx-28 mt-10 md:mt-14">
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Adaptable</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Check Competency</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Increased Applicant Accuracy</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Convenient</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Easy Comparison</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Background Checks</h1>
        </div>
        ...
        <div className="bg-white shadow-lg p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Flexibility</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Consistency</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Cost Effective</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Wider Reach</h1>
        </div>
      </div>
      ...
      <div className="hidden lg:block">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28 mt-5 md:mt-14">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              Our best legal professionals are here to help you with document
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium ">
              ...
              to apply for your Application Form.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              After successfully verifying your application and documents, our
              expert will prepare the Application form you can download from
              Legal257's website or app.
            </p>
          </div>
          <div class="flex  justify-center items-center col-span-3">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              ...
              let you know your Application Form has been prepared.
            </p>
          </div>
        </div>
      </div>
