...
const ApplicationForm = () => {
  ...
  <a
    href="https://legal251.com/application-hindi"
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      <div className="row">
        <div className="col-md-6">
          <p className="serviceamainheading">Application Form</p>
          <p
            style={{
              fontFamily: '"Roboto"',
              marginTop: 18,
          ...
          >
            If you find creating or Filing an Application Form (APPF) difficult
            and tiring, let Legal251 help you.
          </p>
          <br />
          <a href="#formpricediv">
                  ...
                  <center>
                    ...
                    >
                      <option
                        className="cities"
                        data-value=""
                        data-select2-id="select2-data-2-q2b8"
                      />
                    ...
                    <span
                      ...
                      dir="ltr"
                      data-select2-id="select2-data-1-8sn5"
      ...
      <p className="aboutustext">
        It is time-consuming to fill out or make an Application Form
        independently because you have to look for every minute detail. That's
        why you need an expert in Application Form (APPF) issues who can always
        help.
        <br />
        An Application Form (APPF) is used to collect relevant and required
        information from the applicant. Whether Filing out an application form
        or creating one, you need to check for every detail subjected to the
        matter. And for most businesses, the application form is a minor test of
        the individual's ability to follow instructions, literacy, penmanship,
        and communication skills. A poorly drafted/completed application form
        may prevent the individual from being considered or might disqualify
        them altogether.
        <br />
        Lacking complete information also means chances of making mistakes are
        always there. Also, who will focus on your business's growth if you do
        all the jobs? It's time to make changes in the way you work. Let the
        best handle your application form-related issues to make it easy for
        you.
      </p>
      <br />
      <br />
  ...
  <div id="Howtoapply" className="page-section">
    ...
    <center>
      <img
        src="https://legal251.com/images/nda/Application Form.png"
        ...
        <div className="col-md-2 col-xs-4  firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              ...
              />
              <p className="benefitscardtext"> Adaptable</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              ...
              <p className="benefitscardtext">
                Quick Identification of Relevant Applicants
              </p>
            </center>
          </div>
        </div>
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Check Competency </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Increased Applicant Accuracy</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Convenient</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Easy Comparison</p>
            </center>
          </div>
        </div>
      </div>
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Background Checks</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Flexibility</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Consistency</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Cost Effective </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Wider Reach</p>
            </center>
          </div>
        </div>
      </div>
            ...
            <div className="col-md-2 Registrationprocesscol1">
              <center>
                <p className="Registrationprocesstext1 gstrtext1">
                  Our professionals will review all the documents you submit to
            ...
            <div className="col-md-2 Registrationprocesscol2">
              <center>
                <p className="Registrationprocesstext2 gstrtext2">
                  Our best legal professionals are here to help you with
            ...
            <div className="col-md-2 Registrationprocesscol3">
              <center>
                <p className="Registrationprocesstext3 gstrtext3">
                  ...
                  documents to apply for your Application Form.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol4">
              <center>
                <p className="Registrationprocesstext4 gstrtext4">
                  After successfully verifying your application and documents,
                  our expert will prepare the Application form you can download
                  from Legal251's website or app.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol5">
              <center>
                <p className="Registrationprocesstext5 gstrtext5">
                  ...
                  to let you know your Application Form has been prepared.
                </p>
              </center>
            </div>
          </div>
          ...
          <div className="col-md-6 servicefaqcol1">
            ...
            >
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse1"
                    >
                      1. What are the tips for optimizing the employment
                      application form?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    One can optimize the employment application form using tips
                    like Highlighting job requirements, Use of proper
                    formatting, and Optimizing your application forms for mobile
                    devices.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse2"
                    >
                      Q2. Should employers use applications or resumes?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    A well-prepared resume is all-inclusive, whereas a job
                    application is more concise and spots specific qualities you
                    are looking for as an employer. However, it's best to use
                    resumes and job applications while hiring for low-level
                    positions or when you are expecting many applicants. Use
                    applications to retrieve the essential information about
                    candidates.
                  </div>
                </div>
              </div>
