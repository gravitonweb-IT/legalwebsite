...
const Will = () => {
  ...
  <iframe
    ...
    data-load-time={1700125029562}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/367855087?random=1700125029551&cv=11&fst=1700125029551&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Fwill&ref=https%3A%2F%2Flegal251.com%2Fterms-and-conditions-drafting-online&label=3o2zCK68lbIDEO-LtK8B&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20Will&value=0&bttype=purchase&rdp=1&auid=1629897716.1699421317&fledge=1&capi=1&uaa=x86&uab=64&uafvl=Google%2520Chrome%3B119.0.6045.125%7CChromium%3B119.0.6045.125%7CNot%253FA_Brand%3B24.0.0.0&uamb=0&uap=Windows&uapv=15.0.0&uaw=0"
    ac3tq0ajx=""
  />
  <iframe
    allow="join-ad-interest-group"
    data-tagging-id="AW-11126145977/Remarketing Tag"
    data-load-time={1700125029576}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/11126145977?random=1700125029573&cv=11&fst=1700125029573&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Fwill&ref=https%3A%2F%2Flegal251.com%2Fterms-and-conditions-drafting-online&label=Remarketing%20Tag&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20Will&auid=1629897716.1699421317&fledge=1&uaa=x86&uab=64&uafvl=Google%2520Chrome%3B119.0.6045.125%7CChromium%3B119.0.6045.125%7CNot%253FA_Brand%3B24.0.0.0&uamb=0&uap=Windows&uapv=15.0.0&uaw=0"
    ac3tq0ajx=""
  />
  <div style={{ position: "relative", overflowX: "hidden" }}>
    ...
    <a
      href="https://legal251.com/will-hindi"
      ...
      <div className="servicemaindiv" style={{ marginTop: 7 }}>
        <div className="row">
          <div className="col-md-6">
            <p className="serviceamainheading">Will</p>
            <p
              style={{
                fontFamily: '"Roboto"',
                marginTop: 18,
            ...
            >
              Making a WILL (a written document) is a work of responsibility and
              needs detailing. Take help from our top legal experts to handle
              all your Will-related issues!
            </p>
            <br />
            <a href="#formpricediv">
                ...
                <div className="row">
                    ...
                    <center>
                      ...
                      >
                        <option
                          className="cities"
                          data-value=""
                          data-select2-id="select2-data-2-hn12"
                        />
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-1-h4pc"
                  ...
                  <div className="col-md-6">
                    <center>
                      ...
                      >
                        <sup style={{ lineHeight: "1.5" }} />₹ 551.00
                      </p>
                      <p
                        style={{
                          fontFamily: '"Roboto"',
        ...
        <p className="aboutustext">
          Are you constantly thinking of what will happen to your property and
          assets after you? Make a Will with the aces of Legal251 and be
          tension-free!
          <br />
          A Will is a legally obligatory document that accurately ensures what
          will happen to your property and assets after your demise. The Indian
          Succession Act 1925 says that anyone with a sound mind and 18+ years
          of age or who wants to bequeath their property to their close ones and
          for their comfort can make a will. In India, a Will can be either
          hand-written or typed. However, the 'typed' Will is more convincing if
          such situations arise. Especially if you have more than one legal
          heirs, the absence of a Will may result in complications and doubts.
          <br />
          An owner can cancel or revoke their Will anytime before their death.
          However, life is full of uncertainties. The biggest uncertainty is
          death. So, don't take a chance when you can make everything clear now.
          Contact Legal251 and let our aces handle all your Will-related issues!
        </p>
        <br />
        <br />
      </div>
    ...
    <div id="Howtoapply" className="page-section">
      ...
      <center>
        <img
          src="https://legal251.com/images/nda/Will.png"
          ...
          <div className="col-md-2 col-xs-4  firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                ...
                />
                <p className="benefitscardtext"> All Assets Revealed</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Fair Property Distribution</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Financial Security</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Diminise Legal Troubles</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Inventory of Assets</p>
              </center>
            </div>
          </div>
        </div>
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Less Stress &amp; Disputes</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Flexibility of Choice</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Funerary Instructions</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Less Inheritance Tax </p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Avoid Statutory Devolution </p>
              </center>
            </div>
          </div>
        </div>
              ...
              <div className="col-md-2 Registrationprocesscol2">
                <center>
                  <p className="Registrationprocesstext2 gstrtext2">
                    ...
                    requirements and Will necessities.{" "}
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscol3">
                <center>
                  <p className="Registrationprocesstext3 gstrtext3">
                    ...
                    documents to apply for your Will.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscol4">
                <center>
                  <p className="Registrationprocesstext4 gstrtext4">
                    After successfully verifying all your documents, the
                    applicant will get his Will within 5-6 months or with some
                    more delay.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscol5">
                <center>
                  <p className="Registrationprocesstext5 gstrtext5">
                    ...
                    you to let you know your Will has been generated.
                  </p>
                </center>
              </div>
            </div>
            ...
            <div className="col-md-6 servicefaqcol1">
              ...
              >
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse1"
                      >
                        1. What’s the need to make a Will?
                        <img
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      To distribute your assets according to your choices/wishes
                      and to prevent disputes amongst the legal heirs, you
                      should make a Will. A properly drafted Will helps
                      distribute assets in specified proportion amongst your
                      spouse, children, parents, and whosoever you want to
                      transfer it.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse2"
                      >
                        Q2. Who will get my assets and property if I die without
                        making a Will?
                        <img
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Your assets and property will be divided and distributed
                      as per the Succession Laws based on the deceased person’s
                      religion.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      You can make a Will anytime after attaining the age of 18
                      years. However, one should make a Will after getting
                      married and having children, as these factors considerably
                      drive the contents of a will.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse4"
                      >
                        Q4. What will happen if I don’t appoint an Executor?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      The court will appoint an administrator to carry out the
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse5"
                      >
                        Q5. Is it mandatory to register a Will?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      No. It is upon the testator if he wants to register his
                      Will or not. However, for a safe side, if a Will is
                      registered, it will be a documented proof safe in the
                      registrar's hands, as it cannot be tempered afterward.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6 servicefaqcol2">
              <div className="panel-group" id="accordion2">
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse21"
                      >
                        Q6. Who can be a witness to a Will?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20192.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Anyone aged 18+ years with a sound mind can be a witness
                      to the Will. However, it is recommended that one must not
                      have beneficiaries as witnesses.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse22"
                      >
                        Q7.If a single witness signs a Will, will it be valid?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      No, at least two witnesses should sign the Will to make it
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse23"
                      >
                        Q8. Can I update/change my Will?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Yes, you can change/update your will anytime by discarding
                      the old Will and drafting a new Will. If the Will is filed
                      before the registrar, then the agent(s) appointed by the
                      testator may apply for amending the registered Will.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse24"
                      >
                        Q9. Is Handwritten Will legal in India?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Yes, handwritten Wills are legal in India. However, it
                      should be comprehensive and should follow the criteria or
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse25"
                      >
                        Q10. Can a revoked Will be revived?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      According to Section 73 of the Indian Succession Act 1925,
                      a person can revive a revoked Will by re-executing it.
                    </div>
                  </div>
                </div>
              </div>
