...
import WillImg from "../../assests/images/DraftingImg/WillImg.png";
...
const faqs = [
  {
    id: 1,
    question: "Q1. What’s the need to make a Will?",
    answer:
  ...
  {
    id: 2,
    question: "Q2. When should I make a Will?",
    answer:
  ...
  {
    id: 3,
    question: "Q3. Is it mandatory to register a Will?",
    answer:
  ...
  {
    id: 6,
    question: "Q6. Who can be a witness to a Will?",
    answer:
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            A will is a legal document outlining an individual's wishes
            regarding the distribution of their assets and the care of
            dependents after their death. It designates an executor to carry out
            these instructions. A properly executed will ensures the deceased's
            intentions are honored and provides clarity, potentially avoiding
            legal disputes. It is a crucial component of estate planning,
            offering peace of mind and legal guidance for loved ones.
          </p>
          <div className="mt-5">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          ...
          <div className="">
            ...
            <img src={WillImg} className="w-3/4 h-auto mt-4"></img>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-10 mx-5 md:mx-20 lg:mx-28 mt-10 md:mt-14">
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">All Assets Revealed</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Fair Property Distribution</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Financial Security</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Appointing Guardians for Minors</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Diminise Legal Troubles</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Inventory of Assets</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Less Stress & Disputes</h1>
        </div>
        ...
        <div className="bg-white shadow-lg p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Flexibility of Choice</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Funerary Instructions</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Less Inheritance Tax</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Avoid Statutory Devolution</h1>
        </div>
      </div>
      ...
      <div className="hidden lg:block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              After successfully verifying all your documents, the applicant
              will get his Will within 5-6 months or with some more delay.
            </p>
          </div>
          <div class="flex  justify-center items-center col-span-3">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              ...
              let you know your Will has been generated.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                ...
                to let you know your Will has been generated.
              </p>
            </div>
          </div>
        </div>
