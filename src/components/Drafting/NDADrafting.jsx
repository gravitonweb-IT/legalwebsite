...
const NDADrafting = () => {
  ...
  <a
    href="https://legal251.com/nda-non-disclosure-agreement-online-hindi"
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      <div className="row">
        <div className="col-md-6">
          <p className="serviceamainheading">NDA</p>
          <p
            style={{
              fontFamily: '"Roboto"',
              marginTop: 18,
          ...
          >
            Protect your trade secrets and other confidential information with a
            Non-Disclosure Agreement (NDA) drafted by our best lawyers!
          </p>
          <br />
          <a href="#formpricediv">
                  ...
                  <center>
                    ...
                    >
                      <option
                        className="cities"
                        data-value=""
                        data-select2-id="select2-data-2-0z0n"
                      />
                    ...
                    <span
                      ...
                      dir="ltr"
                      data-select2-id="select2-data-1-sd0i"
      ...
      <p className="aboutustext">
        You can keep all your trade secrets and business data safe and secure
        using an NDA or Non-Disclosure Agreement, a legal document that outlines
        what one can share and with whom. Draft the best suited NDA for your
        company with our legal whizzes.
        <br />
        A non-disclosure agreement or NDA, also known as a confidentiality
        agreement, is a written contract between two parties (people or
        organizations) that prohibits the sharing of confidential/sensitive
        information revealed to them. If a company asks someone to sign an NDA,
        whether mutual or unilateral, they promise to keep secret any sensitive
        information shared with them and not to share it with others.
        <br />
        Any company must have strict and precise NDA policies to keep it safe
        from legal/financial or other trouble. Legal251 has a dedicated team of
        experts who will help you with the best NDA agreement according to your
        needs and wants. So don't wait to keep your company secure and safe.
        Contact us today.
      </p>
      <br />
      <br />
  ...
  <div id="Howtoapply" className="page-section">
    ...
    <center>
      <img
        src="https://legal251.com/images/nda/NDA.png"
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Protects New Idea/Services </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Retain Rights</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Ensures Clarity</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Limits Information Sharing</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Cost-Efficient</p>
            </center>
          </div>
        </div>
      </div>
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Prevents Information Leakage</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Maintain Trust and Comfort</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Outlines consequences </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Protects Company Image</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
            ...
            <div className="col-md-2 Registrationprocesscol3">
              <center>
                <p className="Registrationprocesstext3 gstrtext3">
                  The lawyers will move further with your documents to apply for
                  your NDA Agreement.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol4">
              <center>
                <p className="Registrationprocesstext4 gstrtext4">
                  Our lawyers will prepare your NDA Agreement as soon as
                  possible, and you can download it online from Legal251's
                  website or app.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol5">
              <center>
                <p className="Registrationprocesstext5 gstrtext5">
                  ...
                  inform you about the generation of your NDA agreement.
                </p>
              </center>
            </div>
          </div>
          ...
          <div className="col-md-6 servicefaqcol1">
            ...
            >
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse1"
                    >
                      1. What is the intent of an NDA?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The purpose of an NDA is to safeguard the information
                    exchanged by one or more parties. An NDA is a legally
                    binding agreement as long as all parties involved sign it.
                    It prohibits sharing confidential/sensitive information with
                    parties outside (or those not interested in signing it).
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse2"
                    >
                      Q2. Is it mandatory to print the non-disclosure agreement
                      on stamp paper?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    You can use the letterhead as a substrate to print the
                    contract if you are a registered company. However, if you
                    are an individual, you should use stamp paper of prescribed
                    value in your state for executing this agreement.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse3"
                    >
                      Q3. Is it compulsory for both/all the parties to sign the
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, both/all parties should sign the non-disclosure
                    agreement.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse4"
                    >
                      Q4. What are the other names of an NDA?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    A non-disclosure agreement is also known as: <br />
                    <li>Confidential Agreement (CA)</li>
                    <li>Confidential Disclosure Agreement (CDA)</li>
                    <li>Secrecy Agreement (SA)</li>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse5"
                    >
                      Q5. What are the types of Non Disclosure Agreement (NDA)?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    There are three types of a Non Disclosure Agreement: <br />
          ...
          <div className="col-md-6 servicefaqcol2">
            <div className="panel-group" id="accordion2">
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse21"
                    >
                      Q6. How can I get to know the value of a Stamp Paper?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20192.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    There's a different value of stamp paper in each state in
                    India. You can derive the value of the stamp paper from the
                    state in which the execution of the stamp paper is taking
                    place. One can find the value of Stamp Paper/Stamp Duty
                    payable on the state government website.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse22"
                    >
                      Q7. What is the difference between Non Disclosure
                      Agreement With Witness and Without Witness?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    <li>
                      A Non Disclosure Agreement With Witness comes with a
                      limitation period of 12 years to claim against breach of
                      agreement in the court of law. On the other hand, the
                      limitation period in case of agreement Without a Witness
                      is 6 years.
                    </li>
                    <li>
                      Here, the Limitation Period is the legally specified
                      period after which a court of law will not entertain any
                      legal action.
                    </li>
                  </div>
                </div>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse23"
                    >
                      Q8. What will happen if someone breaks the NDA?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The Non Disclosure Agreement itself consists of the
                    penalties to deal with the breach of the agreement. However,
                    you haven't listed any penalty in the agreement. Still, it
                    is clearly mentioned that one can sue the person guilty of a
                    contract violation for such misconduct.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse24"
                    >
                      Q9. Who is the Receiving Party under Non Disclosure
                      Agreement?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    When a party discloses confidential and valuable information
                    to the other party under a Non Disclosure Agreement, the
                    party receiving such information is called a "Receiving
                    Party".
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse25"
                    >
                      Q10. What if I want to add a clause to the Non Disclosure
                      Agreement?
                    </a>
                  </h4>
                </div>
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, you can add a clause to the Non Disclosure Agreement
                    with the other party's prior consent.
                  </div>
                </div>
              </div>
            </div>
