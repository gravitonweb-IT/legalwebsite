...
import NdaImg from "../../assests/images/DraftingImg/NdaImg.png";
...
const faqs = [
  {
    id: 1,
    question: "Q1. What is the intent of an NDA?",
    answer:
      "The purpose of an NDA is to safeguard the information exchanged by one or more parties. An NDA is a legally binding agreement as long as all parties involved sign it. It prohibits sharing confidential/sensitive information with parties outside (or those not interested in signing it).",
  },
  {
    id: 2,
    question: "Q2. What will happen if someone breaks the NDA?",
    answer:
      "The Non Disclosure Agreement itself consists of the penalties to deal with the breach of the agreement. However, you haven't listed any penalty in the agreement. Still, it is clearly mentioned that one can sue the person guilty of a contract violation for such misconduct.",
  },
  {
    id: 3,
    question: "Q3. Who is the Receiving Party under Non Disclosure Agreement?",
    answer:
      "When a party discloses confidential and valuable information to the other party under a Non Disclosure Agreement, the party receiving such information is called a Receiving Party.",
  },
  {
    id: 4,
    question: "Q4. Is it compulsory for both/all the parties to sign the non-disclosure agreement?",
    answer:
      "Yes, both/all parties should sign the non-disclosure agreement.",
  },
  {
    id: 5,
    question: "Q5. What are the other names of an NDA?",
    answer:
      "Non-disclosure agreement (NDA) may be known as confidentiality agreement, secrecy agreement, or proprietary information agreement in legal contexts.",
  },
  {
    id: 6,
    question: "Q6. How can I get to know the value of a Stamp Paper?",
    answer:"Verify the stamp paper's denomination, authenticity, and government seal. Consult a legal professional or visit a notary for confirmation.",
  },
];
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            ...
            outlines confidential information sharing between parties. It
            imposes restrictions on the recipient from disclosing or using the
            confidential information for unauthorized purposes. NDAs safeguard
            sensitive data, trade secrets, or intellectual property during
            business transactions, collaborations, or employment relationships,
            providing legal recourse in case of breaches and promoting trust
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          ...
          <div className="">
            ...
            <img src={NdaImg} className="w-3/4 h-auto mt-4"></img>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-10 mx-5 md:mx-20 lg:mx-28 mt-10 md:mt-14">
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Protects Sensitive Information</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">No Delay in Decision Making</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Retain Rights</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Ensures Clarity</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Limits Information Sharing</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Cost-Efficient</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Prevents Information Leakage</h1>
        </div>
        ...
        <div className="bg-white shadow-lg p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Maintain Trust and Comfort</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Outlines consequences</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Protects Company Image</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Preserve Business Relationship</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              ...
              you about the generation of your NDA agreement
            </p>
          </div>
        </div>
      </div>
