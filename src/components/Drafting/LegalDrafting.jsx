...
const LegalDrafting = () => {
  ...
  <a
    href="https://legal251.com/legal-drafting-hindi"
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      <div className="row">
        <div className="col-md-6">
          <p className="serviceamainheading">Legal Drafting</p>
          <p
            style={{
              fontFamily: '"Roboto"',
              marginTop: 18,
          ...
          >
            It's time to take a step ahead to grow your business while we take
            care of all your Legal Drafting, such as memorandum, petition, and
            much more!{" "}
          </p>
          <br />
          <a href="#formpricediv">
                  ...
                  <center>
                    ...
                    >
                      <option
                        className="cities"
                        data-value=""
                        data-select2-id="select2-data-2-wex5"
                      />
                    ...
                    <span
                      ...
                      dir="ltr"
                      data-select2-id="select2-data-1-5ero"
      ...
      <p className="aboutustext">
        Drafting a Legal Notice or replying to one is definitely a demanding
        task as it needs deep legal knowledge and professional writing skills.
        But not everyone is from a legal background. So, instead of thinking
        ‘what to do next,’ take help from our top legal experts for all your
        Legal Drafting and live stress-free.
        <br />
        Legal Drafting is a method of creating finely-honed documents like
        memorandums, Wills, contracts, petitions, statutes, and more that are
        legally binding on the parties to such documents, generally known as
        Legal Drafts. It is imperative to draft these documents in simple
        language so the intended audience can read and understand them. It must
        be crisp and clear, free from linguistic ambiguities and “community
        jargon.” However, as an individual, not everyone has the proficiency to
        prepare a legal draft by themself. Well, taking help from our legal
        experts will help.
      </p>
      <br />
      <br />
        ...
        <div className="col-md-2 col-xs-4  firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              ...
              />
              <p className="benefitscardtext">Minimize Cost</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Legal Proof </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Encourage Settlements </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Accuracy and Precision</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Easy Access to Professionals</p>
            </center>
          </div>
        </div>
      </div>
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Fast Draft Preparation</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Flexibilities</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Maintain Lucidity</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> No Linguistic Ambiguities </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Eye for Detail</p>
            </center>
          </div>
        </div>
      </div>
            ...
            <div className="col-md-2 Registrationprocesscol3">
              <center>
                <p className="Registrationprocesstext3 gstrtext3">
                  The lawyers will move further with your documents to prepare
                  for your Legal Draft.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol4">
              <center>
                <p className="Registrationprocesstext4 gstrtext4">
                  ...
                  download it online from our website or the Legal251 App.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol5">
              <center>
                <p className="Registrationprocesstext5 gstrtext5">
                  ...
                  inform you about completing your Legal Draft.
                </p>
              </center>
            </div>
          </div>
          ...
          <div className="col-md-6 servicefaqcol1">
            ...
            >
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse1"
                    >
                      1. What essential elements to keep in mind while legal
                      Drafting?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    While working on a legal draft, one must keep the following
                    things in mind: <br />
                    ...
                    <li>Be precise</li>
                    <li>Unilateralism</li>
                    <li>Remember and follow the chronology</li>
                    <li>Don’t forget to define important things</li>
                    <li>Focus on adaptability</li>
                    <li>The draft should be in a lucid way</li>
                    <li>Be logical</li>
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse2"
                    >
                      Q2. How many types of drafts are there in the process of
                      Legal Drafting?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    There are mainly three types of drafts in the legal drafting
                    process, these are: <br />
                    <li>
                      The first draft focuses on the proper mentioning of facts
                    </li>
                    <li>
                      The second draft works on the correction of the first
                      draft’s language to make it easy to understand
                    </li>
                    <li>
                      The final draft is to give it the final touch so that it
                      can convince the concerned authority
                    </li>
                  </div>
                </div>
              </div>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    If you are well aware of the legalities and have proper
                    knowledge of the subject matter, you can try it out
                    yourself. However, while preparing a legal draft, there are
                    many parameters and conditions one must keep in mind which
                    may affect you in future, so it is best to take help from
                    professionals to avoid legal actions or conflicts.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    A draft is a precise legal document that gives all the
                    details about a (legal) case. It is a rough document
                    prepared by the lawyer, which later requires a final touch
                    to compose the original draft.{" "}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-6 servicefaqcol2">
            <div className="panel-group" id="accordion2">
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse21"
                    >
                      Q6. What are the two terminologies used in making a draft?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20192.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The two terminologies used in a draft are: <br />
                    <li>
                      DRAFTSMAN: Person who makes the documents like mortgage
                      deed and lease deed.
                    </li>
                    <li>
                      DRAGOMAN: The person who translates the whole summary of
                      the judgment.
                    </li>
                  </div>
                </div>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse22"
                    >
                      Q7. What are the ‘Don’ts’ in legal Drafting?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    These are the following don’t one must avoid while preparing
                    a legal draft:
                    <li>No typing mistake</li>
                    <li>Avoid repetition</li>
                    <li>Avoid similar words with the same meaning</li>
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse23"
                    >
                      Q8. What are the principles that govern drafting?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The principles governing Drafting are: <br />
                    <li>Emphasis on the arrangement of facts</li>
                    <li>Form outline in a satisfactory manner</li>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse24"
                    >
                      Q9. What are “Physical Characteristics” in a legal draft?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    “Physical Characteristic” means that one must prepare the
                    draft on a paper, i.e., the size of the paper 20 by 30 cm,
                    including a 4 cm margin from the top and left.{" "}
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    When a person sends an intimation to another person to
                    inform them that they intend to initiate legal proceedings
                    against the other person, such notice is known as legal
                    notice.
                  </div>
                </div>
              </div>
