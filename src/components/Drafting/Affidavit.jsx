...
const Affidavit = () => {
  ...
  <div style={{ position: "relative", overflowX: "hidden" }}>
    ...
    <a
      href="https://legal251.com/affidavit-hindi"
      ...
      <div className="servicemaindiv" style={{ marginTop: 7 }}>
        <div className="row">
          <div className="col-md-6">
            <p className="serviceamainheading">Affidavit</p>
            <p
              style={{
                fontFamily: '"Roboto"',
                marginTop: 18,
            ...
            >
              From property disputes to issuing a legal notice, you will need an
              Affidavit (AFFI). Let our Legal251 experts help you prepare this
              official statement for you.
            </p>
            <br />
            <a href="#formpricediv">
                    ...
                    <center>
                      ...
                      >
                        <option
                          className="cities"
                          data-value=""
                          data-select2-id="select2-data-2-gxro"
                        />
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-1-keip"
        ...
        <p className="aboutustext">
          Proof your truthfulness of a particular statement in court by making
          an Affidavit, a sworn written legal document admissible in court. Our
          experts will help you create the best Affidavit according to your
          requirement in no time!
          <br />
          An Affidavit is a sworn written statement, also known as a Notarized
          Statement, typically used in court proceedings and other legal
          matters. The rules for making an Affidavit may change according to
          different places and might be challenging. Based on where you live,
          you might need an authorized affidavit taker to witness the creation
          of your affidavit personally. So, before getting started, always check
          for the requirements accordingly.
          <br />
          An Affidavit is a written statement of an individual sworn to be true,
          meaning the individual is taking an oath saying that whatever is
          written is true. However, a person must be particular while creating
          an Affidavit and take the expert’s advice before proceeding. You can
          contact our professionals for guidance or Affidavit creation.
        </p>
        <br />
        <br />
      </div>
    ...
    <div id="Howtoapply" className="page-section">
      ...
      <center>
        <img
          src="https://legal251.com/images/nda/Affidavit (AFFI).png"
          ...
          <div className="col-md-2 col-xs-4  firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                ...
                />
                <p className="benefitscardtext">Proof of Truthfulness</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Avoid Property Disputes </p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Avoid Debt Disputes</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Residency Verification</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> A Legal Document</p>
              </center>
            </div>
          </div>
        </div>
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Useful for Record Keeping</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Legitimize a Claim</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Sworn Statement</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Multipurpose Document </p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
              ...
              <div className="col-md-2 Registrationprocesscol1">
                <center>
                  <p className="Registrationprocesstext1 gstrtext1">
                    ...
                    to lessen the chances of a smooth process of incorrect or
              ...
              <div className="col-md-2 Registrationprocesscol4">
                <center>
                  <p className="Registrationprocesstext4 gstrtext4">
                    After successfully verifying your documents, your Affidavit
                    will generate.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscol5">
                <center>
                  <p className="Registrationprocesstext5 gstrtext5">
                    We request you wait until one of our experts contacts you to
                    let you know your Affidavit has been generated.
                  </p>
                </center>
              </div>
            </div>
            ...
            <div className="col-md-6 servicefaqcol1">
              ...
              >
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse1"
                      >
                        1. What are the common Affidavit uses?
                        <img
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Affidavits are helpful in many situations. However, there
                      are some everyday situations where you can use an
                      affidavit, including in Self-Proving Will, Court,
                      Affidavit for Financial Declarations, Power of Attorney,
                      Lost Document, and Identity Theft.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      You can prepare your Affidavit by yourself. However, as an
                      affidavit is a legal document, it is advisable to take
                      legal advice from the experts before you start to avoid
                      mistakes.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse3"
                      >
                        Q3.Where to get legal advice for preparing an Affidavit?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      You can take legal advice from an excellent legal
                      consultancy like Legal251. Our experts at Legal251 are the
                      best in knowledge. They will guide you through all the
                      legalities regarding your affidavit.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse4"
                      >
                        Q4. Is a witness required for an affidavit?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Yes, an affidavit is signed and witnessed by a notary
                      authority.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse5"
                      >
                        Q5. What is an Affidavit of Domicile?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      A domicile certificate is proof that the bearer of the
                      certificate is a resident of a particular state or
                      country.
                    </div>
                  </div>
                </div>
            ...
            <div className="col-md-6 servicefaqcol2">
              <div className="panel-group" id="accordion2">
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse21"
                      >
                        Q6.Can a person have two domiciles?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20192.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      No, a person cannot declare two domiciles in different
                      states because anyone can have only one domicile
                      certificate at a time, of a place where the person pays
                      taxes and votes. Also, having more than one domicile is an
                      offense.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse22"
                      >
                        Q7. What does, to the best of my knowledge and belief?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      The term “to the best of my knowledge and belief” used in
                      affidavits and other courts/legal documents indicates that
                      the statements are true and not false knowingly.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse23"
                      >
                        Q8. What is the purpose of an Affidavit?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      The purpose of an affidavit is to legitimize a claim
                      formally. To be valid for an affidavit, the person signing
                      the document must be aware of the facts stated in the
                      affidavit, followed by an oath that the mentioned facts
                      are entirely honest.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse24"
                      >
                        Q9. What are the two types of an affidavit?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      The two types of validity of an affidavit are Authenticity
                      and Time.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse25"
                      >
                        Q10. How important is an affidavit of complaint?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      The complaint affidavit works as the basis for the case,
                      provides basic information about the facts (of the
                      matter), and outlines the nature of the case. This
                      document is part of the court record maintained on the
                      case, and anyone reviewing it can inspect it.
                    </div>
                  </div>
                </div>
              </div>
