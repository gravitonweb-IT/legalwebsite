...
const PowerOfAttorney = () => {
  ...
  <a
    href="https://legal251.com/power-of-attorney-hindi"
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      <div className="row">
        <div className="col-md-6">
          <p className="serviceamainheading">Power of Attorney</p>
          <p
            style={{
              fontFamily: '"Roboto"',
              marginTop: 18,
          ...
          >
            Making or becoming the Power of Attorney (POA) is associated with
            immense responsibility. Let us make it easy for you.
          </p>
          <br />
          <a href="#formpricediv">
                  ...
                  <center>
                    ...
                    >
                      <option
                        className="cities"
                        data-value=""
                        data-select2-id="select2-data-2-bzge"
                      />
                    ...
                    <span
                      ...
                      dir="ltr"
                      data-select2-id="select2-data-1-zf8p"
      ...
      <p className="aboutustext">
        Making someone your Power of Attorney or being someone's POA is full of
        responsibilities &amp; the one bearing the duties must be capable of
        doing so. If you want someone to be your Power of Attorney but are
        unsure how to do it, we can help.
        <br />
        When a person owns property or bank accounts and is not in a position to
        perform his duties due to illness, old age, or being abroad, and if a
        transaction requires his presence, he cannot appear physically. He can
        give his rights to perform his duties to the other dependable person,
        who can now act on behalf of that person bearing the registrations,
        sale, rent out, or other financial responsibilities.
        <br />
        Power of Attorney is an authority regarding the property a person or
        grantor gives to an agent or agents. After signing the Power of
        Attorney, the agent will have the same power as the grantor and can act
        on behalf of the grantor regarding his property when needed. We at
        Legal251 have a team of experts who can skillfully help you with Power
        of Attorney-related issues.
      </p>
      <br />
      <br />
    </div>
  ...
  <div id="Howtoapply" className="page-section">
    ...
    <center>
      <img
        src="https://legal251.com/images/nda/Power of Attorney.png"
        ...
        <div className="col-md-2 col-xs-4  firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              ...
              />
              <p className="benefitscardtext"> Asset Protection</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> No Delay in Decision Making</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Gives Flexibility</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Enduring and Revocable</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Avoid Financial Abuse</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Can Withdraw Anytime</p>
            </center>
          </div>
        </div>
      </div>
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">No Need for Guardianship</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Avoids Legal Troubles</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Buy, sell and rent a property</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Easy Settlements of Claims </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
            ...
            <div className="col-md-2 Registrationprocesscol2">
              <center>
                <p className="Registrationprocesstext2 gstrtext2">
                  Our best documentation lawyers are here to help you with
                  document requirements and legal necessities.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol3">
              <center>
                <p className="Registrationprocesstext3 gstrtext3">
                  ...
                  documents to apply for your Power of Attorney.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol4">
              <center>
                <p className="Registrationprocesstext4 gstrtext4">
                  Once the Sub-registrar verifies all the documents, Power of
                  Attorney will be provided to the applicant within 30 working
          ...
          <div className="col-md-6 servicefaqcol1">
            ...
            >
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse1"
                    >
                      1. What is the difference between a Will and POA?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Will: A Will takes place after the death of a person,
                    whereas Power of Attorney: POA is only applicable when the
                    person is alive and ceases after the person's death.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse2"
                    >
                      Q2. Is registration of a POA necessary?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    It is not necessary to register the POA unless it
                    constitutes an interest in any immovable property, i.e., a
                    change in favor of the power of attorney holder.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse3"
                    >
                      Q3. Do I need a lawyer to prepare a Power of Attorney?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    No, you can prepare it on your own with the Legal251 App.
                    However, you can always ask our experts for assistance, who
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse4"
                    >
                      Q4. What documents do I need for preparing a POA?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The main documents you are required to prepare for a POA are
                    Adhar Card, Identity Proof such as Voter ID, PAN Card
                ...
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse5"
                    >
                      Q5.Can someone appoint multiple Power of Attorney?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
          ...
          <div className="col-md-6 servicefaqcol2">
            <div className="panel-group" id="accordion2">
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse21"
                    >
                      Q6. Are witnesses required for the POA attestation?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20192.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, you will need at least two witnesses for the
                    attestation.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse22"
                    >
                      Q7. What are the types of Power of Attorneys?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    PoA is of two types, General Power of Attorney (GPA) and
              ...
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, POAs are revocable at any time. However, you should
                    seek legal assistance to make your revocation effective
                    because your POA might still get honored if a financial
                    institution hasn't received proper notice of its revocation.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse24"
                    >
                      Q9. Who is incapable of being a Power of Attorney?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    According to the Indian Contract Act, the following are
                    incapable of becoming a POA: <br />
                    <li> Minors (below 18 years of age)</li>
                    <li>
                      Person of Unsound Mind, i.e., Lunatic, Drunkard, and
                      others.
                    </li>
                    <li>
                      Other persons are legally disqualified by the law to which
                      they are subject.
                    </li>
                  </div>
                </div>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse25"
                    >
                      Q10. When does a POA come to an end?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    <br />
                    <li>POA revoked by the principal</li>
                    <li>Death of principal</li>
                    <li>POA canceled by the court</li>
                    <li>
                      The principal divorces their spouse, who happens to be the
                      agent
                    </li>
                    <li>
                      {" "}
