...
const ProjectReportPreparation = () => {
  ...
  <a
    href="https://legal251.com/project-report-prepration-hindi"
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      <div className="row">
        <div className="col-md-6">
          <p className="serviceamainheading">Project Report Preparation</p>
          <p
            style={{
              fontFamily: '"Roboto"',
              marginTop: 18,
          ...
          >
            Let us make your Project Report with proper planning while keeping
            the circumstances and local law in mind to make it more transparent
            and understandable.
          </p>
          <br />
          <a href="#formpricediv">
              ...
              <div className="row">
                  ...
                  <center>
                    ...
                    >
                      <option
                        className="cities"
                        data-value=""
                        data-select2-id="select2-data-2-h0r8"
                      />
                    ...
                    <span
                      ...
                      dir="ltr"
                      data-select2-id="select2-data-1-iffa"
                ...
                <div className="col-md-6">
                  <center>
                    ...
                    >
                      <sup style={{ lineHeight: "1.5" }} />₹ 2551.00
                    </p>
                    <p
                      style={{
                        fontFamily: '"Roboto"',
      ...
      <p className="aboutustext">
        Make your start-up business report properly while keeping all the
        crucial factors in mind to get the bank loan quickly and hassle-free.
        Need help? We are just a call away!
        <br />
        It is vital to make and represent the project report for taking a
        business loan from the back for a new start-up business. To make the
        report look more effective and authenticate, you must submit all the
        required official documents. You must add all the requirements to the
        project report so that it should represent the idea of the business and
        the reader can understand it better, such as technical analysis,
        financial analysis, profitability analysis, economic analysis, and so.
        <br />
        Define all the elements of the project report adequately, such as the
        Introductory Page, Summary of the Project, Details of Customers,
        Promoters and Employees, infrastructure facilities and more, to make it
        clear &amp; concise. While drafting your project report, consider the
        laws and policies of your area, where you want to set up your
        establishment, other official formalities, and national and
        international rules and regulations if you're willing to expand/set up
        your business nationally/internationally. Contact our experts to get
        help regarding your Project Report.
      </p>
      <br />
      <br />
    </div>
  ...
  <div id="Howtoapply" className="page-section">
    ...
    <center>
      <img
        src="https://legal251.com/images/nda/Project Report.png"
        ...
        <div className="col-md-2 col-xs-4  firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              ...
              />
              <p className="benefitscardtext">Feasibility</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Progress Tracking</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Transparency </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Indicates Profitability</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Easy Decision Making</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Financial Assistance</p>
            </center>
          </div>
        </div>
      </div>
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Ensures Survival</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Analyze Profitability</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Evaluate Future Goals</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Eliminate Hurdles </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext"> Improved Performance</p>
            </center>
          </div>
        </div>
      </div>
            ...
            <div className="col-md-2 Registrationprocesscol2">
              <center>
                <p className="Registrationprocesstext2 gstrtext2">
                  Our best Project Report professionals are here to help you
                  with document requirements and licensing necessities.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol3">
              <center>
                <p className="Registrationprocesstext3 gstrtext3">
                  ...
                  documents to apply for your Project Report.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol4">
              <center>
                <p className="Registrationprocesstext4 gstrtext4">
                  After successfully verifying your documents, the relevant
                  expert will tally your accounts and help you make the report.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol5">
              <center>
                <p className="Registrationprocesstext5 gstrtext5">
                  ...
                  to let you know your Project Report is ready.
                </p>
              </center>
            </div>
          </div>
          ...
          <div className="col-md-6 servicefaqcol1">
            ...
            >
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse1"
                    >
                      1. Is making a project report for a bank loan compulsory?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, making a project report is of utmost importance when
                    you take a business loan or avail funds from financial
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse2"
                    >
                      Q2. What is a bank project report?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    A bank Project Report is essential for getting a bank
                    loan(s). It is a document detailing a business or project
                    for which you covet finance. A project report contains
                    details about the economic, financial, technical, and
                    managerial aspects of the company or project.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse3"
                    >
                      Q3. Can I use the same bank project report for multiple
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, you can use the same bank report for multiple banks and
                    Government schemes if it is in a general format to identify
                    the financial feasibility. We can make a report for you, and
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse4"
                    >
                      Q4. Can I create a project report by myself with Legal251?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, you can create the project report in elementary steps,
                    where you can get help from our experts anytime.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse5"
                    >
                      Q5. Does a bank loan project report need to attest by CA?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    No, a project report must be created and submitted by the
                    entrepreneur. This document is a road map/plan for future
                    data, so there's no need for any sort of attestation or sign
                    from CA.
                  </div>
                </div>
              </div>
          ...
          <div className="col-md-6 servicefaqcol2">
            <div className="panel-group" id="accordion2">
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse21"
                    >
                      Q6. Can a CA prepare my project report?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20192.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, any person having financial knowledge/background can
                    prepare the project report. Most people usually ask CA to
                    draft their project report because it requires particular
                    financial skills to prepare if you know the "know-how", you
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse22"
                    >
                      Q7. Do you provide services for getting bank loans?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, we provide loan services to help people/individuals
                    seeking bank loans.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse23"
                    >
                      Q8. Can I get personal assistance for my project report?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, we provide customer associate service to create a
                    report for you and also keep you informed about your report.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse24"
                    >
                      Q9. What are the vital elements of a project report?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The required elements of a project report are: <br />
                    <li>Introductory Page</li>
                    <li>Details of Promoters</li>
                    <li>Scope of the Project</li>
                    <li>Product/Services</li>
                    <li>Location Details</li>
                    <li>Plant &amp; Machinery Details (if any)</li>
                    <li>Raw Materials (if any)</li>
                    <li>Market Potential and Marketing Strategy</li>
                    <li>Employees Details</li>
                    <li>Project Cost</li>
                    <li>Application of Fund</li>
                    <li>Means of Financing</li>
                    <li>Balance Sheet</li>
                    <li>Profit and Loss Statements</li>
                    <li>Cash Flow Statement</li>
                    <li>General Ratios</li>
                    <li>Break-Even Point Evaluations</li>
                    <li>Conclusions</li>
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse25"
                    >
                      Q10. What are the other objectives of preparing a project
                      report?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The other objective of preparing the project report is to
                    test the business profitability and effectiveness of the
                    project. The comparative review of estimated costs and
                    possible income is possible by the project report.
                  </div>
                </div>
              </div>
            </div>
