...
const ITSfiling = () => {
  ...
  <a
    href="https://legal251.com/income-tax-return-filing-hindi"
  ...
  <div>
    ...
    >
      ...
      <li>
        <a
          className="serviceheaderlink onclick"
          id="y"
          href="#plans"
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      <div className="row">
        <div className="col-md-6">
          <p className="serviceamainheading serviceamainheadingvideo">
          ...
          >
            Directly fill out any Tax Returns like salary, capital gains,
            business, professional, or property taxes. Get comprehensive Tax
            return services at your fingertips.
          </p>
          <br />
          <a href="#plans">
          ...
          >
            Documenting income tax returns is each resident's obligation. The IT
            division confirms these assertions of salary, and if any sum has
            been paid in abundance, the office discounts the sum to the
            concerned person's financial balance. Ensure your safe and secure
            filing of all income tax and become a responsible citizen. Legal251
            helps you not miss any important documents and get things done for
            you in a few clicks.
            <br />
            <br />
            An income tax return is a form where taxpayers declare their taxable
            income, deductions, and tax payments. This procedure of filing
            income tax returns isreferred to as income tax filing. While filing,
            the total income tax you owe to the government is also calculated.
            If you've paid more tax than needed for the financial year, the IT
            Department will refund the extra money to your account.
          </p>
        </div>
          ...
          <center className="cnt_margin left-div-body">
            <div className="login-iframe topvideo">
              <iframe
                ...
                src="https://www.youtube.com/embed/yqQmFKO42kk?&modestbranding=1&showinfo=0"
      ...
      <br />
      <br />
      <div className="row experiencecustomcolrow" id="counter">
  ...
  <div id="plans" className="page-section">
    ...
    <br />
    <center>
      <button value="S" className="Salariedperbut itrplans activesal">
        Salaried Person{" "}
      </button>
      <hr className="buttonbetweenrsd" />
      <button value="B" className="bussprobut">
        Business / Profession
      </button>
    </center>
    <br />
    ...
    <div id="multiform" className="multiformdiv" style={{ display: "none" }}>
      ...
      >
        <option
          className="cities"
          data-value=""
          data-select2-id="select2-data-2-t6vt"
        />
      ...
      <span
        ...
        dir="ltr"
        data-select2-id="select2-data-1-rcnw"
        style={{ width: "100%" }}
      >
              ...
              >
                <div style={{ padding: "0 12px" }}>
                  ...
                  <div className="dropdown">
                    ...
                    >
                      <div style={{ padding: "6px 0 6px 6px", height: "auto" }}>
                        <div
                          style={{
                            fontWeight: 500,
                            lineHeight: "1.2",
                    ...
                    >
                      ...
                      >
                        <div style={{ padding: "6px 0 6px 6px", height: 65 }}>
                          <div
                            style={{
                              fontWeight: 500,
                              lineHeight: "1.2",
              ...
              >
                ...
                <div className="hidebusscon3">
                  ...
                  >
                    ...
                    />
                    Income from other than business or profession included
                  </p>
                  <p
                    style={{
                      fontFamily: '"Open Sans", sans-serif',
        ...
        <div className="col-md-3 col-sm-6 businesscol">
          <div
            style={{
              ...
              background: 'url("images/itr/Salaried - premium.svg") #01355D',
              borderRadius: 10,
              boxShadow: "6px 6px 6px #00000017",
              marginBottom: 40
            }}
      ...
      <div className="row" style={{ margin: 0, padding: 0 }}>
        <div className="col-md-3 col-sm-6 Salariedcol">
          <div
            style={{
              backgroundImage: 'url("images/itr/Salaried - starter.svg")',
              background: 'url("images/itr/Salaried - starter.svg") #f8951d',
              borderRadius: 10,
              boxShadow: "6px 6px 6px #00000017",
              marginBottom: 40
            }}
    ...
    <div id="Howtoapply" className="page-section">
      ...
      <center>
        <img
          src="https://legal251.com/images/gstregistration/ITRF.png"
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Claiming Refund</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Carry-forward Losses</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Self-Employed Individual</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Being a Responsible Citizen</p>
              </center>
            </div>
          </div>
        </div>
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Income &amp; Address Proof</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Buying a high life cover</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            ...
            >
              ...
              <div style={{ padding: "0 5px 5px 5px" }}>
                ...
                >
                  ...
                  <div className="row" style={{ padding: 0, margin: 0 }}>
                    <div className="col-sm-3 itrfilingcol3">
                    ...
                    <div className="col-sm-5 itrfilingcol4">
                      <div style={{ paddingLeft: 13 }}>
                        <p
                          style={{
                            fontFamily: '"Open Sans", sans-serif',
                    ...
                    <div className="col-sm-5 itrfilingcol5">
                      <div style={{ paddingLeft: 13 }}>
                        <p
                          style={{
                            fontFamily: '"Open Sans", sans-serif',
                        ...
                        <div style={{ paddingLeft: 13 }}>
                          ...
                          <div style={{ paddingLeft: 13 }}>
                            ...
                            >
                              ...
                              />
                              Partnership deed / Reconstruction deed /
                              Dissolution deed
                            </p>
                            <p
                              style={{
        ...
        <div>
          ...
          >
            <div className="col-md-2 Registrationprocesscol1">
              <center>
                <p className="Registrationprocesstext1 itrtext1">
                  After you have submitted your documents our team will go
                  through them carefully and will inform you if any changes are
            ...
            <div className="col-md-2 Registrationprocesscol2">
              <center>
                <p className="Registrationprocesstext2 itrtext2">
                  Our best ITR filing experts are here to deal with document
                  necessities &amp; fulfilment of filing.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol3">
              <center>
                <p className="Registrationprocesstext3 itrtext3">
                  Experts will carefully look into your expenses and income
                  information so that they consult you regarding this.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol4">
              <center>
                <p className="Registrationprocesstext4 itrtext4">
                  Based on your respective plan relevant experts will prepare
            ...
            <div className="col-md-2 Registrationprocesscol5">
              <center>
                <p className="Registrationprocesstext5 itrtext5">
                  At last, we will file an Income Tax Return on your behalf and
                  share all the deliverables with you.
                </p>
              </center>
            </div>
          </div>
          ...
          <div className="col-md-6 servicefaqcol1">
            ...
            >
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    A tax return is a form or form filed with a tax authority
                    that reports income, expenses, and other pertinent tax
                    information. Tax returns allow taxpayers to calculate their
                    tax liability, schedule tax payments, or request refunds for
                    the overpayment of taxes. In most countries, tax returns
                    must be filed annually for an individual or business with
                    reportable income, including wages, interest, dividends,
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse2"
                    >
                      Q2: Who is required to file an Income Tax Return?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Anybody who is less than 60 years of age and has an annual
                    income of more than Rs 2.5 lakh has to file income tax
                    returns, according to the Income Tax Act. For senior
                    citizens, the cut-off is Rs 3 lakh, and for those who are
                    more than 80 years old, the cut off is Rs 5 lakh.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse3"
                    >
                      Q3: Can I file a return of income even if my income is
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, you can file a return of income voluntarily even if
                    your income is less than the basic exemption limit.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse4"
                    >
                      Q4: How many types of income tax returns forms are
                ...
                >
                  <div className="panel-body servicefaqbody">
                    In total, there are six ITR forms for individuals, namely,
                    ITR-1, ITR-2, ITR-2A, ITR-3, ITR-4, and ITR-4S.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse5"
                    >
                      Q5: Is there any penalty if I will not pay my Income tax
                      return?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    If you file your ITR after the deadline, then a late filing
                    fee will be levied. The maximum penalty is Rs. 10,000.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-6 servicefaqcol2">
            <div className="panel-group" id="accordion2">
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse21"
                    >
                      Q6: What are the benefits of ITR filing?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20192.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Well, there are many benefits if you file your ITR on time.
                    Some of them are Easy Loan approval, Quick Visa Processing,
                    Avoid Penalty, Claim Tax refund, etc.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse22"
                    >
                      Q7: If I have paid excess tax, how will it be refunded to
                      me?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The excess tax can be claimed as a refund by filing your
                    income tax return (ITR). After your return is processed and
                    provided the tax department accepts your refund claim, the
                    amount claimed as a refund would be credited back to your
                    bank account through Electronic Clearance Service (ECS)
                    transfer. You would also get an email intimation for the
                    same.{" "}
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse23"
                    >
                      Q8: How can I get a copy of ITR?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    You can download a copy of your Income Tax Return
                    acknowledgement after filing it online. The I-T department
                    sends your ITR-V acknowledgement to your registered e-mail
                    id.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse24"
                    >
                      Q9: Is it mandatory to file an income tax return if my
                      earning is below Rs 250,000?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    No, it is not mandatory to file an income tax return if your
                    annual income is below Rs 250,000. However, even those who
                    are out of the tax net should consider filing a 'Nil Return'
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse25"
                    >
                      Q10: Who is Required to Fill Schedule FA (Foreign Assets)?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Applicability Of Schedule FA: If an individual (not being a
                    citizen of India) is in India for a business purpose,
                    employment, or student visa purposes and he acquires any
                    asset during the previous year in which he was a
                    non-resident, such asset shall not be required to be
                    reported in Schedule FA – details of foreign assets and
                    income if no income is derived from that asset during the
                    current previous year. That means the requirement to fulfil
                    schedule FA is only for Resident Indian who is having Income
                    from any sources outside India or signing authority in any
                ...
                <center>
                  ...
                  <div className="clientscardtextdiv">
                    <p className="clientscardtext">
                      ...
                      may know there are many problems in Film industries be it
                      in trademarks and copyrights they make all these very easy
                      and efficient.
                      <img
                        src="https://legal251.com/images/about/iconmonstr-quote-5.svg"
                        className="quoteimage2"
