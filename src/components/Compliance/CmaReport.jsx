    ...
    <>
      <div style={{ position: "relative", "overflow-x": "hidden" }}>
            ...
            <div className="row">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <center>
                          ...
                          <br />
                          <img src={one} className="serviceillustration" />
                        </center>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col-md-6 mobhidebr">
                <center>
                  ...
                  <br />
                  <br />
                  <img src={Asset} className="service1illustration" />
                </center>
              </div>
            </div>
            <br />
        ...
        <div id="Howtoapply" className="page-section">
          ...
          <br />
          <center>
            <img src={Report} className="gsthowtoapplyimg" />
          </center>
        </div>
        <div id="Detailedprocess" className="page-section">
          ...
          <br />
          <p className="servicehrheading">
            &nbsp; <img src={Path19952} className="Detailedprocessimage" />{" "}
            Benefits&nbsp;
          </p>
