...
const faqs = [
  {
    id: 1,
    question:
      "Q1. Are CMA Reports mandatory for all companies in India?",
    answer:
      "No, CMA Reports are mandatory only for certain companies as per the Companies Act, 2013 and the Companies (Cost Records and Audit) Rules, 2014.",
  },
  {
    id: 2,
    question:
      "Q2. How does the CMA Report help in cost optimization?",
    answer:
      "CMA Report identifies areas for cost reduction, inefficiencies, and improvement, providing valuable insights and recommendations for optimising cost structures.",
  },
  {
    id: 3,
    question: "Q3. Can CMA Report help in legal compliance?",
    answer:
      "Yes, CMA Report ensures compliance with cost accounting standards and regulatory requirements, helping companies mitigate legal risks.",
  },
  {
    id: 4,
    question: "Q4. Are CMA Reports useful for decision-making?",
    answer:
      "Absolutely. CMA Report provides accurate cost analysis, enabling management to make informed decisions regarding pricing, resource allocation, and cost management strategies.",
  },
  {
    id: 5,
    question:
    ...
    answer:
      "Yes, the CMA Report provides a basis for evaluating the performance of various cost centres and departments, enabling businesses to identify areas of improvement and allocate resources effectively.",
  },
  {
    id: 6,
    question:
      "Q6. How does a CMA Report contribute to a company's financial health assessment?",
    answer:
      "CMA Report provides a comprehensive analysis of a company's cost structures, efficiency, and compliance, thereby assisting in assessing its overall financial health.",
  },
];
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            ...
            details on income, expenses, assets, and liabilities. Lenders use
            the CMA report to assess creditworthiness and make informed lending
            decisions. The report assists in evaluating the borrower's ability
            to repay the loan and helps establish favorable terms.
          </p>
          <div className="mt-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mx-10 md:mx-20 lg:mx-28 mt-5 md:mt-10">
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Adherence to laws and regulations ensures business compliance and
            credibility.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Data-driven insights facilitate enhanced decision-making, ensuring
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Transparency and accountability foster trust, crucial for
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Strict legal adherence ensures regulatory compliance, safeguarding
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Innovation and efficiency secure a competitive advantage for
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Regular performance evaluations ensure continuous improvement and
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Benchmarking enables comparison, driving continuous improvement and
      ...
      <div className="hidden lg:block">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28 mt-5 md:mt-14">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium ">
              Engage with the client, collect data, review and verify, perform
              cost audits, and analyse cost structures.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              Prepare a comprehensive CMA Report with insights, recommendations,
              and compliance, ensuring accuracy and alignment with client
              objectives.
            </p>
          </div>
          <div class="flex  justify-center items-center col-span-3">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              Present Reports to stakeholders, submit to authorities, provide
              implementation support, and drive cost management strategies for
          ...
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                ...
                recommendations, and compliance, ensuring accuracy and alignment
