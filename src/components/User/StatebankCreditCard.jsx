...
The State Bank Credit Card offers diverse benefits including rewards, cashback, and exclusive privileges for seamless and rewarding financial transactions.
          </p>
        ...
        <CreditCard loanType={"State Bank Credit Card"} />
        </div>
        </UserDashboard>
    </>
  );
...
export default StatebankCreditCard