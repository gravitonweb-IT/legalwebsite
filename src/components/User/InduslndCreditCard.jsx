    ...
    <UserDashboard>
      <div className=" shadow-stone-400 m-5 mt-20 p-4">
        <div className="max-w-lg mx-auto">
          ...
          The IndusInd Bank Credit Card offers diverse rewards, exclusive privileges, contactless payments, and personalized services for a seamless and rewarding financial experience.
          </p>
        ...
        <CreditCard loanType={" Induslnd Bank Credit Card"} />
        </div>
        </UserDashboard>
    </>
  );
...
export default InduslndCreditCard