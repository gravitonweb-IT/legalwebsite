    ...
    <>
      <UserDashboard>
        <div className=" shadow-stone-400 m-5 mt-20 p-4">
          <div className="max-w-lg mx-auto">
            ...
            <p className="text-center text-base font-medium mx-2 mb-4">
              The AU Bank Credit Card offers diverse benefits including rewards,
              cashback, and exclusive privileges for seamless and rewarding
              financial transactions.
            </p>
            <div className="flex justify-center">
              <button className="text-center text-blue bg-yellow-300 p-2 mt-2 rounded-md font-bold mb-3">
                @@ No Commission
              </button>
            </div>
            <div className="flex justify-center">
        ...
        <div className=" bg-white shadow-2xl rounded-md ">
          <CreditCard loanType={"AU Bank Credit Card"} />
        </div>
      </UserDashboard>
    </>
  );
...
export default AUBankCreditCard;
