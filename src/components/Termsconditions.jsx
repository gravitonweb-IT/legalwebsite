    ...
    <>
      ...
      <div className="mx-10 md:mx-16 lg:mx-20 mt-5">
        <h1 className=" text-xl font-medium">
          Disclaimer of lawyer-client association
        </h1>
      ...
      <div className="mx-10 md:mx-16 lg:mx-20 mt-5">
        <h1 className=" text-xl font-medium">
          LEGAL257 is not for the promotion of any user.
        </h1>
      ...
      <div className="mx-10 md:mx-16 lg:mx-20 mt-5">
        ...
        <p className="text-medium mt-3">
          access through a single name being made accessible to multiple users
          on a system.
        </p>
        <p className="text-medium mt-3">
      ...
      <div className="mx-10 md:mx-16 lg:mx-20 mt-5"></div>
    </>
  );
};
