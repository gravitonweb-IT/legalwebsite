...
import arrowimg1 from './../images/services/Icon_ionic-ios-arrow-back.svg';
import { Link } from 'react-router-dom';
// import closeiconimg from './../images/closeicon.svg';
// import langiconimg from './../images/langicon.svg';
// import sidebarshapeimg from './../images/sidebarshape.png';
// import cancelbarimg from './../images/cancel.svg';
// import howweworkimg from './../images/howwework.svg';
// import howtogetconimg from './../images/howtogetcon.svg';
...
// import phonenoimg from './../images/phoneno.svg';
// import loginimg1 from './../images/common/login.svg';
// import agentimg from './../images/common/agent.svg';
// import agentimg1 from './../images/common/agent.svg';
// import trackserviceimg from './../images/trackservice.svg';
// import Group_7img from './../images/common/Group_7.svg';
// import Path_1img from './../images/common/Path_1.svg';
// import Group_3img from './../images/common/Group_3.svg';
// import sidesearchiconimg from './../images/sidesearchicon.svg';
// import starimg from './../images/star.svg';
// import legalimg from './../images/common/legal.svg';
// import Group_5675img from './../images/megamenubimage/Group_5675.png';
// import partnershipdeedimg from './../images/icons/partnership-deed.svg';
// import companyregimg from './../images/icons/company-reg.svg';
...
//           <img src={closeiconimg} className="subscribeemailclose" />
//         </div>
//       </div>
//     </div>
//   </div>
...
//     style={{ display: "none" }}
//   >
//     हिंदी <img src={langiconimg} className="langicon" />
//   </a>
...
//             <img src={howweworkimg} className="sidebarimage2" />
//           </a>
//         </p>
//         <center>
//           <a
...
//             <img src={howtogetconimg} className="sidebarimage1" />
//           </a>
//         </p>
//         <center>
//           <a
...
//             <img src={blogimg} className="sidebarimage1" />
//           </a>
//         </p>
//         <center>
//           <a
...
//         <p className="sidebarmainheading">
//           <a href="about.html">
//             <img src={aboutusimg} className="sidebarimage1" />
//           </a>
//         </p>
//         <center>
//           {" "}
...
//         <p className="sidebarmainheading">
//           <a href="contact.html">
//             <img src={contactusimg} className="sidebarimage2" />
//           </a>
//         </p>
//         <center>
//           <a
...
//           {" "}
//           <img src={phonenoimg} className="phonenoheaderlogo" />
//           (+91)77728-77729{" "}
//         </a>
//       </div>
...
//         >
//           Login <img src={loginimg1} className="userloginicon" />
//         </button>
...
//             <br /> Service
//           </p>
//           <img src={trackserviceimg} className="trackserviceicon" />
//         </button>
//       </a>
...
//         >
//           User Services
//           <img src={Group_7img} className="userloginicon" />
//         </button>
...
//               />
//             </a>
//             <ul className="bimage dropdown-menu megamenu-content " role="menu">
...
//                       />
//                       <div>
//                         <span className="title mtitle " data-toggle="dropdown">
//                           Start Business
//                         </span>
//                       </div>
...
//                           <a className="text" href="partnership-deed.html">
//                             <img
//                               className="megamenu_icon"
//                               src={partnershipdeedimg}
//                               loading="lazy"
//                             />
...
//                       <ul className="menu-col" id="id01">
//                         <li className="incontent">
//                           <a className="text" href="annual-compliance-llp.html">
//                             {" "}
//                             <img
//                               className="megamenu_icon"
...
//                     />
//                     <div>
//                       <span className="title mtitle">Change in Business </span>
//                     </div>
//                     <hr className="headinghr" />
//                   </div>
...
//                         </li>
//                         <li className="incontent">
//                           <a className="text" href="change-in-name-llp.html">
//                             {" "}
//                             <img
//                               className="megamenu_icon"
...
//                           </li>
//                           <li className="incontent">
//                             <a className="text" href="pf-registration.html">
//                               <img
//                                 className="megamenu_icon"
...
//                           </li>
//                           <li className="incontent">
//                             <a href="food-licence.html" className="singlemenua">
//                               <img
//                                 className="megamenu_icon"
...
//                       <ul className="menu-col" id="id01">
//                         <li className="incontent">
//                           <a href="legal-drafting.html" className="singlemenua">
//                             <img
//                               className="megamenu_icon"
...
//                         </li>
//                         <li className="incontent">
//                           <a href="rent-agreement.html" className="singlemenua">
//                             <img
//                               className="megamenu_icon"
...
//                         </li>
//                         <li className="incontent">
//                           <a href="affidavit.html" className="singlemenua">
//                             <img
//                               className="megamenu_icon"
...
//                         </li>
//                         <li className="incontent">
//                           <a href="application.html" className="singlemenua">
//                             <img
//                               className="megamenu_icon"
...
//       </li>
//       <li>
//         <a className="serviceheaderlink" id="c" href="#comparison">
//           Comparison
//         </a>
//       </li>
//       <li>
...
//       </li>
//       <li>
//         <a className="serviceheaderlink" id="t" href="#Registrationprocess">
...
//               <img src="images/companyregimage/Line.png" />
//               <span>200k+</span> people trust us
//             </p>
//             <img
//               className="companylegalimg"
//               src="images/companyregimage/Group%209403.png"
//             />
...
//               <span className="companypricetextspan">@ Rs.8251 only /-</span>
//               <span className="includegstline"> &nbsp;( Including GST)</span>
//               <br />
//               <span
//                 className=""
//                 style={{ fontSize: 10 }}
//                 id="termandconditiontext"
//               >
//                 <img
//                   src="images/companyregimage/Icon%20feather-info.svg"
//                   style={{ width: 14, marginTop: "-2px", marginRight: 5 }}
...
//             </p>
//             <img
//               src="images/companyregimage/Line2.png"
//               className="boderimgline"
//             />
...
//               <p className="absolfreeline">Get Absolutely Free In Package</p>
//               <div className="row packagecardrow">
//                 <div className="col-md-2 col-xs-4 colpaddingzero">
//                   <center>
//                     <img src="images/bookdemo/pan.svg" className="roundimg" />
...
//                   <center>
//                     <img
//                       src="images/bookdemo/Group%209162.svg"
//                       className="roundimg"
//                     />
//                     <p className="packagecardtext packagecardtext1">
...
//                   <center>
//                     <img
//                       src="images/bookdemo/Group_9161.svg"
//                       className="roundimg"
//                     />
//                     <p className="packagecardtext packagecardtext1">
...
//                   <center>
//                     <img
//                       src="images/bookdemo/Group%209164.svg"
//                       className="roundimg"
//                     />
//                     <p className="packagecardtext packagecardtext1">
//                       Personal Assistance
...
//                 <p className="comapnydownloadappline">Download The App Now!</p>
//                 <a
//                   target="_blank"
//                   href="https://play.google.com/store/apps/details?id=com.legal251.in"
//                 >
//                   <img
//                     src="images/companyregimage/Mask%20Group%205782.png"
...
//                 >
//                   <img
//                     src="images/companyregimage/badge-example-preferred.png"
...
//                 <br /> <br />
//                 <img
//                   src="images/companyregimage/Group%209174.png"
...
//                 <div>
//                   <img
//                     src="images/companyregimage/employee-experience.png"
...
//                 <div>
//                   <img
//                     src="images/companyregimage/case-report.png"
...
//                 <div>
//                   <img
//                     src="images/companyregimage/gold-cup.png"
//                     className="experienceimg1"
//                     alt=""
//                   />
//                 </div>
...
//                 <div>
//                   <img
//                     src="images/companyregimage/users.png"
//                     className="experienceimg1"
//                     alt=""
//                   />
//                 </div>
...
//                 <div>
//                   <img
//                     src="images/companyregimage/customer.png"
//                     className="experienceimg1"
//                     alt=""
//                   />
//                 </div>
...
//                   src="https://www.youtube.com/embed/-6CUhwRxHNE?&modestbranding=1&showinfo=0"
//                   allowFullScreen="allowfullscreen"
//                 />
//               </div>
//             </div>
//           </div>
//           <div className="col-md-7 companycustomcol4 videopvtltextdiv">
//             <br />
//             <br />
//             <p className="companyaboutsectiontext">
//               One of India's preferred forms of business among entrepreneurs is
//               Limited Liability Partnership (LLP). LLP is an alternative
//               corporate business form that gives the benefits of both a Company
//               and a Partnership Firm.
//               <br />
//               <br /> The LLP is a separate legal entity and is liable to the
//               full extent of its assets. Still, the liability of the partners is
//               limited to their agreed contribution to the LLP, and only a
//               minimum of two partners are required to incorporate an LLP. For
//               Limited Liability Partnership to be a legally valid entity, it
//               must be registered under the Limited Liability Partnership Act,
//               2008.
//               <br />
//               <br /> So, are you ready to take your business to the next level?
//               Legal251's Limited Liability Partnership (LLP) Registration is the
//               perfect way to do it! With our hassle-free process, get all the
//               legal assistance you need to register your LLP in no time, enjoy
//               the peace of mind that comes with Legal251's professional service,
...
//       </div>
//     </div>
//     <div id="comparison" className="page-section">
//       <br />
//       <br />
//       <br />
//       <br />
...
//         &nbsp;{" "}
//         <img src="images/companyregimage/img.svg" className="Howtoapplyimage" />{" "}
//         Comparison &nbsp;&nbsp;
//       </p>
//       <hr className="Howtoapplyhr1" />
//       <hr className="Howtoapplyhr4" />
//       <hr className="Howtoapplyhr5" />
//       <br />
//       <br />
//       <br />
//       <br />
//       <br />
//       <p className="pvttableheading">All Service Comparison</p>
//       <p className="pvtsubtableheading">
//         Proprietorship vs Limited Liability Partnership (LLP) vs Company
//       </p>
//       <div className="custompvtltablemainrow">
//         <div className="row custompvtltablerowheader">
//           <div className="col-xs-1 custompvtlcol1">
//             <p className="pvtsubtableheading1">Features</p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading1">Proprietorship</p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol3">
//             <p className="pvtsubtableheading1">Partnership</p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading1">LLP</p>
//           </div>
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading1">Company</p>
//           </div>
//         </div>
//         <div className="row custompvtltablerow">
//           <div className="col-xs-1 custompvtlcol1">
//             <p className="pvtsubtableheading1">Definition</p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading2">
...
//               or entities agree to share ownership, responsibilities, profits,
...
//         <div className="row custompvtltablerow">
//           <div className="col-xs-1 custompvtlcol1">
//             <p className="pvtsubtableheading1">Ownership</p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading2">
...
//             <p className="pvtsubtableheading2">
//               {" "}
//               A partnership involves two or more individuals (partners) who
//               share ownership and management responsibilities.
//             </p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol2">
...
//               (shareholders). Shareholders have limited liability, and their
//               personal assets are not typically at risk for company debts.
//             </p>
//           </div>
//         </div>
//         <div className="row custompvtltablerow">
//           <div className="col-xs-1 custompvtlcol1">
//             <p className="pvtsubtableheading1">Registration Time</p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol4">
//             <p className="pvtsubtableheading2 text-center">7-15 working days</p>
//             <p></p>
//           </div>
//         </div>
//         <div className="row custompvtltablerow">
//           <div className="col-xs-1 custompvtlcol1">
//             <p className="pvtsubtableheading1">Promoter Liability</p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol5">
//             <p className="pvtsubtableheading4 text-center">
//               Unlimited Liability
//             </p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol5">
//             <p className="pvtsubtableheading4 text-center">Limited Liability</p>
//             <p></p>
//           </div>
//         </div>
//         <div className="row custompvtltablerow">
//           <div className="col-xs-1 custompvtlcol1">
//             <p className="pvtsubtableheading1">Governance</p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading2">Governed by Local Laws</p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol3">
//             <p className="pvtsubtableheading2">Under Partnership Act, 1932</p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading2">LLP Act, 2008</p>
//           </div>
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading2">Under Companies Act,2013</p>
//           </div>
//         </div>
//         <div className="row custompvtltablerow">
//           <div className="col-xs-1 custompvtlcol1">
//             <p className="pvtsubtableheading1">Compliance Requirements</p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading2">
//               Compliance in accordance with- Income Tax Laws and other Local
//               Laws
//             </p>
//           </div>
//           <div className="col-xs-2 custompvtlcol3">
...
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading2">
//               Compliance in accordance with-Income Tax Laws, Local Laws,
//               Companies Act and other as applicable
//             </p>
//           </div>
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading2">
...
//         <div className="row custompvtltablerow">
//           <div className="col-xs-1 custompvtlcol1">
//             <p className="pvtsubtableheading1">Taxation</p>
//             <p></p>
//           </div>
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading2">
...
//           <div className="col-xs-2 custompvtlcol2">
//             <p className="pvtsubtableheading2">
//               Subject to corporate tax rates. Shareholders are taxed on
//               dividends received.
//             </p>
//           </div>
//         </div>
...
//       <p className="servicehrheading">
//         &nbsp;{" "}
//         <img src="images/services/question.svg" className="Howtoapplyimage" />{" "}
//         How to apply&nbsp;
//       </p>
//       <hr className="Howtoapplyhr1" />
...
//       <center>
//         <img
//           src="images/gstregistration/Limited-Liability-Partnership(LLP)-Registration%402x.png"
...
//         &nbsp;{" "}
//         <img
//           src="images/gstregistration/Path%2019952.svg"
...
//                 <p className="companybenefitscardheading">Limited Liability</p>
//                 <p className="companybenefitscardtext">
//                   The partners of an LLP have limited liability, which means
//                   their personal assets are protected in case of business debts
//                   or legal liabilities. The personal assets of partners are not
//                   at risk, and their liability is limited to their agreed-upon
//                   contribution to the LLP.
//                 </p>
//               </div>
//               <div className="col-md-4 col-sm-4 col-xs-4 col-12">
//                 <img
//                   src="images/companyregimage/limited-liability.svg"
...
//                   It can own assets, enter into contracts, and sue or be sued in
//                   its own name. This separation provides a clear distinction
//                   between personal and business matters.
//                 </p>
//               </div>
//               <div className="col-md-4 col-sm-4 col-xs-4 col-12">
//                 <img
//                   src="images/companyregimage/Seperate-Legal-Entity.svg"
//                   className="companybenefitscardimg companybenefitscardimgmargin1"
//                 />
//               </div>
//             </div>
...
//                 </p>
//                 <p className="companybenefitscardtext ">
//                   LLP registration involves a simple and straightforward process
//                   compared to other business structures like companies. It has
//                   fewer compliance requirements and ongoing obligations,
//                   reducing the administrative burden and costs of compliance.
//                 </p>
//               </div>
//               <div className="col-md-4 col-sm-4 col-xs-4 col-12">
//                 <img
//                   src="images/companyregimage/Maintenance-formation.svg"
...
//                 </p>
//                 <p className="companybenefitscardtext ">
//                   LLPs provide flexibility in terms of ownership and management.
//                   Partners have the freedom to determine the profit-sharing
//                   ratio and the decision-making process within the LLP. They can
//                   also admit new partners or remove existing partners based on
//                   the LLP agreement.
//                 </p>
//               </div>
//               <div className="col-md-4 col-sm-4 col-xs-4 col-12">
//                 <img
//                   src="images/companyregimage/management-ownership.svg"
//                   className="companybenefitscardimg companybenefitscardimgmargin2"
//                 />
//               </div>
//             </div>
...
//                 </p>
//                 <p className="companybenefitscardtext ">
//                   LLPs do not have any prescribed minimum capital requirement.
//                   Partners can contribute capital as per their agreement, making
//                   it easier to start and operate the business with lower
//                   financial obligations.
//                 </p>
//               </div>
//               <div className="col-md-4 col-sm-4 col-xs-4 col-12">
//                 <img
//                   src="images/companyregimage/capital.svg"
//                   className="companybenefitscardimg companybenefitscardimgmargin2"
//                 />
//               </div>
//             </div>
...
//                 </p>
//                 <p className="companybenefitscardtext ">
//                   LLPs enjoy the benefits of pass-through taxation. The LLP
//                   itself is not taxed at the entity level. Instead, the partners
//                   are taxed individually on their share of profits or income.
//                   This eliminates the issue of double taxation that companies
//                   may face.
//                 </p>
//               </div>
//               <div className="col-md-4 col-sm-4 col-xs-4 col-12">
//                 <img
//                   src="images/companyregimage/tax-benifits.svg"
//                   className="companybenefitscardimg"
//                 />
//               </div>
//             </div>
//           </div>
...
//                 </p>
//                 <p className="companybenefitscardtext ">
//                   LLP registration protects partners from being held personally
//                   liable for the wrongful acts or misconduct of other partners.
//                   Each partner is responsible for their own actions and is not
//                   automatically liable for the actions of other partners.
//                 </p>
//               </div>
//               <div className="col-md-4 col-sm-4 col-xs-4 col-12">
//                 <img
//                   src="images/companyregimage/partner-protection.svg"
//                   className="companybenefitscardimg "
//                 />
//               </div>
//             </div>
...
//                 </p>
//                 <p className="companybenefitscardtext ">
//                   Registering as an LLP enhances the credibility and
//                   trustworthiness of the business. It provides a formal legal
//                   structure, which can be beneficial while dealing with clients,
//                   suppliers, lenders, and other stakeholders.
//                 </p>
//               </div>
//               <div className="col-md-4 col-sm-4 col-xs-4 col-12">
//                 <img
//                   src="images/companyregimage/Increased-Credibility.svg"
//                   className="companybenefitscardimg "
//                 />
//               </div>
//             </div>
...
//               <span className="love">
//                 L<img className="heartimg" src="images/bookdemo/heart.svg" />
//                 ve
//               </span>{" "}
//               From
...
//               appreciate our expertise in getting their Legal work done on time.
//               We value the trust our clients place in us, and we strive to
...
//                     src="images/bookdemo/Kailash_Chandra_Verma.jpg"
//                   />
//                 </div>
//                 <div>
...
//                     <div>
//                       <img className="cords " src="images/bookdemo/quote.svg" />
//                     </div>
...
//                       Filing my GST returns had been an absolute nightmare until
//                       I found Legal251. The interface is so easy to use, it
//                       makes filing my returns on time a breeze. I can easily
//                       keep track of all my invoices and payments and Legal251
//                       experts even provides helpful tips for me to make sure
//                       that everything is done correctly. Thanks to Legal251
//                       team, filing GST returns has become stress-free!
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//                   <img
//                     className="cords testimonialimg"
//                     src="images/bookdemo/Virendra_Vishwkarma.jpg"
//                   />
//                 </div>
//                 <div>
...
//                       came across Legal251. They were thorough professionals who
//                       made sure that my documents were filed perfectly without
//                       any errors. Their customer service was also top-notch and
//                       they guided me through the entire process with ease. I'm
//                       glad that I chose Legal251 for filing my GST returns.
//                       Highly recommended!
//                     </p>
//                   </div>
//                 </div>
...
//                   <img
//                     className="cords testimonialimg"
//                     src="images/bookdemo/PriyankaVerma.jpg"
//                   />
//                 </div>
//                 <div>
...
//                   <div>
//                     <p className="ptext anim-top">
//                       I've been using Legal251 for filing my GST returns for the
//                       past few months and I'm extremely impressed with their
//                       service and platform. It's so easy to use, and all the
//                       necessary information is provided in a very organized way.
//                       Plus, filing my returns on time has become so much easier
//                       with this platform. Highly recommend Legal251 for anyone
//                       looking for an efficient way to file their GST returns.
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//                   <img
//                     className="cords testimonialimg"
//                     src="images/bookdemo/Monu_Panchal.jpg"
//                   />
//                 </div>
//                 <div>
...
//                       with this task as they have an excellent knowledge of the
//                       regulations and ensured that everything was done
//                       correctly. Thank you!
//                     </p>
//                   </div>
//                 </div>
...
//         &nbsp;{" "}
//         <img
//           src="images/services/registration.svg"
...
//           <center>
//             <img
//               src="images/companyregimage/Group%208586.png"
//               className="minimumreqdivimg1 dregprocessimg"
//             />
//             <img
//               src="images/companyregimage/Group_111862x.png"
//               className="minimumreqdivimg1 dregprocessimg1"
//             />{" "}
//           </center>
//         </div>
//       </div>
...
//       <br />
//       <p className="servicehrheading">
//         &nbsp; <img src="images/services/faq.svg" className="FAQsimage" />{" "}
//         FAQs&nbsp;
//       </p>
...
//                     organisation that combines the benefits of a partnership and
//                     limited liability. It provides partners with limited
//                     liability protection while allowing them to actively
...
//                       href="#collapse2"
//                     >
//                       Q2: What are the minimum requirements to register an LLP?
//                       <img
...
//                   <div className="panel-body servicefaqbody">
//                     {" "}
//                     The minimum requirements to register an LLP typically
//                     include:
//                     <ul style={{ marginTop: 10 }}>
//                       <li>
//                         A minimum of two partners (individuals or corporate
//                         entities).
//                       </li>
//                       <li>
//                         At least two designated partners (individuals) who will
//                         be responsible for compliance and management.
//                       </li>
...
//                 >
//                   <div className="panel-body servicefaqbody">
//                     No, an LLP must have a minimum of two partners. However,
//                     there is no upper limit on the maximum number of partners in
//                     an LLP.
//                   </div>
//                 </div>
//               </div>
...
//                       href="#collapse4"
//                     >
//                       Q4: What is the difference between an LLP and a private
//                       limited company?
//                       <img
//                         src="images/gstregistration/Path_20191.svg"
//                         className="servicefaqimg"
...
//                 >
//                   <div className="panel-body servicefaqbody">
//                     The key differences between an LLP and a private limited
//                     company include:
//                     <ul style={{ marginTop: 10 }}>
//                       <li>
//                         LLP offers limited liability protection to partners,
//                         while a private limited company offers limited liability
//                         to its shareholders.
//                       </li>
//                       <li>
//                         An LLP has fewer compliance requirements and lower
//                         ongoing costs compared to a private limited company.
//                       </li>
//                       <li>
//                         An LLP is taxed as a partnership, with partners being
//                         individually taxed, while a private limited company is
//                         taxed separately at the entity level.
//                       </li>
//                     </ul>
//                   </div>
//                 </div>
...
//                       href="#collapse5"
//                     >
//                       Q5: Can an LLP be converted into a private limited
//                       company?
//                       <img
//                         src="images/gstregistration/Path_20191.svg"
//                         className="servicefaqimg"
...
//                 >
//                   <div className="panel-body servicefaqbody">
//                     Yes, it is possible to convert an LLP into a private limited
//                     company. However, the conversion process involves compliance
//                     with the relevant laws and regulations, including obtaining
...
//                       href="#collapse21"
//                     >
//                       Q6: Can foreign nationals or Non-Resident Indians (NRIs)
...
//                 >
//                   <div className="panel-body servicefaqbody">
//                     Yes, foreign nationals and NRIs can be partners in an LLP.
//                     There are no restrictions on their participation, subject to
//                     compliance with foreign direct investment (FDI) guidelines
...
//                       href="#collapse22"
//                     >
//                       Q7: Can an LLP change its registered office address?
//                       <img
//                         src="images/gstregistration/Path_20191.svg"
//                         className="servicefaqimg"
//                       />
...
//                 >
//                   <div className="panel-body servicefaqbody">
//                     Yes, an LLP can change its registered office address. The
//                     process involves obtaining partner approval, notifying the
//                     Registrar of Companies (RoC), and updating the necessary
//                     documents and records with the new address.{" "}
//                   </div>
//                 </div>
//               </div>
//               <div className="panel panel-default servicefaqmainpanel">
...
//                       href="#collapse23"
//                     >
//                       Q8: Is it mandatory to have an LLP agreement?
//                       <img
//                         src="images/gstregistration/Path_20191.svg"
//                         className="servicefaqimg"
//                       />
...
//                 >
//                   <div className="panel-body servicefaqbody">
//                     Yes, it is mandatory for an LLP to have an LLP agreement.
//                     The agreement outlines the rights, duties, and obligations
//                     of partners, as well as the LLP's operational and management
//                     structure. It must be prepared and filed with the Registrar
//                     at the time of LLP registration.
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//         &nbsp;{" "}
//         <img
//           src="images/services/Layer%202.svg"
...
//         style={{
//           background: 'url("images/services/Mask%20Group%2033%20(1.html).jpg")',
...
//       </div>
//       <img
//         src="images/services/Why%20choose%20us.svg"
...
//               <a
//                 href="cdn-cgi/l/email-protection.html#6f0c00011b0e0c1b2f030a080e035d5a5e410c0002"
//                 style={{ textDecoration: "underline", color: "#fff" }}
//                 className="footertext"
//               >
//                 <span
//                   className="__cf_email__"
//                   data-cfemail="3a5955544e5b594e7a565f5d5b56080f0b14595557"
//                 >
//                   [email&nbsp;protected]
//                 </span>
//               </a>
...
//             <div className="col-md-5">
//               <center>
//                 <p className="Subscribeinfoheading">Subscribe for more info</p>
...
//       </div>
//     </div>
//     <div className="modal fade" id="termandcondition_modal" role="dialog">
//       <div className="modal-dialog modalmainwidth" style={{ border: "none" }}>
//         <div
//           className="modal-content"
//           style={{ borderRadius: 10, border: "none" }}
...
//             <div className="legallandingnorow">
//               <table className="termcondtable">
//                 <tbody>
//                   <tr className="points">
//                     <th className="points">1.</th>
//                     <th className="points">
//                       In Rajasthan &amp; Kerela , the charges are 12,251/-.
//                       (Including all fees &amp; taxes) (Because of High stamp
//                       duties in respective states)
//                     </th>
//                   </tr>
//                   <tr>
//                     <th className="points">2.</th>
//                     <th className="points">
//                       E-Pass tokens accompanied by digital signatures from
//                       eMudhra with a validity of 2 years.
//                     </th>
//                   </tr>
//                   <tr>
//                     <th className="points">3.</th>
//                     <th className="points">
//                       Up to 2 name options can be provided in a single RUN
//                       application when requesting name approval.
//                     </th>
//                   </tr>
//                   <tr>
//                     <th className="points">4.</th>
//                     <th className="points">
//                       Additional Directors can be added for Rs. 1000 if DSC
//                       (Digital Signature Certificate) &amp; DIN (Director
//                       Identification Number) are available. If neither DIN nor
//                       DSC is available, adding Director will be Rs. 2500,
//                       including GST.
//                     </th>
//                   </tr>
//                 </tbody>
...
//    </>
  ...
  <div className="wrapper">
    ...
    <iframe
      ...
      data-load-time={1700045256393}
      height={0}
      width={0}
      style={{ display: "none", visibility: "hidden" }}
      src="https://td.doubleclick.net/td/rul/11126145977?random=1700045256386&cv=11&fst=1700045256386&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1536&u_h=864&url=https%3A%2F%2Flegal251.com%2Fllp-company-registration&ref=https%3A%2F%2Flegal251.com%2Fllp-company-registration&label=Remarketing%20Tag&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20LLP%20Company%20Registration&auid=1635319576.1700023944&fledge=1&uaa=x86&uab=64&uafvl=Google%2520Chrome%3B119.0.6045.124%7CChromium%3B119.0.6045.124%7CNot%253FA_Brand%3B24.0.0.0&uamb=0&uap=Windows&uapv=10.0.0&uaw=0"
    />
    <div style={{ position: "relative", overflowX: "hidden" }}>
      <div className="wrapper page-section" id="overview">
                      ...
                      <div className="col-menu col-md-5">
                        ...
                        <div className="content animated">
                          <ul className="menu-col" id="id01">
                            ...
                            <li className="incontent">
                            <Link to='/ParternLtdCompanyRegisteration'>
                            </Link>
                                <img
                                  className="megamenu_icon"
                  ...
                  <li className="allcontent newincontent allcontent12">
                    <div className="row">
                      <div className="col-menu col-md-4">
                        ...
                        <div className="content le_cpadd animated">
                          <ul className="menu-col" id="id01">
                            <li className="incontent">
                  ...
                  <li className="allcontent newincontent allcontent12">
                    <div className="row">
                      <div className="col-menu col-md-5 pleft">
                        ...
                        <div className="content o_cpadd animated">
                          <ul className="menu-col" id="id01">
                            <li className="incontent">
                  ...
                  <li className="allcontent newincontent allcontent12">
                    <div className="row">
                      <div className="col-menu">
                        ...
                        <div className="col-menu col-md-4 dcol">
                          <div className="content lo_cpadd animated">
                            <ul className="menu-col" id="id01">
                              <li className="incontent">
      ...
      <div>
          ...
          <div className="companycustomcolrow">
            <div className="row">
              <div className="col-md-7 companycustomcol1">
                ...
                <img
                  className="companylegalimg"
                  src="https://legal251.com/images/companyregimage/Group 9403.png"
                />
                <p className="companypageheading">
                  Limited Liability Partnership (LLP) Registration
                </p>
                ...
                >
                  ...
                  >
                    <img
                      src="https://legal251.com/images/companyregimage/Icon feather-info.svg"
                      style={{ width: 14, marginTop: "-2px", marginRight: 5 }}
                      className="Howtoapplyimage"
                    />
                    Terms &amp; Condition
                ...
                <img
                  src="https://legal251.com/images/companyregimage/Line2.png"
                  className="boderimgline"
                />
                <p className="companygovfees">
                  Government fees &amp; stamp duties extra. Please fill form to
                  get detailed quote in seconds.{" "}
                </p>
                <p className="companygovfees2">
                  In 2 Weeks . Transparent Pricing . No Hidden Cost
                </p>
                <div className="packagecard">
                  ...
                  <div className="row packagecardrow">
                    <div className="col-md-2 col-xs-4 colpaddingzero">
                      <center>
                        <img
                          src="https://legal251.com/images/bookdemo/pan.svg"
                          className="roundimg"
                        />
                        <p className="packagecardtext packagecardtext1">
                          PAN &amp; TAN Registration
                    ...
                    <div className="col-md-2 col-xs-4 colpaddingzero">
                      <center>
                        <img
                          src="https://legal251.com/images/bookdemo/Group 9162.svg"
                          className="roundimg"
                        />
                        <p className="packagecardtext packagecardtext1">
                          DIN and DSC for Partner
                    ...
                    <div className="col-md-2 col-xs-4 colpaddingzero">
                      <center>
                        <img
                          src="https://legal251.com/images/bookdemo/Group_9161.svg"
                          className="roundimg"
                        />
                        <p className="packagecardtext packagecardtext1">
                          Complete Documentation
                    ...
                    <div className="col-md-2 col-xs-4 colpaddingzero">
                      <center>
                        <img
                          src="https://legal251.com/images/bookdemo/Group 9164.svg"
                          className="roundimg"
                        />
                        <p className="packagecardtext packagecardtext1">
                          Personal Assistance
                  ...
                  <div className="companyformdiv" style={{ marginTop: 0 }}>
                    ...
                    >
                      <option
                        className="cities"
                        data-value=""
                        data-select2-id="select2-data-2-096h"
                      />
                      <option className="cities" data-value={1}>
                        Adilabad
                      </option>
                    ...
                    <span
                      ...
                      dir="ltr"
                      data-select2-id="select2-data-1-ohbz"
                      style={{ width: "349.788px" }}
                    >
          ...
          <div className="companyaboutsection">
            <div className="row">
              ...
              <div className="col-md-7 companycustomcol4 videopvtltextdiv">
                ...
                <br />
                <p className="companyaboutsectiontext">
                  One of India's preferred forms of business among entrepreneurs
                  is Limited Liability Partnership (LLP). LLP is an alternative
                  corporate business form that gives the benefits of both a
                  Company and a Partnership Firm.
                  <br />
                  <br /> The LLP is a separate legal entity and is liable to the
                  full extent of its assets. Still, the liability of the
                  partners is limited to their agreed contribution to the LLP,
                  and only a minimum of two partners are required to incorporate
                  an LLP. For Limited Liability Partnership to be a legally
                  valid entity, it must be registered under the Limited
                  Liability Partnership Act, 2008.
                  <br />
                  <br /> So, are you ready to take your business to the next
                  level? Legal251's Limited Liability Partnership (LLP)
                  Registration is the perfect way to do it! With our hassle-free
                  process, get all the legal assistance you need to register
                  your LLP in no time, enjoy the peace of mind that comes with
                  Legal251's professional service, and get ready for success!
                </p>
              </div>
            </div>
          </div>
        ...
        <div id="comparison" className="page-section">
          ...
          <div className="custompvtltablemainrow">
            ...
            <div className="row custompvtltablerow">
              ...
              <div className="col-xs-2 custompvtlcol2">
                <p className="pvtsubtableheading2">
                  A sole proprietorship is a business owned and operated by a
                  single individual.
                </p>
                <p></p>
              </div>
              <div className="col-xs-2 custompvtlcol3">
                <p className="pvtsubtableheading2">
                  A partnership is a legal arrangement where two or more
                  individuals or entities agree to share ownership,
                  responsibilities, profits, and liabilities of a business.
                </p>
                <p></p>
              </div>
              <div className="col-xs-2 custompvtlcol2">
                <p className="pvtsubtableheading2">
                  An LLP is a hybrid business structure that combines elements
                  of partnerships and company. It offers limited liability to
                  its partners, protecting their personal assets from the
                  liabilities of the business.
                </p>
              </div>
              <div className="col-xs-2 custompvtlcol2">
                <p className="pvtsubtableheading2">
                  A company is a legal entity that exists separately from its
                  owners (shareholders). It can be a private limited company or
                  a public limited company. Shareholders' are the owners of the
                  company and their liability is limited to their investment,
                  and the company's operations and management are governed by
            ...
            <div className="row custompvtltablerow">
              ...
              <div className="col-xs-2 custompvtlcol2">
                <p className="pvtsubtableheading2">
                  ...
                  are generally protected from business debts or liabilities.
                </p>
              </div>
              <div className="col-xs-2 custompvtlcol2">
                <p className="pvtsubtableheading2">
            ...
            <div className="row custompvtltablerow">
              ...
              <div className="col-xs-2 custompvtlcol4">
                <p className="pvtsubtableheading2 text-center">
                  7-15 working days
                </p>
                <p></p>
              </div>
            ...
            <div className="row custompvtltablerow">
              ...
              <div className="col-xs-2 custompvtlcol3">
                <p className="pvtsubtableheading2">
                  Income is generally taxed at the individual partners' income
                  tax rates.
                </p>
              </div>
              <div className="col-xs-2 custompvtlcol2">
                <p className="pvtsubtableheading2">
                  Taxed as a partnership, where partners are individually taxed
        ...
        <div id="Howtoapply" className="page-section">
          ...
          <center>
            <img
              src="https://legal251.com/images/gstregistration/Limited-Liability-Partnership(LLP)-Registration@2x.png"
              className="gsthowtoapplyimg"
            />
          </center>
        </div>
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext">
                      The partners of an LLP have limited liability, which means
                      their personal assets are protected in case of business
                      debts or legal liabilities. The personal assets of
                      partners are not at risk, and their liability is limited
                      to their agreed-upon contribution to the LLP.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
                      src="https://legal251.com/images/companyregimage/limited-liability.svg"
                      className="companybenefitscardimg companybenefitscardimgmargin1"
                    />
                  </div>
                </div>
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      An LLP is a separate legal entity distinct from its
                      partners. It can own assets, enter into contracts, and sue
                      or be sued in its own name. This separation provides a
                      clear distinction between personal and business matters.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
                      src="https://legal251.com/images/companyregimage/Seperate-Legal-Entity.svg"
                      className="companybenefitscardimg companybenefitscardimgmargin1"
                    />
                  </div>
                </div>
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      LLP registration involves a simple and straightforward
                      process compared to other business structures like
                      companies. It has fewer compliance requirements and
                      ongoing obligations, reducing the administrative burden
                      and costs of compliance.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
                      src="https://legal251.com/images/companyregimage/Maintenance-formation.svg"
                      className="companybenefitscardimg companybenefitscardimgmargin2"
                    />
                  </div>
                </div>
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      LLPs provide flexibility in terms of ownership and
                      management. Partners have the freedom to determine the
                      profit-sharing ratio and the decision-making process
                      within the LLP. They can also admit new partners or remove
                      existing partners based on the LLP agreement.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
                      src="https://legal251.com/images/companyregimage/management-ownership.svg"
                      className="companybenefitscardimg companybenefitscardimgmargin2"
                    />
                  </div>
                </div>
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      LLPs do not have any prescribed minimum capital
                      requirement. Partners can contribute capital as per their
                      agreement, making it easier to start and operate the
                      business with lower financial obligations.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
                      src="https://legal251.com/images/companyregimage/capital.svg"
                      className="companybenefitscardimg companybenefitscardimgmargin2"
                    />
                  </div>
                </div>
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      LLPs enjoy the benefits of pass-through taxation. The LLP
                      itself is not taxed at the entity level. Instead, the
                      partners are taxed individually on their share of profits
                      or income. This eliminates the issue of double taxation
                      that companies may face.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
                      src="https://legal251.com/images/companyregimage/tax-benifits.svg"
                      className="companybenefitscardimg"
                    />
                  </div>
                </div>
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      LLP registration protects partners from being held
                      personally liable for the wrongful acts or misconduct of
                      other partners. Each partner is responsible for their own
                      actions and is not automatically liable for the actions of
                      other partners.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
                      src="https://legal251.com/images/companyregimage/partner-protection.svg"
                      className="companybenefitscardimg "
                    />
                  </div>
                </div>
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      Registering as an LLP enhances the credibility and
                      trustworthiness of the business. It provides a formal
                      legal structure, which can be beneficial while dealing
                      with clients, suppliers, lenders, and other stakeholders.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
        ...
        <section className="testimonial">
          <div className="row">
              ...
              <div className="testmdiv">
                ...
                <h3 className="test_heading">
                  <span className="love">
                    ...
                    <img
                      className="heartimg"
                      src="https://legal251.com/images/bookdemo/heart.svg"
                    />
                    ve
                  </span>{" "}
                  From
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-8">
              ...
              >
                <div className="owl-stage-outer" data-position={0}>
                  <div
                    className="owl-stage"
                    style={{
                  ...
                  >
                    <div
                      ...
                      style={{ width: "375.2px", marginRight: 60 }}
                    >
                      <div className="item" style={{ width: 400 }}>
                        <div className="owlcarhead">
                          <div className="croimgdiv">
                            <img
                              className="cords testimonialimg"
                              src="https://legal251.com/images/bookdemo/PriyankaVerma.jpg"
                            />
                          </div>
                          <div>
                            <h6 className="owlhead">Priyanka Agnihotri</h6>
                          ...
                          <div className="box1 scrollAnim fade-in-up ">
                            <div className="contenthead anim-top testicard">
                              <div>
                                <img
                                  className="cords"
                                  src="https://legal251.com/images/bookdemo/quote.svg"
                                />
                              </div>
                              <div className="ratestar">
                                <div>
                            ...
                            <div>
                              <p className="ptext anim-top">
                                I've been using Legal251 for filing my GST
                                returns for the past few months and I'm
                                extremely impressed with their service and
                                platform. It's so easy to use, and all the
                                necessary information is provided in a very
                                organized way. Plus, filing my returns on time
                                has become so much easier with this platform.
                                Highly recommend Legal251 for anyone looking for
                      ...
                      <div className="item" style={{ width: 400 }}>
                        <div className="owlcarhead">
                          <div className="croimgdiv">
                            <img
                              className="cords testimonialimg"
                              src="https://legal251.com/images/bookdemo/Monu_Panchal.jpg"
                            />
                          </div>
                          <div>
                            <h6 className="owlhead">Monu Panchal </h6>
                        ...
                        <div className=" owlcard">
                          <div className="box1 scrollAnim fade-in-up ">
                            ...
                            <div>
                              <p className="ptext anim-top">
                                I was a bit worried when filing my GST return
                                for the first time, but Legal251 made it a
                                breeze. Their team of experts guided me through
                                every step and filed my return perfectly. I'm
                                really glad I chose Legal251 to help me with
                                this task as they have an excellent knowledge of
                                the regulations and ensured that everything was
                      ...
                      <div className="item" style={{ width: 400 }}>
                        ...
                        <div className=" owlcard">
                          <div className="box1 scrollAnim fade-in-up ">
                            ...
                            <div>
                              <p className="ptext anim-top">
                                Filing my GST returns had been an absolute
                                nightmare until I found Legal251. The interface
                                is so easy to use, it makes filing my returns on
                                time a breeze. I can easily keep track of all my
                                invoices and payments and Legal251 experts even
                                provides helpful tips for me to make sure that
                                everything is done correctly. Thanks to Legal251
                                team, filing GST returns has become stress-free!
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="item" style={{ width: 400 }}>
                        <div className="owlcarhead">
                          <div className="croimgdiv">
                            <img
                              className="cords testimonialimg"
                              src="https://legal251.com/images/bookdemo/Virendra_Vishwkarma.jpg"
                            />
                          </div>
                          <div>
                            <h6 className="owlhead">Virendra Vishwkarma</h6>
                        ...
                        <div className=" owlcard">
                          <div className="box1 scrollAnim fade-in-up ">
                            ...
                            <div>
                              <p className="ptext anim-top">
                                I was having a hard time filing my GST returns
                                and was really confused as to how to go about
                                it. That's when I came across Legal251. They
                                were thorough professionals who made sure that
                                my documents were filed perfectly without any
                                errors. Their customer service was also
                                top-notch and they guided me through the entire
                                process with ease. I'm glad that I chose
                ...
                <div className="owl-nav" data-position={1}>
                  <button
                    type="button"
                    role="presentation"
                    className="owl-prev"
                  >
                    {" "}
                    <img
                      src="https://legal251.com/images/bookdemo/Icon awesome-long-arrow-alt-right.svg"
                      style={{ width: 35 }}
                      className=""
                    />
                  </button>
                  ...
                  >
                    {" "}
                    <img
                      src="https://legal251.com/images/bookdemo/Icon awesome-long-arrow-alt-left.svg"
                      style={{ width: 35 }}
                      className=""
                    />
                  </button>
                </div>
                <div className="owl-dots" data-position={2}>
        ...
        <div id="Registrationprocess" className="page-section">
          ...
          <div className="">
            <div className="" style={{ marginTop: 0 }}>
              <center>
                <img
                  src="https://legal251.com/images/companyregimage/Group 8586.png"
                  className="minimumreqdivimg1 dregprocessimg"
                />
                <img
                  src="https://legal251.com/images/companyregimage/Group_111862x.png"
                  className="minimumreqdivimg1 dregprocessimg1"
                />{" "}
              </center>
            </div>
                  ...
                  <div className="panel panel-default servicefaqmainpanel">
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        ...
                        business organisation that combines the benefits of a
                        partnership and limited liability. It provides partners
                        with limited liability protection while allowing them to
                    ...
                    <div className="panel-heading servicefaqpanelheading">
                      <h4 className="panel-title">
                        <a
                          ...
                          href="#collapse2"
                        >
                          Q2: What are the minimum requirements to register an
                          LLP?
                          <img
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        ...
                        <ul style={{ marginTop: 10 }}>
                          ...
                          <li>
                            At least two designated partners (individuals) who
                            will be responsible for compliance and management.
                          </li>
                          <li>A registered office address in India.</li>
                        </ul>
                      </div>
                    ...
                    <div className="panel-heading servicefaqpanelheading">
                      <h4 className="panel-title">
                        <a
                          ...
                          href="#collapse4"
                        >
                          Q4: What is the difference between an LLP and a
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        ...
                        <ul style={{ marginTop: 10 }}>
                          <li>
                            LLP offers limited liability protection to partners,
                            while a private limited company offers limited
                          ...
                          <li>
                            An LLP is taxed as a partnership, with partners
                            being individually taxed, while a private limited
                            company is taxed separately at the entity level.
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div className="col-md-6 servicefaqcol2">
                <div className="panel-group" id="accordion2">
                  <div className="panel panel-default servicefaqmainpanel">
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        Yes, it is possible to convert an LLP into a private
                        limited company. However, the conversion process
                        involves compliance with the relevant laws and
                        regulations, including obtaining necessary approvals
                  ...
                  <div className="panel panel-default servicefaqmainpanel">
                    <div className="panel-heading servicefaqpanelheading">
                      <h4 className="panel-title">
                        <a
                          ...
                          href="#collapse21"
                        >
                          Q6: Can foreign nationals or Non-Resident Indians
                          (NRIs) be partners in an LLP?
                          <img
                            src="https://legal251.com/images/gstregistration/Path_20192.svg"
                            className="servicefaqimg"
                          />
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        Yes, foreign nationals and NRIs can be partners in an
                        LLP. There are no restrictions on their participation,
                        subject to compliance with foreign direct investment
                        (FDI) guidelines and other applicable laws.
                      </div>
                    </div>
                  </div>
                  <div className="panel panel-default servicefaqmainpanel">
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        Yes, an LLP can change its registered office address.
                        The process involves obtaining partner approval,
                        notifying the Registrar of Companies (RoC), and updating
                        the necessary documents and records with the new
                        address.{" "}
                      </div>
                    </div>
                  </div>
                  <div className="panel panel-default servicefaqmainpanel">
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        Yes, it is mandatory for an LLP to have an LLP
                        agreement. The agreement outlines the rights, duties,
                        and obligations of partners, as well as the LLP's
                        operational and management structure. It must be
                        prepared and filed with the Registrar at the time of LLP
                        registration.
                      </div>
                    </div>
                  </div>
              ...
              <div className="col-xs-4">
                <center>
                  <div>
                    ...
                    >
                      We believe in growth and improvement at all costs. For us,
                      growth is the law of life and it shall be fulfilled. We
                      know the importance of business and its growth for you.
                    </p>
                    <br />
                  </div>
                </center>
                ...
                <center>
                  <div>
                    ...
                    >
                      ...
                      and solve any of such problems at every particular
                      instance in time.{" "}
                    </p>
                    <br />
                  </div>
                ...
                <center>
                  <div>
                    ...
                    >
                      ...
                      why our team members are always focused on taking care of
                      even the smallest of our clients' needs and requirements.
                    </p>
                  </div>
                </center>
              </div>
                ...
                <center>
                  <div>
                    ...
                    >
                      ...
                      your problems, as well as achievements, are our very own.
                      Your interests are ours and their fulfillment is at the
                      top in our regards.
                    </p>
                  </div>
                </center>
                  ...
                  <table className="termcondtable">
                    <tbody>
                      <tr className="points">
                        ...
                        <th className="points">
                          In Rajasthan &amp; Kerela , the charges are 12,251/-.
                          (Including all fees &amp; taxes) (Because of High
                          stamp duties in respective states)
                        </th>
                      </tr>
                      <tr>
                        <th className="points">2.</th>
                      ...
                      <tr>
                        ...
                        <th className="points">
                          Additional Directors can be added for Rs. 1000 if DSC
                          (Digital Signature Certificate) &amp; DIN (Director
                          Identification Number) are available. If neither DIN
                          nor DSC is available, adding Director will be Rs.
                          2500, including GST.
                        </th>
                      </tr>
                    </tbody>
  ...
  <div id="intercom-container" className="intercom-namespace">
    ...
    <div className="intercom-app" aria-live="polite">
      <div className="intercom-messenger-frame intercom-mzb6hf ed8ycz90" />
      <div className="intercom-dfosxs e2u51n60">
        <iframe
          allowFullScreen=""
          className="intercom-launcher-frame intercom-lzkgdq efr23pf0"
          name="intercom-launcher-frame"
          title="Intercom live chat"
          data-intercom-frame="true"
          role="dialog"
        />
        <div className="intercom-1o77lls e1g2dbjq0">
          <span
            data-testid="active-notifications"
            className="intercom-1ugnki8 e1lwd7c40"
          >
            1
          </span>
        </div>
  ...
  <div id="intercom-css-container">
    <style
      data-emotion="intercom-global"
      dangerouslySetInnerHTML={{ __html: "" }}
    />
    <style data-emotion="intercom" dangerouslySetInnerHTML={{ __html: "" }} />
  </div>
</>
