                      ...
                      <div className="companyformdiv" style={{ marginTop: 0 }}>
                        ...
                        >
                          <option
                            className="cities"
                            data-value=""
                            data-select2-id="select2-data-2-y02j"
                          />
                        ...
                        <span
                          ...
                          dir="ltr"
                          data-select2-id="select2-data-1-lvg9"
                ...
                <div className="row">
                  ...
                  <div className="col-md-7 companycustomcol4 videopvtltextdiv">
                    ...
                    <p className="companyaboutsectiontext">
                      Grow your business! Register it as a Private Limited
                      Company with complete legal protection. A Private Limited
                      Company is a company privately held for small businesses.
                      This business entity limits owner liability to their
                      shareholdings and the number of shareholders to 200 and
                      restricts shareholders from publicly trading shares.
                      <br />
                      <br /> It can have a minimum of 2 Directors and a maximum
                      of 15 Directors. Private limited company registration is
                      governed by the Companies Act of 2013 and the Companies
                      Incorporation Rules of 2014. Make it official with
                      Legal251's Private Limited Company Registration services!
                      <br />
                      <br /> We offer a complete package with easy
                      documentation, fast registration, and a hassle-free
                      experience – so you can focus on building and growing your
                      business. Register your private limited company today and
                      start enjoying the benefits of a registered business name!
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div id="Detailedprocess" className="page-section">
              ...
              <div className="row companybenefitscardrow">
                <div className="col-md-6">
                  <div className="companybenefitscard companybenefitscard1">
                    <div className="row ">
                      ...
                      <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                        <img
                          ...
                          className="companybenefitscardimg companybenefitscardimgheight"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="companybenefitscard companybenefitscard1">
                    <div className="row ">
                      <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                        ...
                        <p className="companybenefitscardtext ">
                          The company has its own legal identity, separate from
                          its owners.
                        </p>
                      </div>
                      <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                  ...
                  <div className="companybenefitscard companybenefitscard1">
                    <div className="row ">
                      <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                        ...
                        <p className="companybenefitscardtext ">
                          The company continues to exist even if the
                          shareholders change.
                        </p>
                      </div>
                      <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                  ...
                  <div className="companybenefitscard companybenefitscard1">
                    <div className="row ">
                      <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                        ...
                        <p className="companybenefitscardtext ">
                          Private limited companies can raise funds by issuing
                          shares.
                        </p>
                      </div>
                      <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                  ...
                  <div className="companybenefitscard companybenefitscard1">
                    <div className="row ">
                      <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                        ...
                        <p className="companybenefitscardtext ">
                          Private limited companies have less stringent
                          compliance requirements compared to public companies.
                        </p>
                      </div>
                      <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                        <img
                          src="https://legal251.com/images/companyregimage/limited-compliance.svg"
                          className="companybenefitscardimg companybenefitscardimgheight"
                        />
                      </div>
                    </div>
                  ...
                  <div className="companybenefitscard companybenefitscard1">
                    <div className="row ">
                      <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                        ...
                        <p className="companybenefitscardtext ">
                          The structure of a private limited company is
                          attractive to potential investors.
                        </p>
                      </div>
                      <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                        <img
                          src="https://legal251.com/images/companyregimage/attracting-investors.svg"
                          className="companybenefitscardimg companybenefitscardimgheight"
                        />
                      </div>
                    </div>
                ...
                <div className="col-md-6">
                  <div className="companybenefitscard companybenefitscard1">
                    <div className="row ">
                      ...
                      <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                        <img
                          src="https://legal251.com/images/companyregimage/Separate-taxation.svg"
                          className="companybenefitscardimg companybenefitscardimgheight"
                        />
                      </div>
                    </div>
                  ...
                  <div className="companybenefitscard companybenefitscard1">
                    <div className="row ">
                      <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                        ...
                        <p className="companybenefitscardtext ">
                          Shareholders are only liable for the amount unpaid on
                          their shares.
                        </p>
                      </div>
                      <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                        <img
                          src="https://legal251.com/images/companyregimage/limited-risk.svg"
                          className="companybenefitscardimg companybenefitscardimgheight"
                        />
                      </div>
                    </div>
                  ...
                  <div className="companybenefitscard companybenefitscard1">
                    <div className="row ">
                      <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                        ...
                        <p className="companybenefitscardtext ">
                          Private limited companies have flexibility in
                          expanding their operations globally.
                        </p>
                      </div>
                      <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                        <img
                          src="https://legal251.com/images/companyregimage/global-expansion.svg"
                          className="companybenefitscardimg companybenefitscardimgheight"
                        />
                      </div>
                    </div>
                  ...
                  <div className="companybenefitscard companybenefitscard1">
                    <div className="row ">
                      <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                        ...
                        <p className="companybenefitscardtext ">
                          A company structure provides legal protection to
                          shareholders and directors.
                        </p>
                      </div>
                      <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                        <img
                          src="https://legal251.com/images/companyregimage/legal-protection.svg"
                          className="companybenefitscardimg companybenefitscardimgheight"
                        />
                      </div>
                    </div>
              ...
              <div className="">
                <div className="" style={{ marginTop: 0 }}>
                  <center>
                    ...
                    />
                    <img
                      src="https://legal251.com/images/companyregimage/Group_11170.png"
                    ...
                    >
                      <div className="panel panel-default servicefaqmainpanel">
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            ...
                            entity that offers limited liability protection to
                            its shareholders and restricts the transferability
                            of its shares. It requires a minimum of two
                            directors and two shareholders, with a maximum limit
                            of 200 shareholders.
                          </div>
                        </div>
                      </div>
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse2"
                            >
                              Q2: What are the key requirements to register a
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            {" "}
                            To register a Private Limited Company in India, you
                            need:
                            <ul>
                              <li>
                                Minimum two directors and shareholders (they can
                                be the same individuals).
                              </li>
                              <li>
                                At least one director should be a resident of
                                India.
                              </li>
                              <li>
                              ...
                              <li>
                                Can a foreign national be a director or
                                shareholder in a Private Limited Company?
                              </li>
                              <li>
                                Yes, a foreign national can be a director or
                                shareholder in an Indian Private Limited
                                Company. However, at least one director must be
                                a resident of India.
                              </li>
                            </ul>
                          </div>
                      ...
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse3"
                            >
                              Q3: What is the minimum capital requirement for a
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            There is no specific minimum capital requirement for
                            a Private Limited Company. The company can be
                            registered with any amount of authorised and paid-up
                            share capital as deemed appropriate for the
                            business.
                          </div>
                        </div>
                      </div>
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse4"
                            >
                              Q4: What is the process and timeline for Private
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            The process typically involves obtaining Digital
                            Signatures, Director Identification Numbers (DINs),
                            name reservation, drafting of Memorandum and
                            Articles of Association, and filing of incorporation
                            forms with the Registrar of Companies (ROC). The
                            timeline for registration can range from 10 to 20
                            days, depending on the efficiency of document
                            preparation and government processing.
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="col-md-6 servicefaqcol2">
                    <div className="panel-group" id="accordion2">
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse21"
                            >
                              Q5: Can the registered office address of the
                              company be a residential address?
                              <img
                                src="https://legal251.com/images/gstregistration/Path_20192.svg"
                                className="servicefaqimg"
                              />
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            Yes, the registered office of the company can be a
                            residential address. However, certain documents and
                            proofs will be required to establish the
                            authenticity and legality of the address.
                          </div>
                        </div>
                      </div>
                      <div className="panel panel-default servicefaqmainpanel">
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            Annual compliance requirements include holding
                            annual general meetings, filing annual financial
                            statements (Balance Sheet and Profit &amp; Loss
                            Account), filing annual returns with the ROC, and
                            maintaining statutory registers and books of
                            accounts.
                          </div>
                        </div>
                      </div>
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse22"
                            >
                              Q7: Can a Private Limited Company convert into
                              another type of business entity later?
                              <img
                                src="https://legal251.com/images/gstregistration/Path_20191.svg"
                                className="servicefaqimg"
                              />
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            Yes, subject to certain conditions and legal
                            requirements, a Private Limited Company can convert
                            into a Limited Liability Partnership (LLP) or
                            another type of entity through the prescribed
                      ...
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse23"
                            >
                              Q8: What are the tax implications for a Private
                              Limited Company?
                              <img
                                src="https://legal251.com/images/gstregistration/Path_20191.svg"
                                className="servicefaqimg"
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            A Private Limited Company is subject to corporate
                            income tax on its profits. Additionally, other taxes
                            such as Goods and Services Tax (GST) may apply based
                            on the nature of the company's business activities.
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <tbody>
                          <tr className="points">
                            ...
                            <th className="points">
                              ...
                              are 15,251/-. In Punjab, it is Rs. 17,251.
