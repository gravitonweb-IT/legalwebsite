...
const ParternLtdCompanyRegisteration = () => {
  ...
  <iframe
    ...
    data-load-time={1700040477564}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/367855087?random=1700040477557&cv=11&fst=1700040477557&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Fprivate-limited-company-registration&ref=https%3A%2F%2Flegal251.com%2Fprofessional-tax-registration&label=3o2zCK68lbIDEO-LtK8B&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20Pvt.%20Ltd.%20Company%20Registration&value=0&bttype=purchase&rdp=1&auid=1629897716.1699421317&fledge=1&capi=1"
    xpy1ab6hb=""
  />
  <iframe
    allow="join-ad-interest-group"
    data-tagging-id="AW-11126145977/Remarketing Tag"
    data-load-time={1700040477575}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/11126145977?random=1700040477572&cv=11&fst=1700040477572&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Fprivate-limited-company-registration&ref=https%3A%2F%2Flegal251.com%2Fprofessional-tax-registration&label=Remarketing%20Tag&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20Pvt.%20Ltd.%20Company%20Registration&auid=1629897716.1699421317&fledge=1"
    xpy1ab6hb=""
  />
          ...
          <div className="row">
            ...
            <div className="col-md-7 companycustomcol4 videopvtltextdiv">
              ...
              <p className="companyaboutsectiontext">
                Grow your business! Register it as a Private Limited Company
                with complete legal protection. A Private Limited Company is a
                company privately held for small businesses. This business
                entity limits owner liability to their shareholdings and the
                number of shareholders to 200 and restricts shareholders from
                publicly trading shares.
                <br />
                <br /> It can have a minimum of 2 Directors and a maximum of 15
                Directors. Private limited company registration is governed by
                the Companies Act of 2013 and the Companies Incorporation Rules
                of 2014. Make it official with Legal251's Private Limited
                Company Registration services!
                <br />
                <br /> We offer a complete package with easy documentation, fast
                registration, and a hassle-free experience – so you can focus on
                building and growing your business. Register your private
                limited company today and start enjoying the benefits of a
        ...
        <div className="row companybenefitscardrow">
              ...
              <div className="row ">
                <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                  ...
                  <p className="companybenefitscardtext">
                    Shareholders are not personally liable for the company's
            ...
            <div className="companybenefitscard companybenefitscard1">
              <div className="row ">
                <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                  ...
                  <p className="companybenefitscardtext ">
                    The company continues to exist even if the shareholders
                    change.
                  </p>
                </div>
                <div className="col-md-4 col-sm-4 col-xs-4 col-12">
          ...
          <div className="col-md-6">
            <div className="companybenefitscard companybenefitscard1">
              <div className="row ">
                <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                  <p className="companybenefitscardheading ">More capital</p>
                  <p className="companybenefitscardtext ">
          ...
          <div className="col-md-6">
            <div className="companybenefitscard companybenefitscard1">
              <div className="row ">
                <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                  <p className="companybenefitscardheading ">Limited risk</p>
                  <p className="companybenefitscardtext ">
                    Shareholders are only liable for the amount unpaid on their
                    shares.
                  </p>
                </div>
                <div className="col-md-4 col-sm-4 col-xs-4 col-12">
            ...
            <div className="companybenefitscard companybenefitscard1">
              <div className="row ">
                <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                  ...
                  <p className="companybenefitscardtext ">
                    Private limited companies have flexibility in expanding
            ...
            <div className="col-md-6 servicefaqcol1">
              ...
              >
                <div className="panel panel-default servicefaqmainpanel">
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      A Private Limited Company is a type of business entity
                      that offers limited liability protection to its
                      shareholders and restricts the transferability of its
                      shares. It requires a minimum of two directors and two
                      shareholders, with a maximum limit of 200 shareholders.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse2"
                      >
                        Q2: What are the key requirements to register a Private
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      ...
                      <ul>
                        <li>
                          Minimum two directors and shareholders (they can be
                          the same individuals).
                        </li>
                        <li>
                          At least one director should be a resident of India.
                        </li>
                        <li>Minimum authorised and paid-up share capital.</li>
                        <li>Registered office address in India.</li>
                        <li>
                          Can a foreign national be a director or shareholder in
                          a Private Limited Company?
                        </li>
                        <li>
                          Yes, a foreign national can be a director or
                          shareholder in an Indian Private Limited Company.
                          However, at least one director must be a resident of
                          India.
                        </li>
                      </ul>
                    </div>
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      There is no specific minimum capital requirement for a
                      Private Limited Company. The company can be registered
                      with any amount of authorised and paid-up share capital as
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse4"
                      >
                        Q4: What is the process and timeline for Private Limited
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      ...
                      Signatures, Director Identification Numbers (DINs), name
                      reservation, drafting of Memorandum and Articles of
                      Association, and filing of incorporation forms with the
                      Registrar of Companies (ROC). The timeline for
                      registration can range from 10 to 20 days, depending on
                      the efficiency of document preparation and government
                      processing.
                    </div>
                  </div>
                </div>
            ...
            <div className="col-md-6 servicefaqcol2">
              <div className="panel-group" id="accordion2">
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse21"
                      >
                        Q5: Can the registered office address of the company be
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      ...
                      residential address. However, certain documents and proofs
                      will be required to establish the authenticity and
                      legality of the address.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse5"
                      >
                        Q6: What are the annual compliance requirements for a
                        Private Limited Company?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      ...
                      general meetings, filing annual financial statements
                      (Balance Sheet and Profit &amp; Loss Account), filing
                      annual returns with the ROC, and maintaining statutory
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse22"
                      >
                        Q7: Can a Private Limited Company convert into another
                        type of business entity later?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Yes, subject to certain conditions and legal requirements,
                      a Private Limited Company can convert into a Limited
                      Liability Partnership (LLP) or another type of entity
                      through the prescribed conversion procedures. <br />
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse23"
                      >
                        Q8: What are the tax implications for a Private Limited
                        Company?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      A Private Limited Company is subject to corporate income
                      tax on its profits. Additionally, other taxes such as
                      Goods and Services Tax (GST) may apply based on the nature
                  ...
                  <tbody>
                    <tr className="points">
                      ...
                      <th className="points">
                        ...
                        15,251/-. In Punjab, it is Rs. 17,251. (Including all
                        fees &amp; taxes) (Because of High stamp duties in
                        respective states){" "}
                      </th>
                    </tr>
                    <tr>
