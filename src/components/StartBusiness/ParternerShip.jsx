      ...
      <div className="wrapper">
        <div style={{ position: "relative", overflowX: "hidden" }}>
            ...
            <div className="servicemaindiv" style={{ marginTop: 7 }}>
              <div className="row">
                <div className="col-md-6">
                  <p className="serviceamainheading">Partnership Deed</p>
                  <p
                    style={{
                      fontFamily: '"Roboto"',
                      marginTop: 18,
                  ...
                  >
                    A Partnership Deed (PDR) is a written legal document
                    containing an agreement between the partners of a firm which
                    summarises the terms and conditions of their partnership
                    under the “Indian Partnership Act 1932”. Get help from the
                    experts of Legal251 for making PDR.
                  </p>
                  <br />
                  <a href="#formpricediv">
                      ...
                      <div className="row">
                          ...
                          <center>
                            ...
                            >
                              <option
                                className="cities"
                                data-value=""
                                data-select2-id="select2-data-2-abba"
                              />
                            ...
                            <span
                              ...
                              dir="ltr"
                              data-select2-id="select2-data-1-l4wr"
                        ...
                        <div className="col-md-6">
                          <center>
                            ...
                            >
                              <sup style={{ lineHeight: "1.5" }} />₹ 1251.00
                            </p>
                            <p
                              style={{
                                fontFamily: '"Roboto"',
              ...
              <div className="row">
                ...
                <div className="col-md-7 companycustomcol4 videopvtltextdiv">
                  ...
                  <p className="companyaboutsectiontext">
                    A Partnership Deed is a written legal document that outlines
                    the rights and responsibilities of all partners of a
                    business or firm. Contact us to get your Partnership drafted
                    in the best way by the best legal team!
                    <br />
                    While partnering up with others for a
                    business/establishment, one must prepare their Partnership
                    Deed, an agreement that explains all terms &amp; conditions
                    about/for all respective partners to avoid any future/legal
                    disputes. It is used to guide all the parties in business
                    conduct and deter unwarranted misunderstanding,
                    unpleasantness, and harassment among the partners at the
                    time of the dispute.
                    <br />
                    The Partnership Deed is made under the "Indian Partnership
                    Act 1932" to deter uncertainty of the Partnership Deed.
                    Nevertheless, one can create a partnership firm without
                    registration. But, you must register your partnership firm
                    under the Indian Registration Act for security from future
                    uncertainties. One must take professional legal advice/help
                    for drafting their Partnership Deed. You are at the right
                    place if you are looking to start a partnership business
                    because we have the best legal team who will help you with
                    all the necessities needed for a Partnership Deed.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div id="Howtoapply" className="page-section">
            ...
            <center>
              <img
                src="https://legal251.com/images/nda/Partnership Deed Registration.png"
                  ...
                  <div className="servicebenefitscard">
                    <center>
                      <img
                        ...
                        className="benefitscardimg"
                      />
                      <p className="benefitscardtext">Claim Set-Off</p>
                    </center>
                  </div>
                </div>
                <div className="col-md-2 col-xs-4 firstcarddivcol">
                  <div className="servicebenefitscard">
                    <center>
                      <img
                        ...
                        className="benefitscardimg"
                      />
                      <p className="benefitscardtext">Conversion of Entity</p>
                    </center>
                  </div>
                </div>
                <div className="col-md-2 col-xs-4 firstcarddivcol">
                  <div className="servicebenefitscard">
                    <center>
                      <img
                        ...
                        className="benefitscardimg"
                      />
                      <p className="benefitscardtext">Higher Credibility</p>
                    </center>
                  </div>
                </div>
                <div className="col-md-2 col-xs-4 firstcarddivcol">
                  <div className="servicebenefitscard">
                    <center>
                      <img
                        ...
                        className="benefitscardimg"
                      />
                      <p className="benefitscardtext">Obtain PAN</p>
                    </center>
                  </div>
                </div>
                <div className="col-md-2 col-xs-4 firstcarddivcol">
                  <div className="servicebenefitscard">
                    <center>
                      <img
                        ...
                        className="benefitscardimg"
                      />
                      <p className="benefitscardtext"> Apply for Bank Loan</p>
                    </center>
                  </div>
                </div>
              </div>
                  ...
                  <div className="servicebenefitscard">
                    <center>
                      <img
                        ...
                        className="benefitscardimg"
                      />
                      <p className="benefitscardtext">Easy to Incorporate</p>
                    </center>
                  </div>
                </div>
                <div className="col-md-2 col-xs-4 secondcarddivcol">
                  <div className="servicebenefitscard">
                    <center>
                      <img
                        ...
                        className="benefitscardimg"
                      />
                      <p className="benefitscardtext"> Less Compliances</p>
                    </center>
                  </div>
                </div>
              </div>
                    ...
                    <div className="col-md-2 Registrationprocesscol1">
                      <center>
                        <p className="Registrationprocesstext1 gstrtext1">
                          Our legal experts will review all the documents you
                          submit to lessen the chances of incorrect or
                    ...
                    <div className="col-md-2 Registrationprocesscol2">
                      <center>
                        <p className="Registrationprocesstext2 gstrtext2">
                          Our best Partnership Deed experts are here to help you
                          with document requirements and registration
                          necessities.
                        </p>
                      </center>
                    </div>
                    <div className="col-md-2 Registrationprocesscol3">
                      <center>
                        <p className="Registrationprocesstext3 gstrtext3">
                          The respective professional will move further with
                          your documents to apply for your Partnership Deed
                          Registration.
                        </p>
                      </center>
                    </div>
                    <div className="col-md-2 Registrationprocesscol4">
                      <center>
                        <p className="Registrationprocesstext4 gstrtext4">
                          After acceptance of your application by the Registrar
                          of Firms, your Partnership Deed certificate will be
                          generated.
                        </p>
                      </center>
                    </div>
                    <div className="col-md-2 Registrationprocesscol5">
                      <center>
                        <p className="Registrationprocesstext5 gstrtext5">
                          You are supposed to wait until our expert reaches out
                          to notify you of the generation of your Partnership
                          Deed Certificate.
                        </p>
                      </center>
                    </div>
                  ...
                  <div className="col-md-6 servicefaqcol1">
                    ...
                    >
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse1"
                            >
                              Q1. Partnership Deed Registration is done under
                              which Indian Constitution Act?
                            </a>
                          </h4>
                        </div>
                        <div
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            Partnership Act 1932 is responsible for Partnership
                            Deed Registration in India.
                          </div>
                        </div>
                      </div>
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse2"
                            >
                              Q2. How many partners can form a partnership firm?
                              <img
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            A minimum of 2 persons are required to form a
                            partnership firm, and a maximum of ten persons if an
                            organization is in the banking business. A firm can
                            have up to 20 partners in the case of non-banking
                            business.
                          </div>
                        </div>
                      </div>
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse3"
                            >
                              Q3.Is registration mandatory for business firms?
                            </a>
                          </h4>
                        </div>
                        <div
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            No, it is not mandatory. However, to avoid future
                            disputes, it is advised to register your business
                            firm under the Partnership Deed Registration Act
                            1932.
                          </div>
                        </div>
                      </div>
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse4"
                            >
                              Q4.Which form is required to get registered under
                              the Partnership Act?
                              <img
                                src="https://legal251.com/images/gstregistration/Path_20191.svg"
                                className="servicefaqimg"
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            Form No. 1 is required to get registered under the
                            Partnership Act.
                          </div>
                        </div>
                      </div>
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse5"
                            >
                              Q5. What is the minimum age to register as a
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            Legal251 New Services Complete Description: New
                  ...
                  <div className="col-md-6 servicefaqcol2">
                    <div className="panel-group" id="accordion2">
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse21"
                            >
                              Q6. What are the types of Partnerships in India?
                              <img
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            In India, there are two types of partnerships:
                      ...
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse22"
                            >
                              Q7.How much time does it take to Register a
                              Partnership?
                              <img
                                src="https://legal251.com/images/gstregistration/Path_20191.svg"
                                className="servicefaqimg"
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            In India, the time for obtaining the Registration of
                            a Partnership Firm varies from 14-16 working days.
                          </div>
                        </div>
                      </div>
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse23"
                            >
                              Q8.On which grounds can my partnership be termed
                              invalid?
                              <img
                                src="https://legal251.com/images/gstregistration/Path_20191.svg"
                                className="servicefaqimg"
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            Some significant grounds on which your partnership
                            can be termed invalid are when your firm is engaged
                            in an illegal or unlawful activity or if the court
                            finds the firm invalid.
                          </div>
                        </div>
                      </div>
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse24"
                            >
                              Q9. What are the disadvantages of an Unregistered
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            The main disadvantage of an Unregistered Partnership
                            Firm is that it does not have the right to claim
                            set-offs and cannot sue third parties or partners.
                          </div>
                        </div>
                      </div>
                      <div className="panel panel-default servicefaqmainpanel">
                        <div className="panel-heading servicefaqpanelheading">
                          <h4 className="panel-title">
                            <a
                              ...
                              href="#collapse25"
                            >
                              Q10. Can my friend from a different country become
                              a partner in my Partnership Firm?
                              <img
                                src="https://legal251.com/images/gstregistration/Path_20191.svg"
                                className="servicefaqimg"
                              />
                        ...
                        >
                          <div className="panel-body servicefaqbody">
                            Yes, a foreigner is eligible to become a partner in
                            an Indian Partnership Firm and can contribute to the
                            firm's capital in some cases. There are no
                            restrictions for a foreigner to become a partner in
                            an Indian firm. However, the law restricts foreign
                            investment by NRI.
                          </div>
                        </div>
                      </div>
                ...
                <div className="owl-stage-outer">
                  <div
                    ...
                    style={{
                      ...
                      width: 8893,
                      transform: "translate3d(-3556px, 0px, 0px)",
                    }}
                  >
                    <div
                      className="owl-item cloned"
                      style={{ width: "889.24px" }}
                    >
                      <div
                        ...
                        <center>
                          ...
                          <div className="clientscardtextdiv">
                            <p className="clientscardtext">
                              ...
                              />{" "}
                              For people like us who are surrounded by work,
                              legal251 is like a gift. Be it a busy day, or a
                              deadline, legal251 can always be counted upon. The
                              customer service is always up to the mark and the
                              advices and solutions are always promising. Within
                              48 hrs of the query you can have your solution in
                              your hand, and all this, just a few clicks away
                              and inside your pocket. Legal work is now on a
                          ...
                          <div className="clientscardtextdiv">
                            <p className="clientscardtext">
                              <img
                                ...
                                className="quoteimage1"
                              />{" "}
                              Legal251 changes the very idea which most people
                              have about getting any legal work done. Making the
                              whole process so convenient and also online makes
                              it so easy for everyone to work with. If talking
                              about quality work, they have absolutely no match.
                              A platform as big as Today's Bharat required a
                              very complete and descriptive terms of condition
                              and privacy policy. This was greatly achieved with
                              the help of experts at{" "}
                          ...
                          <div className="clientscardtextdiv">
                            <p className="clientscardtext">
                              <img
                                ...
                                className="quoteimage1"
                              />
                              I'm thrilled to share my exceptional experience
                              with LEGAL251. Their top priority is evident:
                              providing the best and speediest solutions. Their
                              professionalism and expertise stood out. The
                              remarkable speed at which LEGAL251 operates truly
                              sets them apart. Their responses were prompt, and
                              packed with insightful guidance. Any queries I had
                              were addressed immediately. For those seeking
                              legal assistance that's efficient and of the
                              highest quality, I wholeheartedly endorse
                              LEGAL251.
                    ...
                    <div className="owl-item" style={{ width: "889.24px" }}>
                      <div
                        className="clientscard clientservicemargin"
                        data-position={0}
                      >
                          ...
                          <div className="clientscardtextdiv">
                            <p className="clientscardtext">
                              <img
                                ...
                                className="quoteimage1"
                              />{" "}
                              Legal251 is the best platform for getting
                              consultancy be it in any legal domain they provide
                              best solution for your query.I am satisfied with
                              their work. What i was expecting i got it from
                              Legal251. And I would really appreciate their
                              cooperative work and how they deal and cooperate
                              with their customers. They are the best in
                              business as you may know. There are many
                              complications in Filing GST &amp; Income Tax
                              returns for jewellery supply &amp; design business
                              they make all these very easy and efficient.
                              <img
                                src="https://legal251.com/images/about/iconmonstr-quote-5.svg"
                                className="quoteimage2"
                              />
