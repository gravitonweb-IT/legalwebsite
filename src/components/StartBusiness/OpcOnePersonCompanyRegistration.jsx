...
<>
  <iframe
    ...
    data-load-time={1700045627866}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/367855087?random=1700045627858&cv=11&fst=1700045627858&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1536&u_h=864&url=https%3A%2F%2Flegal251.com%2Fopc-one-person-company-registration&ref=https%3A%2F%2Flegal251.com%2Fllp-company-registration&label=3o2zCK68lbIDEO-LtK8B&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20OPC%20Company%20Registration&value=0&bttype=purchase&rdp=1&auid=1635319576.1700023944&fledge=1&capi=1&uaa=x86&uab=64&uafvl=Google%2520Chrome%3B119.0.6045.124%7CChromium%3B119.0.6045.124%7CNot%253FA_Brand%3B24.0.0.0&uamb=0&uap=Windows&uapv=10.0.0&uaw=0"
  />
  <iframe
    allow="join-ad-interest-group"
    data-tagging-id="AW-11126145977/Remarketing Tag"
    data-load-time={1700045627903}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/11126145977?random=1700045627900&cv=11&fst=1700045627900&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1536&u_h=864&url=https%3A%2F%2Flegal251.com%2Fopc-one-person-company-registration&ref=https%3A%2F%2Flegal251.com%2Fllp-company-registration&label=Remarketing%20Tag&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20OPC%20Company%20Registration&auid=1635319576.1700023944&fledge=1&uaa=x86&uab=64&uafvl=Google%2520Chrome%3B119.0.6045.124%7CChromium%3B119.0.6045.124%7CNot%253FA_Brand%3B24.0.0.0&uamb=0&uap=Windows&uapv=10.0.0&uaw=0"
  />
    ...
    <div style={{ position: "relative", overflowX: "hidden" }}>
                      ...
                      <div className="col-menu col-md-5">
                        ...
                        <div className="content animated">
                          <ul className="menu-col" id="id01">
                            ...
                            <li className="incontent">
                            <Link to='/Section8CompanyRegisteration'>
                            </Link>
                                <img
                                  className="megamenu_icon"
      ...
      <div>
                  ...
                  <div className="companyformdiv" style={{ marginTop: 0 }}>
                    ...
                    >
                      <option
                        className="cities"
                        data-value=""
                        data-select2-id="select2-data-2-7zgu"
                      />
                    ...
                    <span
                      ...
                      dir="ltr"
                      data-select2-id="select2-data-1-rek2"
            ...
            <div className="row">
              ...
              <div className="col-md-7 companycustomcol4 videopvtltextdiv">
                ...
                <p className="companyaboutsectiontext">
                  Are you ready to start a company but want to avoid creating it
                  with others? Don't worry! One Person Company (OPC) in India is
                  a new concept introduced with the Companies Act 2013. As per
                  section 2(62) of the Company's Act 2013, a company can be
                  formed with just one director and one member.
                  <br />
                  <br /> The director and member can be the same person. It is a
                  form of a company where the compliance requirements are lesser
                  than that of a private company. Thus, one individual who may
                  be a resident or NRI can incorporate their business with a
                  company's features and the benefits of a sole proprietorship.
                  <br />
                  <br /> What are you waiting for? Register your Person Company
                  from Legal251 now! Our experienced team will handle everything
                  for you, from paperwork to verifying documents, so you can
                  enjoy knowing your business is in good hands. Start your
                  company with Legal 251 and take that first step to success!
                </p>
              </div>
            </div>
          </div>
        ...
        <div id="Howtoapply" className="page-section">
          ...
          <center>
            <img
              src="https://legal251.com/images/gstregistration/One-Person-Company@2x.png"
                ...
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext">
                      The biggest advantage of OPC registration is that it
                      provides limited liability protection to the sole member.
                      This means that the personal assets of the member are
                      separate from the company's liabilities. In case of any
                      financial losses or legal liabilities, the member's
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      OPC allows a single individual to form and manage a
                      company. This is beneficial for entrepreneurs who want to
                      start a business on their own without the need for
                      additional shareholders or partners. The sole member has
                      complete control over the company's operations and
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      OPC is considered a separate legal entity from its owner.
                      It has its own identity, distinct from the individual
                      member. This provides credibility and enhances the
                      business's image, making it easier to enter into
                      contracts, raise funds, and establish business
                      relationships.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      OPC registration ensures perpetual succession, which means
                      the company continues to exist even if the owner or
                      promoter passes away or becomes incapacitated. The shares
                      of the company can be transferred to a nominee mentioned
                      in the incorporation documents, ensuring the continuity of
                      the business.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
                      src="https://legal251.com/images/companyregimage/Perpetual-Existence.svg"
                      className="companybenefitscardimg companybenefitscardimgmargin1"
                    />
                  </div>
                </div>
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      OPCs have better access to funding and bank loans compared
                      to sole proprietorships or partnerships. Financial
                      institutions and investors find OPCs more trustworthy and
                      are more willing to provide financial assistance. OPCs can
                      raise funds through equity or debt and have the option to
                      issue shares to investors.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
                      src="https://legal251.com/images/companyregimage/Easy-Funding-Bank-Loans.svg"
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      OPCs enjoy certain tax benefits. They are eligible for tax
                      deductions, exemptions, and benefits available to other
                      types of companies. OPCs are taxed at the corporate tax
                      rate, which may be lower than individual tax rates,
                  ...
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
                      ...
                      className="companybenefitscardimg  companybenefitscardimg1 "
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      Compared to other types of companies, OPCs have relatively
                      fewer compliance requirements. They are exempted from
                      certain statutory obligations applicable to other
                      companies, such as holding annual general meetings (AGMs)
                      with shareholders.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
                      src="https://legal251.com/images/companyregimage/Minimal-Requirements.svg"
              ...
              <div className="companybenefitscard">
                <div className="row ">
                  <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                    ...
                    <p className="companybenefitscardtext ">
                      As an OPC grows, it can be converted into a private
                      limited company, which offers additional benefits such as
                      the ability to have more shareholders and increased
                      capital. The conversion process is straightforward and
                      provides flexibility for future expansion.
                    </p>
                  </div>
                  <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                    <img
                      src="https://legal251.com/images/companyregimage/Conversion-rate-optimization-pana.svg"
                      className="companybenefitscardimg companybenefitscardimg2 "
                    />
                  </div>
                </div>
        ...
        <div id="Registrationprocess" className="page-section">
          ...
          <div className="">
            <div className="" style={{ marginTop: 0 }}>
              <center>
                <img
                  src="https://legal251.com/images/companyregimage/one-person-company-image.png"
                  className="minimumreqdivimg1 dregprocessimg"
                />
                <img
                  src="https://legal251.com/images/companyregimage/Group_11171.png"
              ...
              <div className="col-md-6 servicefaqcol1">
                ...
                >
                  <div className="panel panel-default servicefaqmainpanel">
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        ...
                        However, a person cannot incorporate more than one OPC
                        or be a nominee for more than one OPC.
                      </div>
                    </div>
                  </div>
                  <div className="panel panel-default servicefaqmainpanel">
                    <div className="panel-heading servicefaqpanelheading">
                      <h4 className="panel-title">
                        <a
                          ...
                          href="#collapse2"
                        >
                          Q2: What is the minimum capital requirement for OPC
                          registration?
                          <img
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        {" "}
                        There is no minimum capital requirement for OPC
                        registration. It can be registered with any amount of
                  ...
                  <div className="panel panel-default servicefaqmainpanel">
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        No, an OPC can have only one director. However, it can
                        appoint a nominee who will take charge in case of the
                        director's death or incapacity.
                      </div>
                    </div>
                  </div>
                  <div className="panel panel-default servicefaqmainpanel">
                    <div className="panel-heading servicefaqpanelheading">
                      <h4 className="panel-title">
                        <a
                          ...
                          href="#collapse4"
                        >
                          Q4: Is it mandatory to have a nominee for OPC
                          registration?
                          <img
                            src="https://legal251.com/images/gstregistration/Path_20191.svg"
                            className="servicefaqimg"
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        Yes, every OPC must nominate a person who will become
                        the member of the company in case of the director's
                        death or incapacity. The nominee's consent is required
                        for the nomination.
                      </div>
                    </div>
                  </div>
                  <div className="panel panel-default servicefaqmainpanel">
                    <div className="panel-heading servicefaqpanelheading">
                      <h4 className="panel-title">
                        <a
                          ...
                          href="#collapse5"
                        >
                          Q5: Can an OPC be converted into a private limited
                          company?
                          <img
                            src="https://legal251.com/images/gstregistration/Path_20191.svg"
                            className="servicefaqimg"
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        Yes, an OPC can be converted into a private limited
                        company if it meets the eligibility criteria. The
                        conversion can be voluntary or mandatory based on
                        certain thresholds specified by the Companies Act,
                        2013..
                      </div>
                    </div>
                  </div>
              ...
              <div className="col-md-6 servicefaqcol2">
                <div className="panel-group" id="accordion2">
                  <div className="panel panel-default servicefaqmainpanel">
                    <div className="panel-heading servicefaqpanelheading">
                      <h4 className="panel-title">
                        <a
                          ...
                          href="#collapse21"
                        >
                          Q6: Is it mandatory for an OPC to get its accounts
                          audited?
                          <img
                            src="https://legal251.com/images/gstregistration/Path_20192.svg"
                            className="servicefaqimg"
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        OPCs are exempted from statutory audit requirements if
                        their turnover does not exceed Rs. 2 crore
                        (approximately) in a financial year. However, if the
                        turnover exceeds this limit or the OPC's paid-up capital
                        exceeds Rs. 50 lakh (approximately), it must get its
                        accounts audited..
                      </div>
                    </div>
                  </div>
                  <div className="panel panel-default servicefaqmainpanel">
                    <div className="panel-heading servicefaqpanelheading">
                      <h4 className="panel-title">
                        <a
                          ...
                          href="#collapse22"
                        >
                          Q7: What are the compliance requirements for an OPC?
                          <img
                            src="https://legal251.com/images/gstregistration/Path_20191.svg"
                            className="servicefaqimg"
                          />
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        OPCs have relatively fewer compliance requirements
                        compared to other types of companies. They must file
                        annual financial statements, annual returns, and income
                        tax returns. They are also required to maintain proper
                        books of accounts and comply with the applicable tax
                        laws.{" "}
                      </div>
                    </div>
                  </div>
                  <div className="panel panel-default servicefaqmainpanel">
                    <div className="panel-heading servicefaqpanelheading">
                      <h4 className="panel-title">
                        <a
                          ...
                          href="#collapse23"
                        >
                          Q8: Can an OPC have branches in multiple locations?
                          <img
                            src="https://legal251.com/images/gstregistration/Path_20191.svg"
                            className="servicefaqimg"
                          />
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        Yes, an OPC can have branches in multiple locations
                        within India or even abroad. However, it must comply
                        with the applicable laws, such as obtaining necessary
                        approvals and licenses for conducting business in
                        different locations.
                      </div>
                    </div>
                  </div>
                  <div className="panel panel-default servicefaqmainpanel">
                    <div className="panel-heading servicefaqpanelheading">
                      <h4 className="panel-title">
                        <a
                          ...
                          href="#collapse24"
                        >
                          Q9: Can an OPC be converted into a sole proprietorship
                          or partnership?
                          <img
                            src="https://legal251.com/images/gstregistration/Path_20191.svg"
                            className="servicefaqimg"
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        No, an OPC cannot be converted into a sole
                        proprietorship or partnership. It can only be converted
                        into a private limited company if it meets the
                  ...
                  <div className="panel panel-default servicefaqmainpanel">
                    <div className="panel-heading servicefaqpanelheading">
                      <h4 className="panel-title">
                        <a
                          ...
                          href="#collapse25"
                        >
                          Q10: How long does it take to register an OPC?
                          <img
                            src="https://legal251.com/images/gstregistration/Path_20191.svg"
                            className="servicefaqimg"
                          />
                    ...
                    >
                      <div className="panel-body servicefaqbody">
                        The OPC registration process typically takes around 10
                        to 15 days, depending on the processing time of the
                        Registrar of Companies (RoC) and the completeness of the
                        submitted documents.
                      </div>
                    </div>
                  </div>
                  ...
                  <table className="termcondtable">
                    <tbody>
                      <tr className="points">
                        ...
                        <th className="points">
                          For incorporations in Madhya Pradesh, the charges are
                          14,751/-. In Punjab, it is Rs. 16,751/-. (Including
                          all fees &amp; taxes) (Because of High stamp duties in
                          respective states)
                        </th>
                      </tr>
                      <tr>
