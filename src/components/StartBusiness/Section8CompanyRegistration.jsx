...
const Section8CompanyRegistration = () => {
  return (
   ...
   <iframe
     ...
     data-load-time={1700042098410}
     height={0}
     width={0}
     style={{ display: "none", visibility: "hidden" }}
     src="https://td.doubleclick.net/td/rul/367855087?random=1700042098400&cv=11&fst=1700042098400&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Fsection-8-company-registration&ref=https%3A%2F%2Flegal251.com%2Fprivate-limited-company-registration&label=3o2zCK68lbIDEO-LtK8B&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20Section%208%20Company%20Registration&value=0&bttype=purchase&rdp=1&auid=1629897716.1699421317&fledge=1&capi=1&uaa=x86&uab=64&uafvl=Google%2520Chrome%3B119.0.6045.124%7CChromium%3B119.0.6045.124%7CNot%253FA_Brand%3B24.0.0.0&uamb=0&uap=Windows&uapv=15.0.0&uaw=0"
     u9zcyyitg=""
   />
   <iframe
     allow="join-ad-interest-group"
     data-tagging-id="AW-11126145977/Remarketing Tag"
     data-load-time={1700042098425}
     height={0}
     width={0}
     style={{ display: "none", visibility: "hidden" }}
     src="https://td.doubleclick.net/td/rul/11126145977?random=1700042098422&cv=11&fst=1700042098422&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Fsection-8-company-registration&ref=https%3A%2F%2Flegal251.com%2Fprivate-limited-company-registration&label=Remarketing%20Tag&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20Section%208%20Company%20Registration&auid=1629897716.1699421317&fledge=1&uaa=x86&uab=64&uafvl=Google%2520Chrome%3B119.0.6045.124%7CChromium%3B119.0.6045.124%7CNot%253FA_Brand%3B24.0.0.0&uamb=0&uap=Windows&uapv=15.0.0&uaw=0"
     u9zcyyitg=""
   />
   <div style={{ position: "relative", overflowX: "hidden" }}>
     ...
     <div className="sidebar-contact" style={{ display: "block" }}>
       <div
         className="toggle1"
     ...
     <div
       ...
       style={{ display: "none", position: "fixed", marginTop: 55 }}
     >
       <input
         type="text"
         id="pop-input"
     ...
     >
       ...
       >
         <div className="attr-nav">
           <ul className="pal" style={{ marginTop: "-20px" }}>
             <li className="search">
             ...
             <li className="menu">
               <a style={{ marginTop: 3 }}>
                 <img
                   ...
                   style={{ width: 23, cursor: "pointer", marginTop: "-41px" }}
                 />
               </a>
             </li>
           </ul>
     ...
     <div>
       <div
         ...
         style={{ marginTop: 0, visibility: "visible", padding: "2px 2px 1px" }}
       >
         <li>
           <a
           ...
           <div className="row ">
             <div className="col-md-7 companycustomcol1">
               ...
               >
                 ...
                 <span className="companypricetextspan">@ Rs.9251 only /-</span>
                 ...
                 <div className="companyformdiv" style={{ marginTop: 0 }}>
                   ...
                   >
                     <option
                       className="cities"
                       data-value=""
                       data-select2-id="select2-data-2-esh6"
                     />
                   ...
                   <span
                     ...
                     dir="ltr"
                     data-select2-id="select2-data-1-6twn"
           ...
           <div className="row">
             ...
             <div className="col-md-7 companycustomcol4 videopvtltextdiv">
               ...
               <p className="companyaboutsectiontext">
                 ...
                 promote sports, education, research, social welfare, art,
                 science, and protection of the environment, etc. The concept of
                 such companies is introduced under section 8 of the Companies
                 Act, 2013.
                 <br />
                 <br />
                 ...
                 company was promoted. To register such a company or
                 organisation, a minimum of two directors are required, and there
                 is no requirement for a minimum paid-up capital to set up such a
                 company in India.
                 <br />
                 <br />
                 Get your non-profit entity registered today with Section 8
                 Company Registration from Legal251! Our easy-to-use platform
                 lets you quickly register and enjoy numerous tax benefits.
                 Please use our reliable service and worry-free registration
                 process to become a legally registered non-profit entity!
               </p>
             </div>
           </div>
         </div>
           ...
           <div className="row custompvtltablerow">
             ...
             <div className="col-xs-2 custompvtlcol2">
               <p className="pvtsubtableheading2">
                 ...
                 partners, protecting their personal assets from the liabilities
                 of the business.
               </p>
             </div>
             <div className="col-xs-2 custompvtlcol2">
               <p className="pvtsubtableheading2">
                 ...
                 owners (shareholders). It can be a private limited company or a
                 public limited company. Shareholders' are the owners of the
                 company and their liability is limited to their investment, and
                 the company's operations and management are governed by the
                 board of directors.
               </p>
             </div>
           </div>
       ...
       <div id="Howtoapply" className="page-section">
         ...
         <center>
           <img
             src="https://legal251.com/images/gstregistration/Section8-Company-Registration2x.png"
               ...
               <div className="row ">
                 <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                   ...
                   <p className="companybenefitscardtext">
                     Section 8 Companies are recognized and governed by the
                     Companies Act, 2013. It provides them with a legal framework
                     and legitimacy as an independent legal entity.
                   </p>
                 </div>
                 <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                   <img
                     src="https://legal251.com/images/companyregimage/Legal-recognition.svg"
             ...
             <div className="companybenefitscard">
               <div className="row ">
                 <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                   ...
                   <p className="companybenefitscardtext ">
                     The liability of the members or shareholders of a Section 8
                     Company is limited. In case of any debts or liabilities, the
                     personal assets of the members are not at risk. This feature
                     provides financial security to the promoters and encourages
                     them to contribute towards social welfare activities.
                   </p>
                 </div>
                 <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                   <img
             ...
             <div className="companybenefitscard">
               <div className="row ">
                 <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                   ...
                   <p className="companybenefitscardtext ">
                     Section 8 Companies enjoy various tax benefits. They are
                     exempt from paying income tax on the surplus income
                     generated from their charitable or social welfare
                     activities. Additionally, donors contributing funds to such
                     organisations are eligible for tax deductions under Section
                     80G of the Income Tax Act.
                   </p>
                 </div>
                 <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                   <img
                     src="https://legal251.com/images/companyregimage/Tax-exepetions.svg"
                     className="companybenefitscardimg companybenefitscardimgmargin1"
                   />
                 </div>
               </div>
             ...
             <div className="companybenefitscard">
               <div className="row ">
                 <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                   ...
                   <p className="companybenefitscardtext ">
                     Section 8 Companies can receive foreign contributions and
                     donations under the Foreign Contribution (Regulation) Act
                     (FCRA). This enables them to access global funding for their
                     charitable initiatives.
                   </p>
                 </div>
                 <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                   <img
                     src="https://legal251.com/images/companyregimage/foregin-dontaions.svg"
                     className="companybenefitscardimg companybenefitscardimgmargin1"
                   />
                 </div>
               </div>
             ...
             <div className="companybenefitscard">
               <div className="row ">
                 <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                   ...
                   <p className="companybenefitscardtext ">
                     Section 8 Companies have a perpetual existence, meaning they
                     can continue their operations and carry out their objectives
                     even if the founding members resign or pass away. This
                     ensures the continuity of their social welfare activities
             ...
             <div className="companybenefitscard">
               <div className="row ">
                 <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                   ...
                   <p className="companybenefitscardtext ">
                     Registration as a Section 8 Company enhances the credibility
                     and trustworthiness of the organisation. It assures
                     stakeholders, including donors, volunteers, and
                     beneficiaries, that the company is committed to social
                     causes and operates with transparency and accountability.
                   </p>
                 </div>
                 <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                   <img
                     src="https://legal251.com/images/companyregimage/credibility.svg"
             ...
             <div className="companybenefitscard">
               <div className="row ">
                 <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                   ...
                   <p className="companybenefitscardtext ">
                     Section 8 Companies are eligible to apply for grants,
                     funding, and schemes offered by government departments,
                     corporate entities, and international organisations. This
                     financial support aids in the implementation and expansion
                     of their social initiatives.
                   </p>
                 </div>
                 <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                   <img
                     src="https://legal251.com/images/companyregimage/funding-access-grants.svg"
                     className="companybenefitscardimg companybenefitscardimg2 "
                   />
                 </div>
               </div>
             ...
             <div className="companybenefitscard">
               <div className="row ">
                 <div className="col-md-8 col-sm-8 col-xs-8 col-12">
                   ...
                   <p className="companybenefitscardtext ">
                     Section 8 Companies have wider visibility and recognition in
                     society. They can collaborate with government bodies, NGOs,
                     and other stakeholders to address social issues and make a
                     positive impact on communities at large.
                   </p>
                 </div>
                 <div className="col-md-4 col-sm-4 col-xs-4 col-12">
                   <img
                     src="https://legal251.com/images/companyregimage/reach.svg"
                     className="companybenefitscardimg companybenefitscardimg2 companybenefitscardimgmargin2"
                   />
                 </div>
               </div>
             </div>
             ...
             >
               <div className="owl-stage-outer" data-position={0}>
                 <div
                   className="owl-stage"
                   style={{
                     transform: "translate3d(-2760px, 0px, 0px)",
                 ...
                 >
                   <div
                     ...
                     style={{ width: "auto", marginRight: 60 }}
                   >
                         ...
                         <div className="box1 scrollAnim fade-in-up ">
                           ...
                           <div>
                             <p className="ptext anim-top">
                               I was having a hard time filing my GST returns and
                               was really confused as to how to go about it.
                               That's when I came across Legal251. They were
                               thorough professionals who made sure that my
                               documents were filed perfectly without any errors.
                               Their customer service was also top-notch and they
                               guided me through the entire process with ease.
                               I'm glad that I chose Legal251 for filing my GST
                     ...
                     <div className="item" style={{ width: 400 }}>
                       ...
                       <div className=" owlcard">
                         <div className="box1 scrollAnim fade-in-up ">
                           ...
                           <div>
                             <p className="ptext anim-top">
                               I've been using Legal251 for filing my GST returns
                               for the past few months and I'm extremely
                               impressed with their service and platform. It's so
                               easy to use, and all the necessary information is
                               provided in a very organized way. Plus, filing my
                               returns on time has become so much easier with
                               this platform. Highly recommend Legal251 for
                               anyone looking for an efficient way to file their
                               GST returns.
                             </p>
                           </div>
                         </div>
                     ...
                     <div className="item" style={{ width: 400 }}>
                       ...
                       <div className=" owlcard">
                         <div className="box1 scrollAnim fade-in-up ">
                           ...
                           <div>
                             <p className="ptext anim-top">
                               I was a bit worried when filing my GST return for
                               the first time, but Legal251 made it a breeze.
                               Their team of experts guided me through every step
                               and filed my return perfectly. I'm really glad I
                               chose Legal251 to help me with this task as they
                               have an excellent knowledge of the regulations and
                               ensured that everything was done correctly. Thank
                               you!
                             </p>
                           </div>
                         </div>
                         ...
                         <div className="box1 scrollAnim fade-in-up ">
                           ...
                           <div>
                             <p className="ptext anim-top">
                               ...
                               nightmare until I found Legal251. The interface is
                               so easy to use, it makes filing my returns on time
                               a breeze. I can easily keep track of all my
           ...
           <div>
             ...
             >
               <div className="col-md-2 Registrationprocesscol1">
                 <center>
                   <p className="Registrationprocesstext1 gstrtext1">
                     ...
                     submitted, reviewing any false or mistaken information to
               ...
               <div className="col-md-2 Registrationprocesscol2">
                 <center>
                   <p className="Registrationprocesstext2 gstrtext2 gstrtext2llp">
                     Our best experts are here to deal with document necessities
               ...
               <div className="col-md-2 Registrationprocesscol3">
                 <center>
                   <p className="Registrationprocesstext3 gstrtext3 regist3 gstrtext3llp">
                     The respective expert will proceed further with your
                     documents in order to apply for your Section 8 Company
                     Registration.
                   </p>
                 </center>
               </div>
               <div className="col-md-2 Registrationprocesscol4 regist4">
                 <center>
                   <p className="Registrationprocesstext4 gstrtext4 regist_p4 gstrtext4llp gstrtext4seight">
                     After our team completes DSC, DIN, and formalities,
                     patiently wait for ROC to issue your COI.
                   </p>
                 </center>
               </div>
               <div className="col-md-2 Registrationprocesscol5">
                 <center>
                   <p className="Registrationprocesstext5 gstrtext5 gstrtext5llp">
               ...
               >
                 <div className="panel panel-default servicefaqmainpanel">
                   ...
                   >
                     <div className="panel-body servicefaqbody">
                       A Section 8 Company, as per the Companies Act, 2013 in
                       India, is a non-profit organisation formed with the
                       objective of promoting social welfare, charity, or any
                       other useful purpose. These companies are prohibited from
                       distributing dividends to their members and instead
                       utilise their income for promoting their stated
                       objectives.
                     </div>
                   </div>
                 </div>
                 <div className="panel panel-default servicefaqmainpanel">
                   <div className="panel-heading servicefaqpanelheading">
                     <h4 className="panel-title">
                       <a
                         ...
                         href="#collapse2"
                       >
                         Q2: What are the minimum requirements to register a
                         Section 8 Company?
                         <img
                   ...
                   >
                     <div className="panel-body servicefaqbody">
                       {" "}
                       The minimum requirements to register a Section 8 Company
                       in India include:
                       <ul>
                         <li>
                           A minimum of two shareholders (individuals or
                           corporate entities).
                         </li>
                         <li>A minimum of two directors (individuals).</li>
                         <li>
                           At least one of the directors must be a resident of
                           India.
                         </li>
                         <li>The proposed company must have a unique name.</li>
                       </ul>
                     </div>
                   </div>
                 </div>
                 <div className="panel panel-default servicefaqmainpanel">
                   <div className="panel-heading servicefaqpanelheading">
                     <h4 className="panel-title">
                       <a
                         ...
                         href="#collapse3"
                       >
                         Q3: Can a Section 8 Company earn profits?
                         <img
                           src="https://legal251.com/images/gstregistration/Path_20191.svg"
                           className="servicefaqimg"
                         />
                   ...
                   >
                     <div className="panel-body servicefaqbody">
                       While Section 8 Companies are primarily formed for
                       charitable or social welfare purposes, they are allowed to
                       generate profits through their activities. However, the
                       profits cannot be distributed among the members as
                       dividends. The surplus generated must be reinvested in the
                 ...
                 <div className="panel panel-default servicefaqmainpanel">
                   <div className="panel-heading servicefaqpanelheading">
                     <h4 className="panel-title">
                       <a
                         ...
                         href="#collapse5"
                       >
                         Q4: Can foreign nationals or Non-Resident Indians (NRIs)
                         be directors or shareholders of a Section 8 Company?
                         <img
                           src="https://legal251.com/images/gstregistration/Path_20191.svg"
                           className="servicefaqimg"
                         />
                   ...
                   >
                     <div className="panel-body servicefaqbody">
                       Yes, foreign nationals and NRIs can be directors or
                       shareholders of a Section 8 Company. However, at least one
                       director must be a resident of India.
                     </div>
                   </div>
                 </div>
               </div>
             ...
             <div className="col-md-6 servicefaqcol2">
               <div className="panel-group" id="accordion2">
                 <div className="panel panel-default servicefaqmainpanel">
                   <div className="panel-heading servicefaqpanelheading">
                     <h4 className="panel-title">
                       <a
                         ...
                         href="#collapse4"
                       >
                         Q5: How long does it take to register a Section 8
                         Company?
                         <img
                           src="https://legal251.com/images/gstregistration/Path_20191.svg"
                           className="servicefaqimg"
                   ...
                   >
                     <div className="panel-body servicefaqbody">
                       The registration process can take around 15 to 30 days,
                       depending on the processing time of the Registrar of
                       Companies (RoC) and the completeness of the application
                 ...
                 <div className="panel panel-default servicefaqmainpanel">
                   <div className="panel-heading servicefaqpanelheading">
                     <h4 className="panel-title">
                       <a
                         ...
                         href="#collapse21"
                       >
                         Q6: What is the procedure for changing the registered
                         office address of a Section 8 Company?
                         <img
                           src="https://legal251.com/images/gstregistration/Path_20192.svg"
                           className="servicefaqimg"
                         />
                   ...
                   >
                     <div className="panel-body servicefaqbody">
                       To change the registered office address, the Section 8
                       Company must follow the prescribed procedure, which
                       includes obtaining board and shareholder approval,
                 ...
                 <div className="panel panel-default servicefaqmainpanel">
                   <div className="panel-heading servicefaqpanelheading">
                     <h4 className="panel-title">
                       <a
                         ...
                         href="#collapse22"
                       >
                         Q7: Are Section 8 Companies exempt from taxation?
                         <img
                           src="https://legal251.com/images/gstregistration/Path_20191.svg"
                           className="servicefaqimg"
                         />
                   ...
                   >
                     <div className="panel-body servicefaqbody">
                       Section 8 Companies enjoy certain tax exemptions,
                       including income tax exemption on the surplus income
                       generated from their charitable activities. They may also
                       qualify for tax deductions under Section 80G of the Income
                       Tax Act for donors contributing funds to the organisation.{" "}
                     </div>
                   </div>
                 </div>
                 <div className="panel panel-default servicefaqmainpanel">
                   <div className="panel-heading servicefaqpanelheading">
                     <h4 className="panel-title">
                       <a
                         ...
                         href="#collapse23"
                       >
                         Q8: Can a Section 8 Company be converted into a
                         for-profit company?
                         <img
                           src="https://legal251.com/images/gstregistration/Path_20191.svg"
                           className="servicefaqimg"
                   ...
                   >
                     <div className="panel-body servicefaqbody">
                       Yes, it is possible to convert a Section 8 Company into a
                       for-profit company. However, this process requires
                       compliance with the relevant laws and regulations,
                       including obtaining necessary approvals from the concerned
                       authorities.
                     </div>
                   </div>
                 </div>
                 ...
                 <table className="termcondtable">
                   <tbody>
                     <tr className="points">
                       ...
                       <th className="points">
                         In Madhya Pradesh, the charges are 16,751/-. In Kerela,
                         it is Rs. 11,251/-. (Including all fees &amp; taxes)
                         (Because of High stamp duties in respective states)
                       </th>
                     </tr>
                     <tr>
