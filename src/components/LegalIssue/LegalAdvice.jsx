...
const LegalAdvice = () => {
  ...
  <div style={{ position: "relative", overflowX: "hidden" }}>
    ...
    <a
      href="https://legal251.com/legal-claim-help-hindi"
      ...
      <div className="servicemaindiv" style={{ marginTop: 7 }}>
        <div className="row">
          <div className="col-md-6">
            <p className="serviceamainheading">Legal Advice</p>
            <p
              style={{
                fontFamily: '"Roboto"',
                marginTop: 18,
            ...
            >
              Don't get overwhelmed with the formalities and documentation.
              Contact Legal251 for Legal Claim Help today!
            </p>
            <br />
            <a href="#formpricediv">
                    ...
                    <center>
                      ...
                      >
                        <option
                          className="cities"
                          data-value=""
                          data-select2-id="select2-data-2-7k0u"
                        />
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-1-3b8h"
        ...
        <p className="aboutustext">
          Are the legalities of Legal Claims stopping you from taking your
          rights? Now, you don't have to worry about it because our team of the
          city's best lawyers is ready to help with all your Legal Claim issues.
          Contact us today!
          <br />
          Asking for what is yours is your legal right. It could be money to
          relieve the damage caused to you due to the defendant's actions. Yet,
          many people are either heedless of the process and facts or avoid it
          due to legalities. And this is why the other party takes advantage of
          the situation without worrying about the damage caused to you. So, we
          at Legal251 have started our Legal Claim Help service to provide you
          with the desired relief from the damage by tackling all the legal work
          ourselves. You only have to provide us with the required information,
          and our best lawyers will take care of it. Contact us for details.
        </p>
        <br />
        <br />
      </div>
          ...
          <div className="col-md-2 col-xs-4  firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                ...
                />
                <p className="benefitscardtext">Enhance Productivity</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Plaintiff's Satisfaction </p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Protects your rights</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Resolve Personal Disputes</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Claim for Personal Injuries</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Get Adequate Compensation </p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Value of time and money</p>
              </center>
            </div>
          </div>
        </div>
              ...
              <div className="col-md-2 Registrationprocesscol4">
                <center>
                  <p className="Registrationprocesstext4 gstrtext4">
                    ...
                    lawyers will prepare the Legal Claim on your behalf. You can
              ...
              <div className="col-md-2 Registrationprocesscol5">
                <center>
                  <p className="Registrationprocesstext5 gstrtext5">
                    ...
                    inform you about completing your Legal Claim.
                  </p>
                </center>
              </div>
            </div>
            ...
            <div className="col-md-6 servicefaqcol1">
              ...
              >
                <div className="panel panel-default servicefaqmainpanel">
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      A Legal Claim happens when someone causes you harm or
                      damage, and you want them to reimburse or repay you for
                      your loss. However, it requires a specific qualification
                      to meet to prove your claim.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Legal Claims generally fall into several categories,
                      including: <br />
                      Product liability cases <br />
                      Worker's compensation cases <br />
                      Social Security Claims <br />
                      Slip and fall claims <br />
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse3"
                      >
                        Q3. What if I want to file a lawsuit against someone
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      It will result in the dismissal of your lawsuit as per the
                      rule.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse4"
                      >
                        Q4. What is the difference between Legal and Equitable
                        Claims?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      The plaintiff files a Legal Claim to get the reimbursement
                      or repay the damage caused by the defendant's actions. An
                      Equitable Claim means the plaintiff is asking the court
                      for an injunction, which is a court order forcing a party
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse5"
                      >
                        Q5. How long do I have to file a personal injury case in
                        India?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      You have 3 years to file a personal injury case since that
                      action occurred.
                    </div>
                  </div>
                </div>
            ...
            <div className="col-md-6 servicefaqcol2">
              <div className="panel-group" id="accordion2">
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse21"
                      >
                        Q6. How long will it take to settle my claim?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20192.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Most cases end up with settlements. However, the time to
                      settle is hard to predict and can vary. However, hiring an
                      attorney may help make the settlement process faster.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse22"
                      >
                        Q7. Do I need a lawyer for a personal injury case?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Some simple injury cases do not require a lawyer to
                      resolve. However, if the facts of the accident are
                      complex, the injuries are significant or unusual, and your
                      money is at risk, you will need a lawyer.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse23"
                      >
                        Q8. What are the 'out of court settlements' advantages?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      The main advantages of "out-of-court settlements are"{" "}
                      <br />
                      Saves your time <br />
                      Saves Costs <br />
                      Guaranteed Compensation <br />
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse24"
                      >
                        Q9. What are the 3 Elements you must prove in a Personal
                        Injury Claim?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      These are the three elements you need to prove for your
                      claim to be valid and successful: <br />
                      The defendant owes your duty of care <br />
                      The defendant breached that duty, <br />
                      Due to which you suffered an injury or loss
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse25"
                      >
                        Q10. Can I file a legal claim without the help of a
                        lawyer in India?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Section 32 of the Advocate's Act of India states, "The
                      court may allow any person to appear before it even if he
                      is not an advocate." Thus, one gets the right to defend
                      his case through the Advocate's Act of India. However, you
                      can contact Legal251 if you need help regarding your Legal
                      Claim.{" "}
                    </div>
                  </div>
                </div>
