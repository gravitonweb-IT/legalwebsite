...
const LegalNoticePreparation = () => {
  ...
  <div style={{ position: "relative", overflowX: "hidden" }}>
    ...
    <a
      href="https://legal251.com/legal-notice-hindi"
      ...
      <div className="servicemaindiv" style={{ marginTop: 7 }}>
        <div className="row">
          <div className="col-md-6">
            <p className="serviceamainheading">Legal Notice Preparation</p>
            <p
              style={{
                fontFamily: '"Roboto"',
                marginTop: 18,
            ...
            >
              No legal action gets commenced without appropriate legal notice.
              Make the Legal Notice effective by hiring someone who has
              professional writing skills and knows the required legal language.
              Ask Legal251 for all Legal Notice related issues.
            </p>
            <br />
            <a href="#formpricediv">
                    ...
                    <center>
                      ...
                      >
                        <option
                          className="cities"
                          data-value=""
                          data-select2-id="select2-data-2-71i1"
                        />
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-1-2ars"
        ...
        <p className="aboutustext">
          Don't know what to do after getting a Legal Notice or how to draft
          one? Now you will. Connect with our legal experts and solve all your
          Legal Notice related issues in no time!
          <br />
          A Legal Notice is a formal and written communication between two
          parties concerning some grievance. Through a legal notice, the sender
          notifies the recipient about his intentions of taking legal action
          against the latter. A Legal Notice is also a final warning to the
          recipient to fulfill a specific condition if he wants to avoid court
          proceedings, allowing the recipient to resolve the issue correctly.
          <br />
          One can draft a legal notice by himself. However, it requires
          knowledge of legal terms and conditions and language. Similarly goes
          with the recipient. Once preparing or answering a legal notice, one
          cannot make changes to it, and if the matter moves to court, the court
          will take it as it is. So, it will be better for someone to take legal
          advice before drafting or replying to a legal notice. Contact our
          legal experts for the best advice.
        </p>
        <br />
        <br />
      </div>
    ...
    <div id="Howtoapply" className="page-section">
      ...
      <center>
        <img
          src="https://legal251.com/images/nda/Legal Notice.png"
          ...
          <div className="col-md-2 col-xs-4  firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                ...
                />
                <p className="benefitscardtext">Written Warning</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Grievance Information</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Mutual Understanding</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Removal of Doubt</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Record</p>
              </center>
            </div>
          </div>
        </div>
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Shared Conclusion</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Outside Court Settlement </p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Dismissal Of Uncertainty</p>
              </center>
            </div>
          </div>
        </div>
              ...
              <div className="col-md-2 Registrationprocesscol1">
                <center>
                  <p className="Registrationprocesstext1 gstrtext1">
                    ...
                    submitted to lessen the chances of incorrect or misleading
              ...
              <div className="col-md-2 Registrationprocesscol3">
                <center>
                  <p className="Registrationprocesstext3 gstrtext3">
                    ...
                    documents to draft the Legal Notice for you.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscol4">
                <center>
                  <p className="Registrationprocesstext4 gstrtext4">
                    Our lawyer will draft your Legal Notice after successful
                    verification of the documents provided by you.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscol5">
                <center>
                  <p className="Registrationprocesstext5 gstrtext5">
                    ...
                    you to let you know your Legal Notice has been prepared.
                  </p>
                </center>
              </div>
            </div>
            ...
            <div className="col-md-6 servicefaqcol1">
              ...
              >
                <div className="panel panel-default servicefaqmainpanel">
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      A legal notice is a formal notice that the sender provides
                      to intimate the recipient for consideration before taking
                      the legal proceedings to court.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse2"
                      >
                        Q2. What are the reasons for legal notice served in
                        employment cases?
                        <img
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Employment law cases can address various matters such as
                      harassment, loss of pay, discrimination, or unlawful
                      termination.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse3"
                      >
                        Q3. If I don't get a reply to my legal notice, what
                        should I do next?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      If the recipient doesn't reply to your legal notice, it
                      would be evidence that the recipient is committing a
                      wrong.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse4"
                      >
                        Q4. Who usually drafts a legal notice?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Generally, the plaintiff's lawyer drafts a legal notice.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse5"
                      >
                        Q5. Why is it essential to file legal notice?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      It is essential to file legal notice because: <br />
                      <li>It is a legal requirement.</li>
                      <li>Gives prior notice to the opponent.</li>
                      <li>Increases efficiency of the litigation process.</li>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6 servicefaqcol2">
              <div className="panel-group" id="accordion2">
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse21"
                      >
                        Q6. What are the modes of sending a legal notice?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20192.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      One can send a legal notice via Direct Courier, Speed
                      Post, Email, Registered Post, WhatsApp messaging, or Hand
                      Delivery.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse22"
                      >
                        Q7. What is the time for filing a reply to a legal
                        notice?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      In some cases, the time for filing a reply to a legal
                      notice is between 15-30 working days and 45 days.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse23"
                      >
                        Q8. What does the term "Show-Cause Notice" mean?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      The term "Show-Cause Notice" means a notice sent to any
                      person or an individual by an authority such as an
                      employer, Government, lawyer, and the like.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse24"
                      >
                        Q9. What are the benefits of legal notice?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      There are various benefits of a legal notice: It provides
                      out of Court Settlements, Written Warning, Cost Friendly,
                      Promotes Mutual Understanding, Acts as Legal Proof, and
                      Removal of Doubt.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse25"
                      >
                        Q10. Under which Act does a Legal Notice someone file in
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Anyone can send a legal notice under Section 80 of the
                      Code of Civil Procedure, 1908, to file Civil Cases in
                      India.
                    </div>
                  </div>
                </div>
