...
import LegalNoticeImg from "../../assests/images/LegalIssueImgs/LegalNotice.png";
...
const faqs = [
  {
    id: 1,
    question:
      "Q1. What are the benefits of legal notice?",
    answer:
      "There are various benefits of a legal notice: It provides out of Court Settlements, Written Warning, Cost Friendly, Promotes Mutual Understanding, Acts as Legal Proof, and Removal of Doubt.",
  },
  {
    id: 2,
    question:
      "Q2. What does the term Show-Cause Notice mean?",
    answer:
      "There are various benefits of a legal notice: It provides out of Court Settlements, Written Warning, Cost Friendly, Promotes Mutual Understanding, Acts as Legal Proof, and Removal of Doubt.",
  },
  {
    id: 3,
    question: "Q3. What is the time for filing a reply to a legal notice?",
    answer:
      "In some cases, the time for filing a reply to a legal notice is between 15-30 working days and 45 days.",
  },
  {
    id: 4,
    question: "Q4. What are the modes of sending a legal notice?",
    answer:
      "One can send a legal notice via Direct Courier, Speed Post, Email, Registered Post, WhatsApp messaging, or Hand Delivery.",
  },
  {
    id: 5,
    question: "Q5. Who usually drafts a legal notice?",
    answer:
      "Generally, the plaintiff's lawyer drafts a legal notice.",
  },
  {
    id: 6,
    question: "Q6. Why is it essential to file legal notice?",
    answer:
      "Filing a legal notice is crucial to formally communicate intentions, demand compliance, and set the stage for potential legal action.",
  },
];
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            Preparing a legal notice involves detailing the issue, relevant
            laws, and desired actions. It should be clear, concise, and formally
            written, outlining facts, legal basis, and consequences.
            Consultation with a lawyer ensures accuracy and adherence to legal
            requirements. Timely delivery to the opposing party is crucial. Seek
            professional advice for effective legal notice preparation tailored
            to your specific situation and jurisdiction.
          </p>
          <div className="mt-5">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          <div className="">
            ...
            <Check formType={"Legal Notice Preparation"}/>
          </div>
          ...
          <div className="">
            ...
            <img src={LegalNoticeImg} className="w-3/4 h-auto"></img>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-10 mx-5 md:mx-20 lg:mx-28 mt-10 md:mt-14">
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Written Warning</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Grievance Information</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Mutual Understanding</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Removal of Doubt</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Record</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Amicable & Speedy Resolution</h1>
        </div>
        ...
        <div className="bg-white shadow-lg p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Proof of Information in Court</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Shared Conclusion</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Outside Court Settlement</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Dismissal Of Uncertainty</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28 mt-5 md:mt-14">
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              Our legal maestros will review all the documents you submitted to
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium ">
              ...
              to draft the Legal Notice for you.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              ...
              let you know your Legal Notice has been prepared.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 mx-5 md:mx-20 lg:mx-28 mt-5 md:mt-14">
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                Our legal maestros will review all the documents you submitted
                to lessen the chances of incorrect or misleading information to
          ...
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                ...
                to let you know your Legal Notice has been prepared.
              </p>
            </div>
          </div>
        </div>
