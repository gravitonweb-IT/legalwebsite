...
const LegalNoticeReply = () => {
 ...
 <div style={{ position: "relative", overflowX: "hidden" }}>
  ...
  <a
    href="https://legal251.com/legal-notice-reply-hindi"
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      <div className="row">
        <div className="col-md-6">
          <p className="serviceamainheading">Legal Notice Reply</p>
          <p
            style={{
              fontFamily: '"Roboto"',
              marginTop: 18,
          ...
          >
            Not sure what to do after getting a legal notice? Don't worry. Let
            Legal251 help you with all your Legal Reply-related issues!
          </p>
          <br />
          <a href="#formpricediv">
      ...
      <div className="Salarieddiv planhide" id={1}>
      ...
      <div id="plans" className="page-section">
        ...
        >
          ...
          >
            <option
              className="cities"
              data-value=""
              data-select2-id="select2-data-2-w5qr"
            />
          ...
          <span
            ...
            dir="ltr"
            data-select2-id="select2-data-1-zegg"
            style={{ width: "100%" }}
          >
        ...
        <div className="Salarieddiv">
          ...
          <div className="row" style={{ margin: 0, padding: 0 }}>
            ...
            <div className="col-md-4 col-sm-5 Salariedcol">
              <div
                style={{
            ...
            <div className="col-md-4 col-sm-5 Salariedcol">
              <div
                style={{
                  ...
                  background:
                    'url("images/itr/Salaried - premium.svg") #f8951d',
                  borderRadius: 10,
                  boxShadow: "6px 6px 6px #00000017",
                  marginBottom: 40
                }}
                ...
                <div style={{ padding: "0 5px 5px 5px" }}>
                  ...
                  >
                    ...
                    <div className="hidesalcon2">
                      ...
                      <p>
                        Preferable in matters where examination of documents is
                        required.
                      </p>
                    </div>
                  </div>
        ...
        <div style={{ padding: "0 40px" }}>
          ...
          <p className="aboutustext">
            Taking too much time to reply to the Legal Notice or failing may put
            you in serious legal trouble. Also, you might lose the chance to
            resolve the dispute amicably. Save your time and chances of getting
            a better resolution with our experts, who will tackle all your Legal
            Reply-related issues.
            <br />
            One thing everyone must understand about the legal Notice is to take
            it seriously and send a proper Legal Reply to avoid legal problems.
            At first, you should respond to the sender and try to resolve the
            matter benevolently. Replying to a legal notice is not mandatory.
            Still, it is advisable to send a proper reply to a Legal Notice so
            that the other party cannot take advantage of it, blaming you for
            not obeying the requirements of the Notice. Contact our finest legal
            experts for the best advice, and they will take care of all your
            Legal Replies.
          </p>
          <br />
          <br />
              ...
              <div className="col-md-2 col-xs-4  firstcarddivcol">
                <div className="servicebenefitscard">
                  <center>
                    ...
                    />
                    <p className="benefitscardtext">Resolution of Dispute</p>
                  </center>
                </div>
              </div>
              <div className="col-md-2 col-xs-4 firstcarddivcol">
                <div className="servicebenefitscard">
                  <center>
                    <img
                      ...
                      className="benefitscardimg"
                    />
                    <p className="benefitscardtext">Amicable Settlement </p>
                  </center>
                </div>
              </div>
              <div className="col-md-2 col-xs-4 firstcarddivcol">
                <div className="servicebenefitscard">
                  <center>
                    <img
                      ...
                      className="benefitscardimg"
                    />
                    <p className="benefitscardtext"> Saves Time &amp; Money</p>
                  </center>
                </div>
              </div>
              <div className="col-md-2 col-xs-4 firstcarddivcol">
                ...
                <div className="servicebenefitscard">
                  <center>
                    <img
                      ...
                      className="benefitscardimg"
                    />
                    <p className="benefitscardtext"> Counter-Reaction </p>
                  </center>
                </div>
              </div>
              <div className="col-md-2 col-xs-4 secondcarddivcol">
                ...
                <div className="servicebenefitscard">
                  <center>
                    <img
                      ...
                      className="benefitscardimg"
                    />
                    <p className="benefitscardtext"> Avoid Legal Actions </p>
                  </center>
                </div>
              </div>
              <div className="col-md-2 col-xs-4 secondcarddivcol">
                <div className="servicebenefitscard">
                  <center>
                    <img
                      ...
                      className="benefitscardimg"
                    />
                    <p className="benefitscardtext"> Admissible in Court</p>
                  </center>
                </div>
              </div>
            </div>
                  ...
                  <div className="col-md-2 Registrationprocesscol1">
                    <center>
                      <p className="Registrationprocesstext1 gstrtext1">
                        Our legal maestros will review all the documents you
                        submit to lessen the chances of incorrect or misleading
                  ...
                  <div className="col-md-2 Registrationprocesscol3">
                    <center>
                      <p className="Registrationprocesstext3 gstrtext3">
                        The lawyers will move further with your documents to
                        prepare for your Legal Reply.
                      </p>
                    </center>
                  </div>
                  <div className="col-md-2 Registrationprocesscol4">
                    <center>
                      <p className="Registrationprocesstext4 gstrtext4">
                        After successfully verifying the documents you provided,
                        our lawyers will prepare the Legal Reply on your behalf.
                        You can download it online from our website or the
                        Legal251 App.
                      </p>
                    </center>
                  </div>
                  <div className="col-md-2 Registrationprocesscol5">
                    <center>
                      <p className="Registrationprocesstext5 gstrtext5">
                        It would be best to wait until our expert contacts you
                        to inform you about completing your Legal Reply.
                      </p>
                    </center>
                  </div>
                </div>
                ...
                <div className="col-md-6 servicefaqcol1">
                  ...
                  >
                    <div className="panel panel-default servicefaqmainpanel">
                      <div className="panel-heading servicefaqpanelheading">
                        <h4 className="panel-title">
                          <a
                            ...
                            href="#collapse1"
                          >
                            1. What is the first thing one must do after getting
                            a Legal Notice?
                            <img
                      ...
                      >
                        <div className="panel-body servicefaqbody">
                          The first thing one should do after receiving a legal
                          notice is to call the sender of the Notice and try to
                          solve the dispute amicably.
                        </div>
                      </div>
                    </div>
                    <div className="panel panel-default servicefaqmainpanel">
                      <div className="panel-heading servicefaqpanelheading">
                        <h4 className="panel-title">
                          <a
                            ...
                            href="#collapse2"
                          >
                            Q2. What if I don’t reply to a legal notice?
                            <img
                      ...
                      >
                        <div className="panel-body servicefaqbody">
                          According to the legal provisions, it is not
                          compulsory to reply to a legal notice. However, not
                          responding to a Legal Notice may add a legal advantage
                          to the sender if the case appears in court. Thus,
                          legal experts advise you to reply to a legal notice
                          with the help of an experienced advocate.
                        </div>
                      </div>
                    </div>
                    <div className="panel panel-default servicefaqmainpanel">
                      ...
                      >
                        <div className="panel-body servicefaqbody">
                          A Legal Reply is a legal document written by a party,
                          mainly replying to a Responsive Declaration and, in
                          some cases, an answer to an obligation.
                        </div>
                      </div>
                    </div>
                    <div className="panel panel-default servicefaqmainpanel">
                      <div className="panel-heading servicefaqpanelheading">
                        <h4 className="panel-title">
                          <a
                            ...
                            href="#collapse4"
                          >
                            Q4. What key points should one keep in mind while
                            drafting a Legal Reply?
                            <img
                              src="https://legal251.com/images/gstregistration/Path_20191.svg"
                              className="servicefaqimg"
                            />
                      ...
                      >
                        <div className="panel-body servicefaqbody">
                          After receiving a legal notice, one should keep the
                          following points in mind to send a Legal Reply: <br />
                          <li>Carefully read the Legal Notice</li>
                          <li>Contact an experienced lawyer </li>
                          <li>
                            Brief the lawyer about the case with complete
                            information
                          </li>
                          <li>
                            Send the Legal Reply and keep a copy of the reply
                            with yourself for future
                          </li>
                        </div>
                      </div>
                    </div>
                    <div className="panel panel-default servicefaqmainpanel">
                      <div className="panel-heading servicefaqpanelheading">
                        <h4 className="panel-title">
                          <a
                            ...
                            href="#collapse5"
                          >
                            Q5. Who can send and draft a Legal Reply?
                            <img
                              src="https://legal251.com/images/gstregistration/Path_20191.svg"
                              className="servicefaqimg"
                            />
                      ...
                      >
                        <div className="panel-body servicefaqbody">
                          A Legal Notice contains lawful credentials. Thus it is
                          essential to draft the Legal Policies to draft
                          properly. You can take help from an experienced
                          advocate or legal personnel from Legal251.
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-md-6 servicefaqcol2">
                  <div className="panel-group" id="accordion2">
                    <div className="panel panel-default servicefaqmainpanel">
                      <div className="panel-heading servicefaqpanelheading">
                        <h4 className="panel-title">
                          <a
                            ...
                            href="#collapse21"
                          >
                            Q6. What period is to send a Legal Reply to a
                            Notice?
                            <img
                              src="https://legal251.com/images/gstregistration/Path_20192.svg"
                              className="servicefaqimg"
                      ...
                      >
                        <div className="panel-body servicefaqbody">
                          One can send a reply to a Legal Notice within 15-45
                          days, depending upon the provisions under which the
                          Notice is drafted.
                        </div>
                      </div>
                    </div>
                    <div className="panel panel-default servicefaqmainpanel">
                      <div className="panel-heading servicefaqpanelheading">
                        <h4 className="panel-title">
                          <a
                            ...
                            href="#collapse22"
                          >
                            Q7. What are the cases in which a legal notice is
                            served?
                            <img
                              src="https://legal251.com/images/gstregistration/Path_20191.svg"
                              className="servicefaqimg"
                      ...
                      >
                        <div className="panel-body servicefaqbody">
                          ...
                          <br />
                          <li>Notice by an employee</li>
                          <li>Notice by employer</li>
                          <li>Consumer complaints</li>
                          <li>Property disputes</li>
                          <li>Recovery of money</li>
                          <li>Breach of contracts</li>
                          <li>Personal conflicts, i.e., divorce</li>
                          <li>Cheque bounce, and more.</li>
                        </div>
                      </div>
                    </div>
                    <div className="panel panel-default servicefaqmainpanel">
                      <div className="panel-heading servicefaqpanelheading">
                        <h4 className="panel-title">
                          <a
                            ...
                            href="#collapse23"
                          >
                            Q8. What are common mistakes people make while
                            sending a Legal Reply?
                            <img
                              src="https://legal251.com/images/gstregistration/Path_20191.svg"
                              className="servicefaqimg"
                            />
                      ...
                      >
                        <div className="panel-body servicefaqbody">
                          ...
                          <br />
                          <li>Not replying on time</li>
                          <li>Forgetting about the relevant sections</li>
                          <li>
                            Not responding in a proper and prescribed manner
                          </li>
                          <li>Not mentioning party’s and advocate’s sign</li>
                          <li>Not mentioning the present address</li>
                          <li>
                            Not adding current/active phone number (contact
                            information)
                          </li>
                        </div>
                      </div>
                    ...
                    <div className="panel panel-default servicefaqmainpanel">
                      <div className="panel-heading servicefaqpanelheading">
                        <h4 className="panel-title">
                          <a
                            ...
                            href="#collapse24"
                          >
                            Q9. What is the benefit of sending a Legal Reply?
                            <img
                              src="https://legal251.com/images/gstregistration/Path_20191.svg"
                              className="servicefaqimg"
                            />
                      ...
                      >
                        <div className="panel-body servicefaqbody">
                          The main advantage of sending a Legal Reply is that it
                          gives a fair chance to resolve their dispute through
                          negotiation, arbitration, or mediation without
                          dragging the matter before the Court of Law.
                        </div>
                      </div>
                    </div>
                    <div className="panel panel-default servicefaqmainpanel">
                      <div className="panel-heading servicefaqpanelheading">
                        <h4 className="panel-title">
                          <a
                            ...
                            href="#collapse25"
                          >
                            Q10. Whom should I address the Legal Reply?
                            <img
                              src="https://legal251.com/images/gstregistration/Path_20191.svg"
                              className="servicefaqimg"
                            />
                      ...
                      >
                        <div className="panel-body servicefaqbody">
                          You have to address the advocate of the person or the
                          person who has sent the Notice.
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <center>
                        ...
                        <div className="clientscardtextdiv">
                          <p className="clientscardtext">
                            ...
                            your hand, and all this, just a few clicks away and
                            inside your pocket. Legal work is now on a whole
                            different level.
                            <img
                      ...
                      <center>
                        ...
                        <div className="clientscardtextdiv">
                          <p className="clientscardtext">
                            ...
                            whole process so convenient and also online makes it
                            so easy for everyone to work with. If talking about
                            quality work, they have absolutely no match. A
                            platform as big as Today's Bharat required a very
                            complete and descriptive terms of condition and
                            privacy policy. This was greatly achieved with the
                            help of experts at <br className="hidden-md" />{" "}
                            Legal251.
                            <img
                              src="https://legal251.com/images/about/iconmonstr-quote-5.svg"
                              className="quoteimage2"
                      ...
                      <center>
                        ...
                        <div className="clientscardtextdiv">
                          <p className="clientscardtext">
                            ...
                            LEGAL251. Their top priority is evident: providing
                            the best and speediest solutions. Their
                            ...
                            were addressed immediately. For those seeking legal
                            assistance that's efficient and of the highest
                            quality, I wholeheartedly endorse LEGAL251.
                      ...
                      <center>
                        ...
                        <div className="clientscardtextdiv">
                          <p className="clientscardtext">
                            ...
                            with their customers. They are the best in business
                            as you may know. There are many complications in
                            Filing GST &amp; Income Tax returns for jewellery
                            supply &amp; design business they make all these
