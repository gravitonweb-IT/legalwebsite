...
import RemoveDirectorImg from "../../assests/images/RemoveDirector/RemoveDirector.jfif";
...
const faqs = [
  {
    id: 1,
    question: "Q1. Can a director be removed without any reason?",
    answer:
      "In general, a director can be removed with or without reason, as long as the removal is done in accordance with the provisions specified in the company's governing documents or the Companies Act.",
  },
  {
    id: 2,
    question: "Q2. Can a director be removed by other directors?",
    answer:
  ...
  {
    id: 3,
    question: "Q3. Can a director challenge their removal?",
    answer:
      "Yes, a director can challenge their removal if they believe it was unjust or conducted in violation of the company's governing documents or applicable laws. ",
  },
  {
    id: 4,
    question: "Q4. Can a director be reappointed after their removal?",
    answer:
      "Yes, in most cases, a director can be reappointed after their removal, subject to the provisions of the company's governing documents and the Companies Act. ",
  },
  {
    id: 5,
    question:
      "Q5. Can a director be removed by shareholders holding a minority stake?",
    answer:
  ...
  },
  {
    id: 6,
    question:
      "Q6. Are there any legal formalities or documentation required for the removal of a director?",
    answer:
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            ...
            However, before taking this action, the Director must be allowed to
            be heard.
          </p>
          <div className="mt-5">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          ...
          <div className="">
            ...
            <img src={RemoveDirectorImg} className="w-[80%] h-auto mt-8"></img>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mx-10 md:mx-20 lg:mx-28 mt-5 md:mt-10">
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Effective governance enhances transparency, accountability, and
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Improved decisions drive success through enhanced strategic thinking
            and collaboration.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Peaceful dialogue fosters resolution, mitigating conflicts with
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Enhanced efficiency elevates overall performance, driving
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Rebuilding trust and confidence ensures stronger relationships and
            collaboration.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Adherence to legal standards ensures regulatory compliance and
      ...
      <div className="hidden lg:block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              Once the process of filing the documentation with the ROC and
              other formalities is completed successfully by our team, you must
              keep patience.
            </p>
          </div>
          <div class="flex  justify-center items-center col-span-3">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              By passing a resolution under AOA and Companies Act, filing forms
              with ROC within the time limit officially removes the director.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 mx-5 md:mx-20 lg:mx-28 mt-5 md:mt-14">
          ...
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                Once the process of filing the documentation with the ROC and
                other formalities is completed successfully by our team, you
                must keep patience.
              </p>
            </div>
          </div>
