...
const DissolutionOfDeed = () => {
  ...
  <a href="dissolution-of-deed-hindi.html" className="languageicon">
                ...
                <div className="row ">
                    ...
                    <div className="content">
                      <ul className="menu-col" id="id01">
                        <li className="incontent">
                          <Link className="text" to="/ParternerShip">
                            <img
                        ...
                        <li className="incontent">
                          <Link
                            className="text"
                            to="private-limited-company-registration.html"
                          >
                            <img
                              className="megamenu_icon"
                        ...
                        <li className="incontent">
                          <Link
                            className="text"
                            to="section-8-company-registration.html"
                          >
                            <img
                              className="megamenu_icon"
                        ...
                        <li className="incontent">
                          <Link
                            className="text"
                            to="llp-company-registration.html"
                          >
                            <img
                              className="megamenu_icon"
                        ...
                        <li className="incontent">
                          <Link
                            className="text"
                            to="opc-one-person-company-registration.html"
                          >
                            <img
                              className="megamenu_icon"
                  ...
                  <div className="col-menu col-md-5">
                    ...
                    <div className="content">
                      <ul className="menu-col" id="id01">
                        <li className="incontent">
                          <Link className="text" to="annual-compliance-llp.html">
                            {" "}
                            <img
                              className="megamenu_icon"
                ...
                <div className="row col-menu">
                        ...
                        <li className="incontent">
                          <div style={{ display: "flex" }}>
                            ...
                            <div>
                              <Link
                                className="text"
                                to="address-amendment-within-state-llp.html"
                              >
                                <span className="hvr-sweep-to-right textres">
                                  {" "}
                        ...
                        <li className="incontent">
                          <div style={{ display: "flex" }}>
                            ...
                            <div>
                              <Link
                                className="text"
                                to="address-amendment-within-state-company.html"
                              >
                                <span className="hvr-sweep-to-right textres">
                                  {" "}
                        ...
                        <li className="incontent">
                          <div style={{ display: "flex" }}>
                            ...
                            <div>
                              <Link
                                className="text"
                                to="address-amendment-out-state-llp.html"
                              >
                                <span className="hvr-sweep-to-right textres">
                        ...
                        <li className="incontent">
                          <div style={{ display: "flex" }}>
                            ...
                            <div>
                              <Link
                                className="text"
                                to="address-amendment-out-state-company.html"
                              >
                                <span className="hvr-sweep-to-right textres">
                                  {" "}
                  ...
                  <div className="col-menu col-md-3 dview">
                    <div className="content">
                      <ul className="menu-col" id="id01">
                        <li className="incontent">
                          <Link className="text" to="add-director.html">
                            {" "}
                            <img
                              className="megamenu_icon"
                        ...
                        <li className="incontent">
                          <Link className="text" to="add-partner.html">
                            {" "}
                            <img
                              className="megamenu_icon"
                        ...
                        <li className="incontent">
                          <Link className="text" to="change-in-name-llp.html">
                            {" "}
                            <img
                              className="megamenu_icon"
                    ...
                    <div className="col-menu col-md-4 dview">
                      <div className="content ">
                        <ul className="menu-col" id="id01">
                          ...
                          <li className="incontent">
                            <Link className="text" to="pf-registration.html">
                              <img
                                className="megamenu_icon"
                    ...
                    <div className="col-menu col-md-4 dview">
                      <div className="content">
                        <ul className="menu-col" id="id01">
                          ...
                          <li className="incontent">
                            <Link to="food-licence.html" className="singlemenua">
                              <img
                                className="megamenu_icon"
                ...
                <div className="row col-menu">
                  ...
                  <div className="col-menu col-md-4 dcol">
                    <div className="content">
                      <ul className="menu-col" id="id01">
                        <li className="incontent">
                          <Link to="legal-drafting.html" className="singlemenua">
                            <img
                              className="megamenu_icon"
                        ...
                        <li className="incontent">
                          <Link to="rent-agreement.html" className="singlemenua">
                            <img
                              className="megamenu_icon"
                        ...
                        <li className="incontent">
                          <Link to="affidavit.html" className="singlemenua">
                            <img
                              className="megamenu_icon"
                  ...
                  <div className="col-menu col-md-5">
                    <div className="content">
                      <ul className="menu-col" id="id01">
                        ...
                        <li className="incontent">
                          <Link to="application.html" className="singlemenua">
                            <img
                              className="megamenu_icon"
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      <div className="row">
        <div className="col-md-6">
          <p className="serviceamainheading">Dissolution Of Deeds</p>
          <p
            style={{
              fontFamily: '"Roboto"',
              marginTop: 18,
          ...
          >
            According to Indian Partnership Act 1932, one can dissolve a
            partnership using the Dissolution of Deeds agreement. Let Legal251
            handle your DISD for you.
          </p>
          <br />
          <a href="#formpricediv">
      ...
      <p className="aboutustext">
        The simplest way to start an establishment with another person is to
        form a partnership. But, sometimes, you have to put an end to the
        partnership firm, which is known as Dissolution of partnership. And for
        that, you have to make a Dissolution of Deed.
        <br />
        Dissolution Deed or Dissolution of Partnership Deed is written or made
        when the partnership between the partners of a firm dissolves. The
        Dissolution takes place according to Section 39 under the Indian
        Partnership Act 1932.
        <br />
        The term "firm dissolution" suggests the breakup of a partnership
        between all its business participants. This process clarifies the
        discarding and selling of the respective firm's assets, accounts, and
        liability settlements. However, the partnership firm dissolution, legal
        provisions, and account settlement come with certain risks included, and
        it needs to be handled professionally.
        <br />
        Don't know whom to ask for help? Contact us, and our aces will handle
        all your Dissolution of Deeds issues!
      </p>
      <br />
      <br />
    </div>
  ...
  <div id="Howtoapply" className="page-section">
    ...
    <center>
      <img
        src="../images/nda/Dissolution%20of%20Deeds.png"
      ...
      <div className="row" style={{ margin: 0, padding: 0 }}>
        <div className="col-md-2 col-xs-4  firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img src="../images/faqflag.svg" className="benefitscardimg" />
              <p className="benefitscardtext">Removal of Partners</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img src="../images/faqflag.svg" className="benefitscardimg" />
              <p className="benefitscardtext">Sharing Profits</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img src="../images/faqflag.svg" className="benefitscardimg" />
              <p className="benefitscardtext"> Avoid Legal Proceedings</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
        ...
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img src="../images/faqflag.svg" className="benefitscardimg" />
              <p className="benefitscardtext">Protects Rights</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
      ...
      <div className="row" style={{ margin: 0, padding: 0 }}>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img src="../images/faqflag.svg" className="benefitscardimg" />
              <p className="benefitscardtext">Time-Saving</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img src="../images/faqflag.svg" className="benefitscardimg" />
              <p className="benefitscardtext"> Avoid Mistakes</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img src="../images/faqflag.svg" className="benefitscardimg" />
              <p className="benefitscardtext"> Easy Settlements </p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img src="../images/faqflag.svg" className="benefitscardimg" />
              <p className="benefitscardtext">Assigning Outstanding Debts</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img src="../images/faqflag.svg" className="benefitscardimg" />
              <p className="benefitscardtext">Avoid State Default Rules</p>
            </center>
          </div>
        </div>
      </div>
          ...
          <div className="col-md-6 servicefaqcol1">
            ...
            >
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse1"
                    >
                      1. What are the ways of dissolving a Partnership Firm?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The ways of dissolving a Partnership Firm are: <br />
                    Dissolution by Mutual Consent <br />
                    Dissolution by Notice <br />
                    Dissolution by Court <br />
                    Compulsory Dissolution <br />
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse2"
                    >
                      Q2. What does it mean by Dissolution by Court?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    When two or more partners don't find it suitable to continue
                    under some circumstances, in such cases, the court may
                    dissolve the partnership of the firm. Some main grounds
                    where Dissolution by Court takes place are: <br />
                    Due to the Mental Instability of a partner <br />
                    Due to misconduct <br />
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse3"
                    >
                      Q3.Who Is Responsible after Dissolution?
                      <img
                        src="../images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The partners are liable for any act/occurrence after
                    Dissolution except the ones who are insolvent/dead.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse4"
                    >
                      Q4. What is Compulsory Dissolution?
                      <img
                        src="../images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The Compulsory Dissolution of a firm occurs when (i) All
                    partners or all partners except one partner are declared
                    insolvent and (ii) The firm is carrying out illegal
              ...
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Under this section, the Dissolution of Deeds Act describes
                    what is meant by the Dissolution of a firm to mean the
                    Dissolution of a partnership between all the partners.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-6 servicefaqcol2">
            <div className="panel-group" id="accordion2">
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse21"
                    >
                      Q6. Which section says a court may dissolve a partnership?
                      <img
                        src="../images/gstregistration/Path_20192.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Section 44 provides the grounds on which a court may
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse22"
                    >
                      Q7. Is the Dissolution of a partnership different from the
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Yes, business continues in the Dissolution of partnership,
                    whereas the company is closed in the Dissolution of a firm.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse23"
                    >
                      Q8. Is a firm dissolved when all partners give consent to
                      it?
                      <img
                        src="../images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Mutual consent is the best and most straightforward way to
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse24"
                    >
                      Q9. Can a firm compulsorily dissolve when a partner
                      decides to retire?
                      <img
                        src="../images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    No, the remaining partners can continue the business.
                    Therefore, there is no need to dissolve the firm.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse25"
                    >
                      Q10. Will a partnership dissolve when there is a death of
                      a partner?
                      <img
                        src="../images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
        ...
        <div className="clientscard clientservicemargin">
          <center>
            ...
            <div className="clientscardstardiv">
              <img
                src="../images/about/Icon%20ionic-md-star.svg"
                className="staricon"
              />
              <img
                src="../images/about/Icon%20ionic-md-star.svg"
            ...
            <div className="clientscardtextdiv">
              <p className="clientscardtext">
                <img
                  src="../images/about/iconmonstr-quote-1.svg"
                ...
                easy and efficient.
                <img
                  src="../images/about/iconmonstr-quote-5.svg"
        ...
        <div className="col-md-6">
          <div className="row">
            <div className="col-md-4">
              ...
              <a
                href="cdn-cgi/l/email-protection.html#f2919d9c86939186b29e9795939ec0c7c3dc919d9f"
                style={{ textDecoration: "underline", color: "#fff" }}
                className="footertext"
              >
                <span
                  className="__cf_email__"
                  data-cfemail="93f0fcfde7f2f0e7d3fff6f4f2ffa1a6a2bdf0fcfe"
                >
                  [email&nbsp;protected]
                </span>
              </a>
