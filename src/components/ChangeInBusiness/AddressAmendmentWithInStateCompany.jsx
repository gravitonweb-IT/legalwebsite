...
const faqs = [
  {
    id: 1,
    question: "Q1. What is a Company Address Amendment (within State)?",
    answer:
      "A Company Address Amendment (within State) refers to the process of changing the registered office address of a company within the same state or territory where it is registered. ",
  },
  {
    id: 2,
    question: "Q2. Why would I need to amend the company address?",
    answer:
      "Company address amendments may be necessary due to relocation, expansion, or legal requirements, ensuring accurate communication, compliance, and operations.",
  },
  {
    id: 3,
    question: "Q3. Do I need to inform other parties about the company address amendment?",
    answer:
      "Yes, it's important to inform relevant parties about the company address amendment. This includes updating the new address on company letterheads, business cards, website, and notifying customers, suppliers, financial institutions, and other stakeholders of the change.",
  },
  {
    id: 4,
    question: "Q4. Can I amend the company address myself, or do I need professional assistance?",
    answer:
      "The complexity of the Company Address Amendment (within State) process can vary based on the jurisdiction. While some amendments can be done by the company's authorised representative, it's advisable to consult legal and business professionals to ensure compliance with applicable laws and regulations.",
  },
  {
    id: 5,
    question:
      "Q5. How do I submit a Company Address Amendment (within State)?",
    answer:
      "The submission process for a Company Address Amendment (within State) varies by jurisdiction. It typically involves submitting the completed amendment form and supporting documents to the relevant regulatory authority.",
  },
  {
    id: 6,
    question:
      "Q6. Can I amend the company address myself, or do I need professional assistance?",
    answer:
      "Partners' consent is generally required if the amendment affects the LLP agreement. Obtaining their approval through a partner meeting or signatures on the amended agreement is advisable.",
  },
];
...
const AddressAmendmentWithInStateCompany = () => {
  ...
  const handleSubmit = (e) => {
    ...
    var raw = JSON.stringify({
      ...
      "city": formData.city,
      "type": "AddressAmendmentWithinStateCompany"
    });
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            To amend a company's address within the state, submit a formal
            request to the respective state's Secretary of State or equivalent
            regulatory authority. Include the updated address, company details,
            and any required documentation. Pay any applicable fees associated
            with the address amendment. Ensure compliance with state regulations
            to expedite the process. Accurate and up-to-date address information
            is crucial for legal and operational purposes.
          </p>
          <div className="mt-5">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          <div className="">
            ...
            <Check formType={"Address Amendment WithIn State Company"}/>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mx-10 md:mx-20 lg:mx-28 mt-5 md:mt-10">
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Accurate records ensure legal compliance and efficient business
            operations.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Clear, concise communication fosters understanding and promotes
            effective collaboration in organizations.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Timely and proper delivery ensures legal notice compliance and
            effectiveness.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Adherence to regulations is crucial for maintaining good standing in
            organizations.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Compliance safeguards, preventing penalties, and mitigating adverse
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Sustained operations and resilience ensure business continuity in
            diverse scenarios.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Adopting professional behavior and practices contributes to
            enhancing overall professionalism.
          </p>
        </div>
      </div>
