...
<div style={{ position: "relative", overflowX: "hidden" }}>
    ...
    <div className="input-group-btn">
      ...
      >
        <div className="popupsearchbaraddon">
          <img src="images/closeicon.svg" className="subscribeemailclose" />
        </div>
      </div>
    </div>
  </div>
  ...
  >
    <div className="trackserviceheader" id="trackservicediv">
      ...
      <div className="dropdown mydropdownclass" style={{ color: "#2d2d2d" }}>
        ...
        >
          Login <img src="images/common/login.svg" className="userloginicon" />
        </button>
      ...
      <a href="track-service.html" style={{ color: "#2d2d2d" }}>
        <button className="trackservicebutton">
          ...
          <img src="images/trackservice.svg" className="trackserviceicon" />
        </button>
      </a>
      <div className="trackservicebuttonmobdiv dropdown">
        ...
        >
          User Services
          <img src="images/common/Group_7.svg" className="userloginicon" />
        </button>
  ...
  />
  <div>
    <div className="nav navbar-nav serviceheader" style={{ display: "none" }}>
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      <div className="row">
        <div className="col-md-6">
          ...
          >
            ...
            sure everything is done correctly and quickly. Make the most of your
            business legally with Legal 251 – it's fast, easy, and reliable.
            <br />
            <a href="#formpricediv">
              ...
              <div className="row">
                <div className="col-md-6">
                  <center>
                    ...
                    >
                      Proceed now{" "}
                      <img
                        src="images/services/Path%204125.svg"
                ...
                <div className="col-md-6">
                  <center>
                    ...
                    <br />
                    <img
                      src="images/services/1%20(37).png"
        ...
        <div className="col-md-6 mobhidebr">
          <center>
            ...
            <br />
            <img
              src="images/services/Asset%201%401000x.png"
      ...
      <p className="aboutustext">
        ...
        Ministry of Corporate Affairs (MCA); the other branches and offices can
        be opened by a company without any prior intimation to the Registrars of
        Companies (ROC). If there is a change of address in a company's
        registered office, the ROC must be notified within 15 days. If the
        company wants to change the registered office, then the company needs to
        file a form INC22 with the MCA. It should be filed within 30 days of
        passing the board resolution. Suppose the company wants to change the
        registered office from the jurisdiction of one ROC to another. In that
        case, the company has to apply for the approval of the Regional Director
        as prescribed in Form INC-23. Get your Company Address Amendment (within
        State) from Legal251 in no time, without any hassle. Our team of experts
        will be with you every step of the way to make sure everything is done
        correctly and quickly. Make the most of your business legally with Legal
        251 – it's fast, easy, and reliable.
      </p>
      <br />
      <br />
    </div>
  ...
  <div id="Howtoapply" className="page-section">
    ...
    <p className="servicehrheading">
      &nbsp;{" "}
      <img src="images/services/question.svg" className="Howtoapplyimage" /> How
      to apply&nbsp;
    </p>
    ...
    <center>
      <img
        src="images/nda/Company-Address-Intrastate-Amendment%402x.png"
        ...
        <div className="companybenefitscard ">
          <div className="row ">
            ...
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Legal-Requirements.svg"
          ...
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                ...
                address. This helps prevent any confusion or discrepancies when
                presenting such documents to third parties, financial
                institutions, or regulatory bodies.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/official-documentation.svg"
                className="companybenefitscardimg companybenefitscardimgheight1 "
              />
            </div>
          </div>
          ...
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                ...
                important communications, notices, and legal documents reach the
                company promptly. It allows for efficient communication with
                government authorities, customers, suppliers, and other business
                partners, minimising the risk of missed correspondence or
                delays.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/communication.svg"
                className="companybenefitscardimg companybenefitscardimgheight1 "
              />
            </div>
          </div>
      ...
      <div className="col-md-6">
        <div className="companybenefitscard ">
          <div className="row ">
            ...
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Legal-notice.svg"
                className="companybenefitscardimg companybenefitscardimgheight1 "
              />
            </div>
          </div>
        ...
        <div className="companybenefitscard ">
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                An accurate registered office address demonstrates the company's
                commitment to compliance and professionalism. It helps maintain
                the company's good standing and reputation, as stakeholders
                perceive it as a well-managed and legally compliant entity.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/good-standing.svg"
                className="companybenefitscardimg companybenefitscardimgheight1 "
              />
            </div>
          </div>
          ...
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                ...
                avoid potential legal and financial repercussions that may arise
                from non-compliance.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Avoiding-Penalties.svg"
                className="companybenefitscardimg companybenefitscardimgheight1 "
              />
            </div>
          </div>
          ...
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                ...
                correspondence, and regulatory notifications reach the company's
                designated office without disruption. This is particularly
                important during important transactions, audits, or legal
                processes.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Business-Continuity.svg"
                className="companybenefitscardimg companybenefitscardimgheight1 "
              />
            </div>
          </div>
          ...
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                ...
                impact the company's reputation and relationships with clients,
                partners, and investors.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Enhancing-Professionalism.svg"
                className="companybenefitscardimg companybenefitscardimgheight1 "
              />
            </div>
          </div>
      ...
      <div style={{ padding: "0px 10.61vw" }}>
        <div>
          ...
          <div>
            <center>
              <img
                src="images/services/blue.svg"
                className="registrationicon1"
              />
              <img
                src="images/services/yellow.svg"
                className="registrationicon2"
              />
              <img
                src="images/services/blue_cut.svg"
              ...
              />
              <img
                src="images/services/Group_1799.svg"
          ...
          <div className="col-md-6 servicefaqcol1">
            ...
            >
              ...
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The processing time for a Company Address Amendment (within
                    State) can vary depending on the jurisdiction and the
                    workload of the regulatory authority. It's advisable to
                    check the estimated processing time provided by the
                    authority or consult with them directly for a more accurate
                    timeline.
                  </div>
                </div>
              </div>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    (within State) varies by jurisdiction. It typically involves
                    submitting the completed amendment form and supporting
                    documents to the relevant regulatory authority. This can be
                    done through online portals, mail, or in-person submission,
                    depending on the options provided by the authority.
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse21"
                    >
                      Q5. Are there any fees associated with the Company Address
                      Amendment (within State)?
                      <img
                        src="images/gstregistration/Path_20192.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    being made. It's important to check the official website of
                    the regulatory authority or contact them directly to
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    <ul>
                      ...
                      <li>
                        Ensuring compliance with legal requirements to maintain
                        accurate records.
                      </li>
                      <li>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    address on company letterheads, business cards, website, and
                    notifying customers, suppliers, financial institutions, and
                    other stakeholders of the change. It's also essential to
                    update any applicable government registrations, licences,
                    and permits with the new address.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    representative, it's advisable to consult legal and business
                    professionals to ensure compliance with applicable laws and
                    regulations. They can provide guidance and assistance
        ...
        <div className="col-md-6">
          <div className="row">
            <div className="col-md-4">
              ...
              <a
                href="cdn-cgi/l/email-protection.html#20434f4e54414354604c4547414c1215110e434f4d"
                style={{ textDecoration: "underline", color: "#fff" }}
                className="footertext"
              >
                <span
                  className="__cf_email__"
                  data-cfemail="680b07061c090b1c28040d0f09045a5d59460b0705"
                >
                  [email&nbsp;protected]
                </span>
              </a>
