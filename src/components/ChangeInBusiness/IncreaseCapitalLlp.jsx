...
import IncreaseCapital from "../../assests/images/IncreaseCapitalllp/IncreaseCapital.png";
...
const faqs = [
  {
    id: 1,
    question:
      "Q1. Why would I consider increasing the capital of my LLP in India?",
    answer:
      "Increasing the capital of your LLP provides additional financial resources that can support business growth, fund new projects, attract investors, and strengthen the overall financial position of your LLP.",
  },
  {
    id: 2,
    question:
      "Q2. Is there a minimum or maximum limit for the capital increase?",
    answer:
      "There are no specific limits on the capital increase; it can be tailored to meet the requirements of your LLP.",
  },
  {
    id: 3,
    question: "Q3. What is the process for increasing the capital of an LLP?",
    answer:
      "Increasing capital in an LLP typically involves a member resolution, updating the LLP agreement, and filing required forms with authorities.",
  },
  {
    id: 4,
    question: "Q4. Can the capital increase be done at any time?",
    answer:
      "Yes, you have the flexibility to increase the capital of your LLP at any time as per your business requirements.",
  },
  {
    id: 5,
    question:
      "Q5. Are all partners required to give consent for the capital increase?",
    answer:
      "Yes, obtaining the consent of all partners is generally required to proceed with the capital increase. This can be done through a partner meeting or obtaining their signatures on the amended LLP agreement.",
  },
  {
    id: 6,
    question:
      "Q6. What documents are needed to increase the capital of an LLP?",
    answer:
      "You must typically amend the LLP agreement and file LLP Form 3 with the RoC. Additionally, supporting documents such as the updated LLP agreement and payment of prescribed fees may be required.",
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            Increase Capital LLP is a financial services firm specializing in
            investment management, advisory, and wealth enhancement. With a
            client-centric approach, we deliver tailored solutions to optimize
            financial portfolios. Our team of seasoned professionals combines
            expertise with innovative strategies, fostering growth and
            mitigating risks. By aligning with clients' goals, we provide
            comprehensive financial planning, asset allocation, and risk
            management.
          </p>
          <div className="mt-5">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          <div className="">
            ...
            <Check formType={"Increase Capitals LLp"}/>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mx-10 md:mx-20 lg:mx-28 mt-5 md:mt-10">
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Optimized financial resilience, bolstering strength for sustained
            growth.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Strategic expansion and diversification initiatives drive sustained
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Enhanced borrowing capacity empowers flexibility for strategic
            financial maneuvers.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Attracting investors, forging strategic partnerships for sustained
            growth and success.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Attracting and retaining skilled talent for organizational
            excellence.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Fortified brand reputation through consistent excellence, trust, and
            innovation.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Adaptable operations ensure flexibility, resilience, and
            responsiveness to dynamic challenges.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Strategic measures in place for effective mitigation of financial
            risks.
          </p>
        </div>
      </div>
