...
const IncreaseCapitalLlp = () => {
  ...
  <div>
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      ...
      <p className="aboutustext">
        ...
        injecting additional funds into your LLP to support growth and seize new
        opportunities. Our experienced team will guide you through the entire
        process, ensuring a seamless and hassle-free experience. We start by
        assessing your capital requirements and determining the desired
        increase. Our experts will then assist you in convening a partner
        meeting to obtain the necessary consent for the capital increase. We
        handle all the necessary paperwork, including amending the LLP agreement
        and filing the LLP Form 3 with your state's Registrar of Companies
        (RoC). With our in-depth knowledge of the regulations and processes, we
        ensure compliance and timely submission. By availing of our Increase
        Capital of LLP service, you can strengthen your LLP's financial
        position, fuel its growth, and confidently embark on new ventures.
        Contact Legal251 today to take your LLP to new heights through increased
        capital.
      </p>
      <br />
      <br />
  ...
  <div id="Howtoapply" className="page-section">
    ...
    <center>
      <img
        src="images/nda/Increase-in-Paid-Up-Share-Capital%402xLLP.png"
        ...
        <div className="companybenefitscard companybenefitscard3">
          <div className="row ">
            ...
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Enhanced-Financial-Strength.svg"
        ...
        <div className="companybenefitscard companybenefitscard3">
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                With increased capital, your LLP can explore expansion into new
                markets, diversify its offerings, or invest in research and
                development, fostering business growth and competitiveness.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Funding-for-Expansion.svg"
                className="companybenefitscardimg   companybenefitscardimgmargin3"
              />
            </div>
          </div>
      ...
      <div className="col-md-6">
        <div className="companybenefitscard companybenefitscard3">
          <div className="row ">
            ...
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Improved-Creditworthiness.svg"
        ...
        <div className="companybenefitscard companybenefitscard3">
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                A substantial capital increase makes your LLP more attractive to
                potential investors and partners, opening doors to strategic
                alliances, joint ventures, and equity investments.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/investors-confidence.svg"
                className="companybenefitscardimg companybenefitscardimgheight1 companybenefitscardimgmargin2 companybenefitscardimgmargin3"
              />
            </div>
          </div>
      ...
      <div className="col-md-6">
        <div className="companybenefitscard companybenefitscard3">
          <div className="row ">
            ...
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Strategic-Acquisitions.svg"
                className="companybenefitscardimg companybenefitscardimgheight1 companybenefitscardimgmargin2 companybenefitscardimgmargin3"
              />
            </div>
          </div>
          ...
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                ...
                customers, suppliers, and stakeholders, instilling confidence in
                the organisation's stability, growth prospects, and ability to
                deliver on commitments.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Debt-Reduction.svg"
                className="companybenefitscardimg companybenefitscardimgheight1 companybenefitscardimgmargin2 companybenefitscardimgmargin3"
              />
            </div>
          </div>
          ...
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                ...
                seize time-sensitive opportunities, and adapt to evolving market
                dynamics, providing the flexibility needed for agile
                decision-making.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Capital-Structure.svg"
                className="companybenefitscardimg companybenefitscardimgheight1 companybenefitscardimgmargin2 companybenefitscardimgmargin3"
              />
            </div>
          </div>
      ...
      <div className="col-md-6">
        <div className="companybenefitscard companybenefitscard3">
          <div className="row ">
            ...
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Quality-Talent.svg"
                className="companybenefitscardimg companybenefitscardimgheight1 companybenefitscardimgmargin2 companybenefitscardimgmargin3"
              />
            </div>
          </div>
            ...
            <div className="col-md-2 Registrationprocesscol5">
              <center>
                <p className="Registrationprocesstext5 gstrtext5 gstrtext5iipusc">
                  Necessary paperwork, including amending the LLP agreement and
                  filing the LLP Forms with the RoC in your state.
                </p>
              </center>
            </div>
          </div>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse1"
                    >
                      Q1. Why would I consider increasing the capital of my LLP
                      in India?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    new projects, attract investors, and strengthen the overall
                    financial position of your LLP.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    <ul>
                      ...
                      <li>
                        Fax the necessary documents with your state's Registrar
                        of Companies (RoC).
                      </li>
                    </ul>
                  </div>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    done through a partner meeting or obtaining their signatures
                    on the amended LLP agreement.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    You must typically amend the LLP agreement and file LLP Form
                    3 with the RoC. Additionally, supporting documents such as
                    the updated LLP agreement and payment of prescribed fees may
                    be required.
                  </div>
                </div>
              </div>
          ...
          <div className="col-md-6 servicefaqcol2">
            <div className="panel-group" id="accordion2">
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    There are no specific limits on the capital increase; it can
                    be tailored to meet the requirements of your LLP.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse22"
                    >
                      Q7. How long does it take to complete the capital increase
                      process?
                      <img
                        src="images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
              ...
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    Affairs (MCA) and ensuring compliance with applicable laws.
                    It is recommended to consult with professionals to ensure
                    proper compliance.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    It is advisable to consult with qualified professionals such
                    as chartered accountants or company secretaries who can
                    provide guidance, ensure compliance, and assist with the
                    necessary paperwork for a smooth and error-free capital
                    increase process.
                  </div>
                </div>
              </div>
        ...
        <div className="col-md-6">
          <div className="row">
            <div className="col-md-4">
              ...
              <a
                href="cdn-cgi/l/email-protection.html#6b0804051f0a081f2b070e0c0a07595e5a45080406"
                style={{ textDecoration: "underline", color: "#fff" }}
                className="footertext"
              >
                <span
                  className="__cf_email__"
                  data-cfemail="35565a5b415456417559505254590700041b565a58"
                >
                  [email&nbsp;protected]
                </span>
              </a>
