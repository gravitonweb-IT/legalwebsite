...
import CompanyNameImg from "../../assests/images/CompanyNameImg/CompanynameImg.png";
...
const faqs = [
  {
    id: 1,
    question: "Q1. What benefits can the company expect after the name change?",
    answer:
      "The benefits include improved brand identity, increased market opportunities, customer engagement, and a competitive advantage in the industry.",
  },
  {
    id: 2,
    question: "Q2. What legal steps are involved in changing a company's name?",
    answer:
      "The legal steps typically include filing articles of amendment with the relevant government authorities and updating business licences and registrations.",
  },
  {
    id: 3,
    question: "Q3. Why would a company consider a name change?",
    answer:
      "A company may consider a name change due to rebranding, mergers, acquisitions, or to better align with its evolving vision and goals.",
  },
  {
    id: 4,
    question: "Q4. How long does the name change process usually take?",
    answer:
      "The time frame varies by jurisdiction but can take several weeks to a few months, depending on government processing times.",
  },
  {
    id: 5,
    question:
      "Q5. Can the company choose any name for the change, or are there restrictions?",
    answer:
      "Most jurisdictions have naming guidelines that companies must follow to prevent misleading or inappropriate names.",
  },
  {
    id: 6,
    question:
      "Q6. Are there any trademark or intellectual property considerations for a name change?",
    answer:
      "A company must ensure the new name doesn't infringe on existing trademarks or intellectual property rights.",
  },
];

const Changeincompany = () => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            Changing a company's name involves a series of legal and procedural
            steps. Begin by checking the availability of the new name with the
            corporate registry and ensuring it complies with naming regulations.
            Amend the Articles of Association to reflect the new name, and
            obtain shareholder approval through a resolution. Update all legal
            documents, licenses, and inform relevant authorities to complete the
            process seamlessly and avoid any legal complications.
          </p>
          <div className="mt-5">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          <div className="">
            ...
            <Check formType={"Change In Company"}/>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mx-10 md:mx-20 lg:mx-28 mt-5 md:mt-10">
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Strategic branding efforts elevate recognition, fostering an
            enhanced brand identity.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Diversification strategies unlock new markets, creating expanded
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Interactive strategies and personalized approaches lead to increased
            customer engagement.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Innovative practices and strategic differentiation create a
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Excellence and ethical conduct contribute to an improved
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Adaptability fosters resilience, driving organizational flexibility
            and sustained growth strategies.
          </p>
        </div>
      </div>
...
export default Changeincompany;
