...
const faqs = [
  {
    id: 1,
    question: "Q1. Why is it necessary to amend the address of an LLP within the state of India?",
    answer:
      "Updating the address is crucial to maintain compliance with legal requirements and ensure accurate records with the Ministry of Corporate Affairs (MCA) and other government agencies.",
  },
  {
    id: 2,
    question: "Q2. What documents are required for the address amendment process?",
    answer:
      "Typically, you must submit LLP Form 3 (for filing LLP agreements and changes) and proof of the new address, such as utility bills or property tax receipts.",
  },
  {
    id: 3,
    question: "Q3. Can I amend the address without the partners' consent?",
    answer:
  ...
  {
    id: 4,
    question: "Q4.How do I submit the address amendment application?",
    answer:
      "The LLP Form 3 and supporting documents must be submitted to the Registrar of Companies (RoC) within your state.",
  },
  {
    id: 5,
    question:
      "Q5. What happens after the address amendment is approved?",
    answer:
      "Once approved, the RoC will update the LLP's address in its records, ensuring that official communication is directed to the correct location.",
  },
  {
    id: 6,
    question:
      "Q6. Can I update the address to any location within the state?",
    answer:
      "Yes, you can choose any valid address within the same state where your LLP is registered.",
  },
];
...
const AddressAmendmentWithInStateLlp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    var raw = JSON.stringify({
      ...
      "city": formData.city,
      "type": "AddressAmendmentWithInStateLLp"
    });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
          <div className="">
            ...
            <p className="text-md xl:text-lg font-medium mt-5 text-justify">
              ...
              Pay the prescribed fee and comply with LLP regulations to ensure
              accurate and timely address updates in official records.
              To change an LLP's address within a state, complete Form 15,
              submit required documents, and pay applicable fees to the
              Registrar.
            </p>
          ...
          <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
            <div className="">
              ...
              <Check formType={"Address Amendment WithIn State LLP"}/>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mx-10 md:mx-20 lg:mx-28 mt-5 md:mt-10">
          <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
            ...
            <p className="text-gray-600 mt-3 text-center">
              Compliance with laws is crucial for legal integrity and
          ...
          <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
            ...
            <p className="text-gray-600 mt-3 text-center">
              Adhering to rules avoids penalties, ensuring smooth operations and
              legal conformity.
            </p>
          </div>
          ...
          <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
            ...
            <p className="text-gray-600 mt-3 text-center">
              Adhering to regulations is key to maintaining good standing and
          ...
          <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
            ...
            <p className="text-gray-600 mt-3 text-center">
              Prioritize accessibility to benefit stakeholders and ensure
          ...
          <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
            ...
            <p className="text-gray-600 mt-3 text-center">
              Efficient, secure processes ensure seamless banking and financial
              transactions for clients and institutions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28 mt-5 md:mt-14">
            ...
            <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium ">
                ...
                documents, and other formalities is completed by our team, we’ll
                update you.
              </p>
            </div>
          </div>
