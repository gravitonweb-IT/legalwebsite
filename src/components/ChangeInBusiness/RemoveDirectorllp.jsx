...
import RemovePartnerImg from "../../assests/images/RemovePartner/RemovePartner.png";
...
const faqs = [
  {
    id: 1,
    question: "Q1. Can a partner be removed from an LLP in India?",
    answer:
      "Yes, a partner can be removed from an LLP in India through a prescribed legal process.",
  },
  {
    id: 2,
    question: "Q2. What is the process for removing a partner from an LLP?",
    answer:
  ...
  },
  {
    id: 3,
    question:
      "Q3. Is unanimous consent of partners required to remove a partner?",
    answer: "Is unanimous consent of partners required to remove a partner?",
  },
  {
    id: 4,
    question:
      "Q4. Should I seek professional assistance for partner removal from an LLP?",
    answer:
  ...
  {
    id: 5,
    question: "Q5.  Can the LLP agreement be amended after removing a partner?",
    answer:
  ...
  },
  {
    id: 6,
    question:
      "Q6.  Do I need to inform tax authorities about the partner's removal?",
    answer:
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            To remove a partner from a Limited Liability Partnership (LLP),
            follow the LLP agreement's provisions or relevant state laws.
            Typically, this involves a formal resolution, updating official
            records, and notifying regulatory authorities. Draft a resolution
            documenting the partner's departure, hold a meeting, and ensure
            consensus among other partners. Amend the LLP agreement and file
            necessary forms with the appropriate government authorities for
            official removal.
          </p>
          <div className="mt-5">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          <div className="">
            ...
            <Check formType={"Remove Director LLP"}/>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mx-10 md:mx-20 lg:mx-28 mt-5 md:mt-10">
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Enhanced oversight and streamlined processes contribute to improved
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Increased adaptability and agility lead to enhanced organizational
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            ...
            contribute to dispute mitigation.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Economic security, fiscal strength, and sustainable financial
            well-being ensure stability.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Consistent excellence and ethical practices bolster and reinforce
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Enhanced responsibility and transparent practices lead to increased
      ...
      <div className="hidden lg:block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              After our team successfully completes the documentation filing and
              other formalities, please be patient throughout the process.
            </p>
          </div>
          <div class="flex  justify-center items-center col-span-3">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              ...
              update, including LLP Agreement PAN, TAN, Bank Accounts, and other
              registrations, officially confirming partner removal.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="block lg:hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 mx-5 md:mx-20 lg:mx-28 mt-5 md:mt-14">
          ...
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                After our team successfully completes the documentation filing
                and other formalities, please be patient throughout the process.
              </p>
            </div>
          </div>
