...
const AddPartner = () => {
  ...
  <div>
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      ...
      <p className="aboutustext">
        ...
        new partner to an LLP. The existing partner must provide written consent
        and complete the necessary documentation, forms explicitly 4 and 3,
        along with all relevant attachments. The process of adding a partner to
        an LLP involves two crucial steps. The first step is to pass a
        resolution for the partner's admission, which entails the existing
        partners collectively agreeing to bring the new partner on board. Once
        the resolution is passed, the second step is to complete the LLP
        agreement amendment. This involves updating the LLP agreement to reflect
        the inclusion of the new partner. By choosing "Add Partner to Limited
        Liability Partnership (LLP)" by Legal251, you can rest assured that your
        LLP's legal requirements will be met with precision and efficiency. Our
        meticulous attention to detail, commitment to compliance, and extensive
        knowledge of the LLP Act 2008 will ensure a smooth transition as you
  ...
  <div id="Howtoapply" className="page-section">
    ...
    <br />
    <center>
      <img src="images/nda/Add-Partner%402x.png" className="gsthowtoapplyimg" />
    </center>
  </div>
          ...
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext">
                ...
                into the business. The new partner can contribute funds, assets,
                or expertise, thereby strengthening the financial position of
                the business and providing resources for expansion, investment,
                or operational requirements.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Increased-Capital.svg"
        ...
        <div className="companybenefitscard">
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                The addition of a partner helps distribute the responsibilities
                and workload among multiple individuals. This can lead to
                increased efficiency and productivity as partners can specialise
                in different areas of expertise, share decision-making, and
                collectively contribute to the growth and management of the
                business.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/Sharing-responsibilities.svg"
                className="companybenefitscardimg companybenefitscardimgmargin1"
              />
            </div>
          </div>
      ...
      <div className="col-md-6">
        <div className="companybenefitscard">
          <div className="row ">
            ...
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/skills-expertise.svg"
        ...
        <div className="companybenefitscard">
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                By adding a partner, the burden of risk and liability is shared
                among multiple individuals. This can provide a sense of security
                and reduce the individual exposure to potential financial and
                legal risks. Partners can also contribute to risk management
                strategies and share the costs associated with mitigating risks.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/shared-risk.svg"
                className="companybenefitscardimg companybenefitscardimgmargin2"
              />
            </div>
          </div>
          ...
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                ...
                clients, and business relationships. Adding a partner can expand
                the business's reach and access to new opportunities, markets,
                and resources. Partners can leverage their networks to attract
                new customers, forge partnerships, and enhance the overall
                business network.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/expanded-network.svg"
                className="companybenefitscardimg companybenefitscardimgmargin2"
              />
            </div>
          </div>
        ...
        <div className="companybenefitscard">
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                Bringing in a new partner introduces fresh ideas, perspectives,
                and insights into the business. This can foster creativity,
                innovation, and adaptability, enabling the business to stay
                competitive and responsive to changing market dynamics.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/new-ideas.svg"
      ...
      <div className="col-md-6">
        <div className="companybenefitscard">
          <div className="row ">
            ...
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
              <img
                src="images/companyregimage/long-term-stability.svg"
        ...
        <div className="companybenefitscard">
          <div className="row ">
            <div className="col-md-8 col-sm-8 col-xs-8 col-12">
              ...
              <p className="companybenefitscardtext ">
                A partnership with multiple partners can enhance the credibility
                and reputation of the business. The combined expertise,
                experience, and resources of partners can instil confidence in
                stakeholders, including customers, suppliers, investors, and
                lenders.
              </p>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4 col-12">
          ...
          <div className="col-md-6 servicefaqcol1">
            ...
            >
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    conditions among the partners. It helps prevent disputes and
                    provides a clear understanding of the partnership's
              ...
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    partners contribute capital without involvement in the daily
                    activities.
                  </div>
                </div>
              </div>
              ...
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Registration of partnerships is optional in India. However,
                    it is advisable to register the partnership with the
                    Registrar of Firms to enjoy legal benefits, such as the
                    ability to file a lawsuit in court, establish proof of
          ...
          <div className="col-md-6 servicefaqcol2">
            <div className="panel-group" id="accordion2">
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    The removal or replacement process is generally outlined in
                    the partnership agreement and requires the consent of the
                    existing partners.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    A partner can join an existing partnership firm at any time,
                    not only at the time of its formation. The addition of a
                    partner to an existing partnership requires the consent of
                    all existing partners and the necessary amendments to the
              ...
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The profit-sharing ratio among partners is generally decided
                    through mutual agreement. It may be based on the capital
                    contribution, the involvement in the business, or other
                    factors as specified in the partnership deed or agreement.
                    Similarly, losses are shared in proportion to the
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse23"
                    >
                      Q8. Can a partner have a different role or responsibility
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    and areas of expertise based on their skills and interests.
                    The division of responsibilities is often outlined in the
                    partnership agreement, allowing partners to specialise in
                    specific aspects of the business's operations.
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="col-md-6">
          <div className="row">
            <div className="col-md-4">
              ...
              <a
                href="cdn-cgi/l/email-protection.html#197a76776d787a6d59757c7e78752b2c28377a7674"
                style={{ textDecoration: "underline", color: "#fff" }}
                className="footertext"
              >
                <span
                  className="__cf_email__"
                  data-cfemail="c5a6aaabb1a4a6b185a9a0a2a4a9f7f0f4eba6aaa8"
                >
                  [email&nbsp;protected]
                </span>
              </a>
