...
import AddPartnerImg from "../../assests/images/AddPartner/AddPartner.png";
...
const faqs = [
  {
    ...
    answer:
      "While it is not legally required to have a written agreement, it is highly recommended to have a partnership deed or agreement in place. This document outlines the rights, duties, profit-sharing ratios, and other terms and conditions among the partners.",
  },
  {
    id: 2,
    question:
      "Q2. Can a partner be removed or replaced later?",
    answer:
  ...
  {
    id: 3,
    question: "Q3. Can I add a partner without their financial contribution?",
    answer:
  ...
  {
    id: 4,
    question: "Q4. Can I add multiple partners at the same time?",
    answer:
  ...
  },
  {
    id: 5,
    question:
      "Q5. Do I need to register the partnership with the Registrar of Firms?",
    answer:
  ...
  },
  {
    id: 6,
    question:
      "Q6. Can a partner join an existing partnership firm or only at the time of formation?",
    answer:
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            Incorporating a new partner into a Limited Liability Partnership
            (LLP) requires meticulous steps. Begin with partner consent,
            followed by a formal resolution from the existing partners. Amend
            the LLP Agreement, if necessary, and draft a Supplemental Agreement
            outlining the new partner's rights and responsibilities. File the
            required forms, such as Form 4, with the Registrar of Companies,
            ensuring compliance with LLP regulations.
          </p>
          <div className="mt-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mx-10 md:mx-20 lg:mx-28 mt-5 md:mt-10">
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Adding partners contributes to increased capital and financial
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          <div className="flex justify-center">
            <img src={Cost} alt="" className="w-2/4 h-auto" />
          </div>
          ...
          <p className="text-gray-600 mt-3 text-center">
            More partners mean shared responsibilities and a distributed
            workload in businesses.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Additional partners bring diversification of skills and expertise to
            the organization.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            More partners mean shared risk and liability in business operations.{" "}
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Additional partners lead to an expanded network and valuable
            contacts.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            More partners bring access to new ideas and diverse perspectives.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            More partners contribute to long-term stability and effective
            succession planning.
          </p>
        </div>
        ...
        <div className="p-5 border border-[#B70505] rounded-lg cursor-pointer hover:bg-[#FBB03B] hover:bg-opacity-16">
          ...
          <p className="text-gray-600 mt-3 text-center">
            Increased credibility and positive outcomes enhance overall
      ...
      <div className="hidden lg:block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              We’ll get it registered with the Registrar of Firms, which will
              officially establish the addition of the Partner.
            </p>
          </div>
        </div>
      </div>
