...
<div className="wrapper">
  <iframe
    ...
    data-load-time={1700123176589}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/367855087?random=1700123176575&cv=11&fst=1700123176575&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Fpf-registration&ref=https%3A%2F%2Flegal251.com%2Fmsme-udhyam-registration&label=3o2zCK68lbIDEO-LtK8B&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-PF%20Registration&value=0&bttype=purchase&rdp=1&auid=1629897716.1699421317&fledge=1&capi=1"
    zum1daz4y=""
  />
  <iframe
    allow="join-ad-interest-group"
    data-tagging-id="AW-11126145977/Remarketing Tag"
    data-load-time={1700123176605}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/11126145977?random=1700123176601&cv=11&fst=1700123176601&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Fpf-registration&ref=https%3A%2F%2Flegal251.com%2Fmsme-udhyam-registration&label=Remarketing%20Tag&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-PF%20Registration&auid=1629897716.1699421317&fledge=1"
    zum1daz4y=""
  />
  <div style={{ position: "relative", overflowX: "hidden" }}>
    ...
    <a
      href="https://legal251.com/pf-registration-hindi"
      ...
      <div className="servicemaindiv" style={{ marginTop: 7 }}>
        <div className="row">
          <div className="col-md-6">
            <p className="serviceamainheading">PF Registration</p>
            <p
              style={{
                fontFamily: '"Roboto"',
                marginTop: 18,
            ...
            >
              Get your hard-earned money to be yours with on-time PF
              Registration (PFR) and be financially assured at the time of
              retirement or any emergency.
            </p>
            <br />
            <a href="#formpricediv">
                    ...
                    <center>
                      ...
                      >
                        <option
                          className="cities"
                          data-value=""
                          data-select2-id="select2-data-2-psnt"
                        />
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-1-sbev"
        ...
        <p className="aboutustext">
          Be a responsible employer and register your company under Employees
          Provident Fund Organization (EPFO). Even if you are an employee who
          comes under the PF Registration slab, you must ask your employer to
          open your EPF account to give you financial security in a time of
          need.
          <br />
          PF Registration (PFR) is mandatory for every employer whose employee
          strength is 20 or more. Provident Fund (PF) is implemented by the
          Employees Provident Fund Organization (EPFO) of India and is one of
          the core savings platforms in India for almost all people working in
          Government, Private or Public sector organizations. The company must
          complete its PF registration within One month from the date of hiring
          the 20th employee.
          <br />
          PF is the best way to provide financial and social security &amp;
          stability to the employees, such as providing medical assistance,
          retirement, education of children, insurance support and housing
          facilities for the employees of an organization.
          <br />
          It is vital to register EPF online to make the process aligned. Get
          help from the best legal team of Legal251 for your EPF Registration to
          avoid any hustle and bustle.
        </p>
        <br />
        <br />
        <p />
    ...
    <div id="Howtoapply" className="page-section">
      ...
      <center>
        <img
          src="https://legal251.com/images/nda/PF Registration.png"
          ...
          <div className="col-md-2 col-xs-4  firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                ...
                />
                <p className="benefitscardtext"> Tax Exemptions</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Withdrawal Benefits </p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Universal Access</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Post-Death Benefits </p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Pension Benefits</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Insurance Benefits</p>
              </center>
            </div>
          </div>
        </div>
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Capital Appreciation</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Risk Coverage</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Long-Term Goals</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> EDLI Scheme</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Easy Transferability </p>
              </center>
            </div>
          </div>
        </div>
              ...
              <div className="col-md-2 Registrationprocesscol1">
                <center>
                  <p className="Registrationprocesstext1 gstrtext1">
                    Our team will review the documents you have submitted,
              ...
              <div className="col-md-2 Registrationprocesscol2">
                <center>
                  <p className="Registrationprocesstext2 gstrtext2">
                    Our best PF experts are here to help you with document
              ...
              <div className="col-md-2 Registrationprocesscol3">
                <center>
                  <p className="Registrationprocesstext3 gstrtext3">
                    ...
                    documents to apply for your PF Registration.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscol4">
                <center>
                  <p className="Registrationprocesstext4 gstrtext4">
                    After acceptance of the application, you will be registered
                    through UAN. We will share the UAN no. with you &amp; will
                    also track the status of your PF account.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscol5">
                <center>
                  <p className="Registrationprocesstext5 gstrtext5">
                    ...
                    notify you of the activation of your PF Account.
                  </p>
                </center>
              </div>
            </div>
            ...
            <div className="col-md-6 servicefaqcol1">
              ...
              >
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse1"
                      >
                        Q1.What is the PR Contribution rate for employers and
                        employees?
                        <img
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Both employer and employee contribute 12% each to the
                      Provident Fund.
                    </div>
                  </div>
                </div>
                  ...
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse2"
                      >
                        Q2. How can I login into my PF account?
                        <img
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse3"
                      >
                        Q3. How many members/employees are required to obtain
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      A minimum of 20 members/employees are needed to obtain EPF
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse4"
                      >
                        Q4. Do I need to create another PF account if I change
                        my job?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      No, you can apply to transfer your account online by
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse5"
                      >
                        Q5.Can I pay more than a 12% share towards EPF?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Yes, but the total contribution should not exceed 15,000
                      per month.
                    </div>
                  </div>
                </div>
            ...
            <div className="col-md-6 servicefaqcol2">
              <div className="panel-group" id="accordion2">
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse21"
                      >
                        Q6. Is there an upper limit on contribution to PF?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20192.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Both employee and employer contribute around 12% of the
                      basic salary, which is the upper limit. However, you can
                      add more to the PF account by contributing to VPF.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse22"
                      >
                        Q7. What is the basic salary for EPF?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      One needs a basic pay of less than Rs. 15,000 per month to
                      be applicable for EPF.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse23"
                      >
                        Q8. Who are all qualified for the EPF scheme?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      All companies employing 20 or more employees are eligible
                      or apply for the EPF scheme.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      UAN or Universal Account Number is a 12-digit unique
                      number allotted to every member by the department of EPFO.
                      This specific number is permanent and valid for the
                      member's entire life, and it does not change with the
                      change of employment. The UAN number helps in the
                      automatic transfer of Funds and PF withdrawals.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse25"
                      >
                        Q10.The EDLI benefits are payable to whom?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      The EDLI benefits are payable to the eligible individuals
                      to receive EPF dues.
                    </div>
                  </div>
                </div>
