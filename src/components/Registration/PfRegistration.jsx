...
const faqs = [
  {
    id: 1,
    question:
      " Q1.What is the PR Contribution rate for employers and employees?",
    answer:
      "Both employer and employee contribute 12% each to the Provident Fund.",
  },
  {
    id: 2,
    question: "Q2. How can I login into my PF account?",
    answer: "You can log into your PF account using your UAN number.",
  },
  {
    id: 3,
    question:
      "Q3. How many members/employees are required to obtain EPF Registration in India?",
    answer:
      "A minimum of 20 members/employees are needed to obtain EPF Registration in India.",
  },
  {
    id: 4,
    question: "Q4. Do I need to create another PF account if I change my job?",
    answer:
      "No, you can apply to transfer your account online by submitting Form 13(R).",
  },
  {
    id: 5,
    question: "Q5.Can I pay more than a 12% share towards EPF?",
    answer:
      "Yes, but the total contribution should not exceed 15,000 per month.",
  },
  {
    id: 6,
    question: "Q6. Is there an upper limit on contribution to PF?",
    answer:
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        <div className="">
          ...
          <p className="text-md xl:text-lg font-medium mt-5 text-justify">
            Ensure your financial security with timely PF (Provident Fund)
            Registration through expert guidance. Secure your hard-earned
            savings for retirement or emergencies. Register with accuracy to
            claim what's rightfully yours and enjoy peace of mind for a secure
            future.Secure your future by timely PF (Provident Fund) Registration.
            Expert assistance ensures rightful savings, offering financial
            assurance during retirement or emergencies.
          </p>
          <div className="mt-5">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          <div className="">
            ...
            <Check formType={"PF Registration"}/>
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-10 mx-5 md:mx-20 lg:mx-28 mt-10 md:mt-14">
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Tax Exemptions</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Withdrawal Benefits</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Universal Access</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Post-Death Benefits</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Pension Benefits</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Insurance Benefits</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Capital Appreciation</h1>
        </div>
        ...
        <div className="bg-white shadow-lg p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Risk Coverage</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Long-Term Goals</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">EDLI Scheme</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Easy Transferability</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28 mt-5 md:mt-14">
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              Our team will review the documents you have submitted, reviewing
              any false or mistaken information to keep you secure.
            </p>
          </div>
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium ">
              ...
              to apply for your PF Registration.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              ...
              through UAN. We will share the UAN no. with you & will also track
              the status of your PF account.
            </p>
          </div>
          <div class="flex  justify-center items-center col-span-3">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              ...
              you of the activation of your PF Account.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 mx-5 md:mx-20 lg:mx-28 mt-5 md:mt-14">
          ...
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                After acceptance of the application, you will be registered
                through UAN. We will share the UAN no. with you & will also
                track the status of your PF account.
              </p>
            </div>
          </div>
