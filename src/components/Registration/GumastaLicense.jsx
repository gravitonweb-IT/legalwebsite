...
<div className="wrapper">
  <iframe
    ...
    data-load-time={1700122943038}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/367855087?random=1700122943026&cv=11&fst=1700122943026&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Fgumasta-licence&ref=https%3A%2F%2Flegal251.com%2Fgst-registration&label=3o2zCK68lbIDEO-LtK8B&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20Gumasta%20Licence%20(S%26E)&value=0&bttype=purchase&rdp=1&auid=1629897716.1699421317&fledge=1&capi=1&uaa=x86&uab=64&uafvl=Google%2520Chrome%3B119.0.6045.125%7CChromium%3B119.0.6045.125%7CNot%253FA_Brand%3B24.0.0.0&uamb=0&uap=Windows&uapv=15.0.0&uaw=0"
    r6d109bol=""
  />
  <iframe
    allow="join-ad-interest-group"
    data-tagging-id="AW-11126145977/Remarketing Tag"
    data-load-time={1700122943053}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/11126145977?random=1700122943050&cv=11&fst=1700122943050&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Fgumasta-licence&ref=https%3A%2F%2Flegal251.com%2Fgst-registration&label=Remarketing%20Tag&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20Gumasta%20Licence%20(S%26E)&auid=1629897716.1699421317&fledge=1&uaa=x86&uab=64&uafvl=Google%2520Chrome%3B119.0.6045.125%7CChromium%3B119.0.6045.125%7CNot%253FA_Brand%3B24.0.0.0&uamb=0&uap=Windows&uapv=15.0.0&uaw=0"
    r6d109bol=""
  />
  <div style={{ position: "relative", overflowX: "hidden" }}>
    ...
    <div className="sidephoneform">
      <img
        src="https://legal251.com/images/Capture.png"
      ...
      <div className="sideformdiv">
        <p className="sideformheading">
          Get Legal Consultancy <br />
          &amp;
          <br />
          Solution for@251
        </p>
        <center>
          ...
          />
          <br />
          <select className="getconsultancysideinputselect" required="">
            <option selected="" style={{ color: "#000000" }}>
              Related to
            </option>
            <option style={{ color: "#000000" }}>Lawyer</option>
            <option style={{ color: "#000000" }}>C.A.</option>
            <option style={{ color: "#000000" }}>C.S.</option>
            <option style={{ color: "#000000" }}>Not sure</option>
          </select>
          <button className="legalsidesubmitBtn">
            SUBMIT{" "}
            <img
              src="https://legal251.com/images/submithammer.svg"
    ...
    <a
      href="https://legal251.com/gumasta-licence-hindi"
      ...
      <div className="servicemaindiv" style={{ marginTop: 7 }}>
        <div className="row">
          <div className="col-md-6">
            <p className="serviceamainheading">Gumasta Licence</p>
            <p
              style={{
                fontFamily: '"Roboto"',
                marginTop: 18,
            ...
            >
              If you are starting a new business, then Gumasta License is
              mandatory under the Shops and Establishment Act. At Legal251, we
              help you register for the Gumasta easily from the comfort of your
              home.
            </p>
            <br />
            <a href="#formpricediv">
                ...
                <div className="row">
                    ...
                    <center>
                      ...
                      >
                        <option
                          className="cities"
                          data-value=""
                          data-select2-id="select2-data-2-2eee"
                        />
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-1-4v46"
                      ...
                      <br />
                      <br />
                      <select className="serviceinputselect" id="no_of_worker">
                        <option
                          value=""
                          id="selectOpt"
                          disabled="disabled"
                        ...
                        <option value={1} style={{ color: "#01355D" }}>
                          0 to 3 workers Employed
                        </option>
                        <option value={2} style={{ color: "#01355D" }}>
                          More than 3 workers Employed
                        </option>
                      </select>
                      <div
                        style={{
                  ...
                  <div className="col-md-6">
                    <center>
                      ...
                      >
                        <sup style={{ lineHeight: "1.5" }}>₹</sup>751
                      </p>
                      <p
                        style={{
                          fontFamily: '"Roboto"',
        ...
        <p className="aboutustext">
          Gumasta license is a state-level registration required to do any
          business in Madhya Pradesh. To start any kind of business in Madhya
          Pradesh, entrepreneurs need Gumasta License. The State Government
          governs this license under the Madhya Pradesh Shops and Establishment
          Act. Gumasta License allows entrepreneurs to start their businesses in
          a specific place, area, or location in Madhya Pradesh. Obtaining
          Gumasta ensures that your business can grow without complications, and
          it is necessary to open a business account or get a bank loan.
          <br />
          <br />
          Without this license, getting GST registration is also not possible.
          Before starting a business, every shop and commercial establishment in
          a state must be registered with the state government under the Shop
          &amp; Establishment Act. Since the day it was enacted, the Shop &amp;
          Establishment Act has been significant and relevant to provide
          employees and employers with legal obligations and rights. The Shop
          and Establishment Act consolidates and modifies the law governing the
          regulation of work and employment in shops, commercial establishments,
          restaurants, eating establishments, theatres, residential hotels,
    ...
    <div id="Howtoapply" className="page-section">
      ...
      <center>
        <img
          src="https://legal251.com/images/gstregistration/gumasta.png"
          ...
          <div className="col-md-2 col-xs-4  firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                ...
                />
                <p className="benefitscardtext">Tax subsidies</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Proof for bank account</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Authority to work</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Builds trust</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Competitive advantage</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Government Aid</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Employee Trust </p>
              </center>
            </div>
          </div>
        </div>
                ...
                <div style={{ padding: "0 5px 5px 5px" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      Premises Photo with Banner or Board of Trade Name to be
                      licensed
                    </p>
                    <p
                      style={{
                ...
                <div style={{ padding: "0 5px 5px 5px" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      Aadhar Card /Voter ID / Passport /Pan Card / Driving
                      License of Karta
                    </p>
                    <p
                      style={{
                ...
                <div style={{ padding: "0 5px 5px 5px" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      Aadhar Card /Voter ID / Passport /Pan Card / Driving
                      License of President or Secretary
                    </p>
                    <p
                      style={{
                        fontFamily: '"Open Sans", sans-serif',
      ...
      <div id="Registrationprocess" className="page-section">
        ...
        <div style={{ padding: "0px 10.61vw" }}>
          <div>
            ...
            >
              <div className="col-md-2 Registrationprocesscolgl1">
                <center>
              ...
              <div className="col-md-2 Registrationprocesscolgl2">
                <center>
                  <p className="Registrationprocesstext2">
                    Our best professionals are here to help you with document
                    and licensing requirements as required by the state
                    department.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscolgl3">
                <center>
                  <p className="Registrationprocesstext3">
                    After Filing out the application form, a challan number will
                    be generated, and a UTN number can be obtained after paying
                    the required fees.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscolgl4">
                <center>
                  <p className="Registrationprocesstext4">
                    Once the concerned officer verifies all the documents, Shop
                    License will be provided to the applicant within 7-10
                    working days or with some more delay.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscolgl5">
                <center>
            ...
            <div className="col-md-6 servicefaqcol1">
              ...
              >
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse1"
                      >
                        Q1: How long is the Shop Act Registration valid?
                        <img
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      The Shop Act Registration is valid for a lifetime.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse2"
                      >
                        Q2: What are the components of a Gumasta License?
                        <img
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse3"
                      >
                        Q3: Who needs to obtain a Gumasta License?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      ...
                      professionals, private limited companies, sole
                      proprietors, partnerships, and LLPs must obtain a Gumasta
                      License. They intend to open physical stores, hotels, or
                      commercial establishments in Madhya Pradesh. According to
                      the Madhya Pradesh Shops and Establishment Act, all
                      employers with ten or more employees must obtain a gumasta
                      license. Upon submission of the license, the concerned
                      officer will register the establishment in the register of
                      establishments and issue an enrolment certificate and the
                      Labour Identification Number (LIN). This license or
                      certificate is the primary or mandatory requirement to get
                      recognized by all the banks and NBFCs working for people
                      in MP.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse4"
                      >
                        Q4. Do I require a Gumasta if I want to sell online on
                        Amazon?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Yes, gumasta is required for carrying on any business
                      activity, including any trading activity.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse5"
                      >
                        Q5. If I have two shops or two offices, do I require
                        shop act for each location separately?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Yes, every business location requires its gumasta license.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6 servicefaqcol2">
              <div className="panel-group" id="accordion2">
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse21"
                      >
                        Q6. What is meant by the establishment for shop act
                        registration?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20192.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      "Establishment" means a shop, commercial space,
                      residential hotel, restaurant, theatre, or another place
                      of the public to which this Act applies, as well as any
                      other establishment that the [State] Government may
                      declare to be an establishment for this Act by
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse22"
                      >
                        Q7. How do I have to send my documents?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Legal251 accepts documents via our user panel. Don't
                      worry; we have a strict confidentiality policy and will
                      delete the records from our system once the work is
                      completed. You can easily upload documents in.pdf,.doc,
                      or.jpeg format there.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse23"
                      >
                        Q8. What is the objective of the shops &amp;
                        establishments Act?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Every Indian state has enacted specific rules and
                      regulations regarding working conditions. The goal is to
                      ensure that employees working in various establishments,
                      such as shops, commercial establishments, and residential
                      hotels, receive uniform benefits and restaurants,
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse24"
                      >
                        Q9: Who needs to register for the shop act license?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      According to the law, any business selling goods or
                      services to customers out of a commercial office becomes
                      liable to register.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse25"
                      >
                        Q10. Is a license required for a small shop without any
                        employees under the Worker's Compensation Act?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Shop Act Registration, also known as Gumasta Registration,
                      is required for any commercial establishment, small or
                      large, self-employed or professional hires.
                    </div>
                  </div>
                </div>
              </div>
