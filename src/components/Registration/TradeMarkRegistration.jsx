...
const faqs = [
  ...
  },
  {
    id: 6,
    question:
      "Q6.Can a registered trademark be removed from the register?",
    answer:
  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
      <div className="">
        ...
        Secure your brand identity by registering your logo, slogan, or company name with a ™ sign through Trademark Registration. Safeguard your intellectual property, establish brand recognition, and prevent unauthorized use. Protect your business assets and gain exclusive rights to your brand elements.
        </p>
        <p className="text-lg font-medium mt-5 text-justify">
        
Protect your brand's identity by registering your logo, slogan, or company name with a ™ sign through Trademark Registration. Safeguard your intellectual property rights effectively.
        </p>
        <div className="mt-5">
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-10 mx-5 md:mx-20 lg:mx-28 mt-10 md:mt-14">
      ...
      <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
        ...
        <h1 className="mt-3 text-center">Global Filing
of Trademark</h1>
      </div>
      ...
      <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
        ...
        <h1 className="mt-3 text-center">Creation of
intangible asset</h1>
      </div>
    ...
    <div className="hidden lg:block">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28 mt-5 md:mt-14">
        <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
          ...
          Our team will look into the documents that you have submitted and carefully review them in order to avoid mistakes.
          </p>
        </div>
        ...
        <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
          <p className="text-center text-xs font-medium">
          Our best trademark search experts are here to check the uniqueness of the logo or wordmark which is submitted by you.
          </p>
        </div>
        ...
        <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
          <p className="text-center text-xs font-medium ">
          Experts will decide on a relevant class for your ™ according to the information given by you & proceed further for your trademark registration.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
        ...
        <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
          <p className="text-center text-xs font-medium">
          After eliminating all of the document necessities & needed information, we’ve applied for a trademark on your behalf. This whole application process generally takes 4-5 working days.
          </p>
        </div>
        <div class="flex  justify-center items-center col-span-3">
        ...
        <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
          <p className="text-center text-xs font-medium">
          We will share Application number with you through which you can track your trademark status.
          </p>
        </div>
      </div>
    </div>
