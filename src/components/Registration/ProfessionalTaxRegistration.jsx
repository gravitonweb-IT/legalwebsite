...
const faqs = [
  {
    id: 1,
    question:
      "Q1. What is the difference between Income Tax and Professional Tax?",
    answer:
      "The Central Government directly collects income tax from all the taxpayers on a specific part of their income. However, Professional Tax is an indirect tax collected by the state government based on a tax slab for people engaged in employment, business, or occupation.",
  },
  {
    id: 2,
    question: "Q2. Is Professional Tax registration mandatory for everyone?",
    answer:
      "Employers in certain states are needed to deduct and deposit taxes from employees with pay exceeding the minimum slab limit. However, that entity needs to get a registration and an enrollment certificate to do so.",
  },
  {
    id: 3,
    question: "Q3.How do I know my professional tax is paid?",
    answer:
      "Download the payment acknowledgement receipt after making the payment. In the receipt, you can check that the payment has been made.",
  },
  {
    id: 4,
    question: "Q4. Is it mandatory to pay professional tax?",
    answer:
      "Paying Professional Tax is mandatory for every individual, firm, or company. Else there are penalties in case of non-compliance.",
  },
  {
    id: 5,
    question:
      "Q5.What is the maximum amount of Professional Tax imposed by a state government?",
    answer:
      "The maximum amount of Professional Tax levied by the state is Rs. 2500.",
  },
  {
    id: 6,
    question: "Q6. Does Professional Tax differ from state to state?",
    answer:
      "Yes, Professional Tax levied by the state government differs from state to state. Every state decides its tax slabs and the professional tax deduction according to those slabs determined by the authority.",
  },
];
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 mx-5 md:mx-20 lg:mx-28 mt-24 md:mt-28">
        ...
        <div className="grid grid:cols-1 sm:grid-cols-2 gap-5 border-4 mt-8 border-[#01355D] rounded-2xl p-5">
          <div className="">
            ...
            <Check formType={"Professional Tax Registration "}/>
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-10 mx-5 md:mx-20 lg:mx-28 mt-10 md:mt-14">
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Avoid Paying Penalties</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Judicial Requirement</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Claim Deductions</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">State Government Tax</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Easy to Follow</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Impose Minimal Restrictions</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Avoid Property Seizure</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Avoid Overall Balance</h1>
        </div>
      </div>
      ...
      <div className="hidden lg:block">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28 mt-5 md:mt-14">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium ">
              ...
              to apply for your Professional Tax Registration.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              Your Professional Tax registration is complete after accepting the
              application. We request you to wait until our expert reaches out
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              ...
              you of the completion of your Professional Tax Registration.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="block lg:hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 mx-5 md:mx-20 lg:mx-28 mt-5 md:mt-14">
          ...
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                Your Professional Tax registration is complete after accepting
                the application. We request you to wait until our expert reaches
                out to notify you of the same.
              </p>
            </div>
          </div>
