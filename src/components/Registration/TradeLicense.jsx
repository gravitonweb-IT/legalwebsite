...
const TradeLicense = () => {
  ...
  <div style={{ position: "relative", overflowX: "hidden" }}>
    ...
    <a
      href="https://legal251.com/trade-licence-hindi"
      ...
      <div className="servicemaindiv" style={{ marginTop: 7 }}>
        <div className="row">
          <div className="col-md-6">
            <p className="serviceamainheading">Trade Licence</p>
            <p
              style={{
                fontFamily: '"Roboto"',
                marginTop: 18,
            ...
            >
              Are you commencing a new business and wondering what kind of
              paperwork you'll need? Let's begin with the Trade Licence. Our
              expert team at Legal251 will help you proceed with your
              application and let you do your work smoothly.
            </p>
            <br />
            <a href="#formpricediv">
                ...
                <div className="row">
                    ...
                    <center>
                      ...
                      >
                        <option
                          className="cities"
                          data-value=""
                          data-select2-id="select2-data-2-u6z3"
                        />
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-1-v5l1"
                  ...
                  <div className="col-md-6">
                    <center>
                      ...
                      >
                        *Government Fees Extra as per applicable.
                      </p>
                      <br />
                      <img
        ...
        <p className="aboutustext">
          A trade licence is a document that allows an individual or a firm to
          conduct business or trade. When starting a business or trade in a
          specific municipality, it is a compulsory document to have. To oversee
          diverse commercial operations in the country, the government has made
          trade permits mandatory for people to start a firm. The procedure for
          obtaining a trade licence varies by state. This licence promotes
          societal harmony by ensuring that all businesses follow necessary
          regulations, norms, and safety precautions.
          <br />
          <br />
          The company or trade must conduct following the Municipal
          Corporation's safety regulations. It protects the people within from
          any potential health concerns. However, the licence does not permit
          the holder to engage in any other trade or company. Furthermore, the
          holder of this licence does not become the owner of any property. It
          ensures that any trade nuisance adversely harms no one. Legal 251 can
          assist you in obtaining a trade licence in your name.
        </p>
        <br />
        <br />
      </div>
    ...
    <div id="Howtoapply" className="page-section">
      ...
      <center>
        <img
          src="https://legal251.com/images/gstregistration/trade.png"
          ...
          <div className="col-md-2 col-xs-4  firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                ...
                />
                <p className="benefitscardtext">Easy Financial Aids</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Increased Goodwill </p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Motivates Investors</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Lesser Legal Confrontations</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Intact Safety Measures</p>
              </center>
            </div>
          </div>
        </div>
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Fairtrade practices </p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Protect Consumer's Interest </p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Aids Business Growth</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Escalate Credibility</p>
              </center>
            </div>
          </div>
        </div>
      ...
      <div id="Registrationprocess" className="page-section">
        ...
        <div style={{ padding: "0px 10.61vw" }}>
          <div>
            ...
            >
              <div className="col-md-2 Registrationprocesscoltl1">
                <center>
                  <p className="Registrationprocesstext1">
                    Our team will analyze the documents you've submitted to
                    avoid any discrepancy, looking for any misleading or
                    incorrect information.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscoltl2">
                <center>
                  <p className="Registrationprocesstext2">
                    Our best professionals are here to help you with document
                    and licensing requirements as required by the state or
                    central department.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscoltl3">
                <center>
              ...
              <div className="col-md-2 Registrationprocesscoltl4">
                <center>
                  <p className="Registrationprocesstext4">
                    If the application is approved, your business or trade will
                    be registered with the municipality or municipal
                    corporation.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscoltl5">
                <center>
                  <p className="Registrationprocesstext5">
                    It's recommended to wait until one of our experts contacts
                    you to let you know your licence has been issued.
                  </p>
                </center>
              </div>
            </div>
            ...
            <div className="col-md-6 servicefaqcol1">
              ...
              >
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse1"
                      >
                        Q1. How To Register For A Trade Licence Online?
                        <img
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      It is essential for every business that carries out a
                      trade to have a Trade Licence. You can use the Legal251
                      app or web to get this registration done at the local
                      municipality quickly.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse2"
                      >
                        Q2. What are the aspects of issuing a Trade Licence?
                        <img
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      1.When a person or a company starts a new business, they
                      must register it with the local government.
                      <br />
                      2.A trade licence is a permit that allows you to open a
                      business. Municipal statutes regulate the issuing of trade
                      permits by the state government.
                      <br />
                      3.To obtain the licence, the company must follow the norms
                      and regulations of the state's corporation and safety
                      authorities.
                      <br />
                      4.A trade licence does not entitle the holder to any
                      property owner.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse3"
                      >
                        Q3. How long does it take to get a trade licence?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      From the time you apply, Legal 251 will assist you in
                      obtaining your trade licence in 5-10 working days.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse4"
                      >
                        Q4. Is it required to renew a business licence?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Yes, the government has made renewing this licence a
                      necessity every year. Failure to submit the renewal may
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse5"
                      >
                        Q5. Do I require a Trade Licence to operate a
                        restaurant?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Yes, regardless of what area of the business you're in,
                      you'll need a Trade Licence. This licence is required for
                      every business that trades goods or services for money,
                      and a Food Establishment licence is necessary for a
                      restaurant.
                    </div>
                  </div>
                </div>
            ...
            <div className="col-md-6 servicefaqcol2">
              <div className="panel-group" id="accordion2">
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse21"
                      >
                        Q6. When may I apply for a trade licence?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20192.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      It is possible to apply for it 30 days before starting
                      your business.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse22"
                      >
                        Q7. What happens if my Trade License application gets
                        rejected?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      If you are denied a Trade License for whatever reason, you
                      can file a petition with the Standing Committee. Also, you
                      have to submit a copy of your rejected application.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse23"
                      >
                        Q8. What are the various types of trade licences?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      1. Small, medium, and large-scale manufacturing factories
                      require an industry licence.
                      <br />
                      2. Shop licence: Dangerous and offensive trades such as
                      firewood sales, cracker and candle manufacturing, barber
                      and dhobi shops, and so on.
                      <br />
                      3. Restaurants, hotels, food stalls, canteens, meat and
                      vegetable sales, bakeries, and other food establishments
                      require a food establishment licence.
                      <br />
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse24"
                      >
                        Q9. What are the eligibility criteria for a Trade
                        License?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      ...
                      <br />
                      3. The operation of a business must be legal.
                      <br />
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse25"
                      >
                        Q10. When will I be able to renew my trade licence?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      In India, trade licences are renewed from January 1 to
                      March 31. The renewal application must be submitted within
                      thirty days of the license's expiration date. The
                      following are the documents that must be supplied to renew
                      your licence: A copy of the trade licence; challans from
                      the previous year; and a receipt for current property
                      taxes paid.
                    </div>
                  </div>
                </div>
