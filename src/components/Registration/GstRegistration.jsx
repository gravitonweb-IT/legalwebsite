...
const GstRegistration = () => {
  ...
  >
    हिंदी{" "}
    <img src="https://legal251.com/images/langicon.svg" className="langicon" />
  </a>
                  ...
                  <div className="col-menu col-md-5">
                    ...
                    <div className="content">
                      <ul className="menu-col" id="id01">
                        ...
                        <li className="incontent">
                          <a className="text" href="/annual-compliance-company">
                            {" "}
                            <img
                              className="megamenu_icon"
                      ...
                      <ul className="menu-col" id="id01">
                        ...
                        <li className="incontent">
                          <div style={{ display: "flex" }}>
                            ...
                            <div>
                              <a className="text" href="/increase-capital-llp">
                                {" "}
                                <span className="hvr-sweep-to-right textres">
    ...
    <div className="servicemaindiv" style={{ marginTop: 7 }}>
      <div className="row">
        <div className="col-md-6">
          <p className="serviceamainheading">GST Registration </p>
          <p
            style={{
              fontFamily: '"Roboto"',
              marginTop: 18,
          ...
          >
            ...
            online in minutes. Our experts are ready to guide you for an easy
            GST Registration.
          </p>
          <br />
          <a href="#formpricediv">
                  ...
                  <center>
                    ...
                    >
                      <option
                        className="cities"
                        data-value=""
                        data-select2-id="select2-data-2-a774"
                      />
                    ...
                    <span
                      ...
                      dir="ltr"
                      data-select2-id="select2-data-1-s1tl"
      ...
      <p className="aboutustext">
        GST Registrations are one of topmost priority for businesses and sailing
        through this process efficiently is the ultimate aim. Enlist your
        business for GST effortlessly with experts at Legal251 and start
        focusing on the growth and productivity part. In the GST Regime,
        organizations whose turnover surpasses Rs.40 lakhs* (Rs.10 lakhs for NE
        and slope states) is required to enroll as an ordinary available
        individual. GST registration usually takes between 2-6 working days.
        <br />
        <br />
        Currently, the types of GST in India are CGST, SGST, and IGST. This
        simple division helps distinguish between inter- and intra-state
        supplies and mitigates indirect taxes. CGST stands for Central Goods and
        Services Tax. It is a category of GST that the Central Government
        collects. SGST stands for State Goods and Services Tax, and IGST stands
        for Integrated Goods and Services Tax. CGST, SGST, and IGST work
        according to the place of transactions. In the case of inter-state
        transactions, GST is collected as IGST, which indirectly charges tax for
        the State and Central governments clubbed together. SGST and CGST are
        collected in case of intrastate transactions and are both collected
        directly for the State and Central Governments, respectively. Thus,
  ...
  <div id="Howtoapply" className="page-section">
    ...
    <center>
      <img
        src="https://legal251.com/images/gstregistration/GSTR.png"
        ...
        <div className="col-md-2 col-xs-4  firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              ...
              />
              <p className="benefitscardtext">Elimination of Multiple Taxes</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Cascading Effect Reduction</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">More Employment</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 firstcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Increase in GDP</p>
            </center>
          </div>
        </div>
      </div>
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Reduction in Tax Evasion</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">More Competitive Product</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
          ...
          <div className="servicebenefitscard">
            <center>
              <img
                ...
                className="benefitscardimg"
              />
              <p className="benefitscardtext">Lesser Compliances</p>
            </center>
          </div>
        </div>
        <div className="col-md-2 col-xs-4 secondcarddivcol">
      ...
      <div className="Documentssection">
        <div className="row" style={{ margin: 0, padding: 0 }}>
              ...
              <div style={{ padding: "0 5px 5px 5px" }}>
                ...
                >
                  ...
                  >
                    ...
                    />
                    Copy of Deed / Agreement Firm PAN Card
                  </p>
                  <p
                    style={{
                      fontFamily: '"Open Sans", sans-serif',
          ...
          >
            ...
            <img
              className="noimg"
              src="https://legal251.com/images/gstregistration/Group 656.svg"
            />
          </div>
        </div>
        <p
            ...
            <div className="col-md-2 Registrationprocesscol3">
              <center>
                <p className="Registrationprocesstext3 gstrtext3">
                  The respective expert will proceed further with your documents
                  in order to apply for your GST Registration.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol4">
              <center>
                <p className="Registrationprocesstext4 gstrtext4">
                  After acceptance of the application, your business will be
                  registered through ARN. We will share ARN no. with you &amp;
                  will also track the status of your GST.
                </p>
              </center>
            </div>
            <div className="col-md-2 Registrationprocesscol5">
              <center>
                <p className="Registrationprocesstext5 gstrtext5">
                  ...
                  notify you of the generation of your unique GST Identification
                  Number.
                </p>
              </center>
            </div>
            ...
            >
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    ...
                    requirement for the identification of taxpayers ensuring tax
                    compliance in the economy. Registration of any business
                    entity under the GST Law implies obtaining a unique number
                    from the concerned tax authorities for the purpose of
                    collecting tax on behalf of the government and to avail
                    Input tax credit for the taxes on his inward supplies.
                    Without registration, a person can neither collect tax from
                    his customers nor claim any input tax credit of tax paid by
                    him.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse2"
                    >
                      Q2: How many days will it take to get a GST number?
                      <img
                ...
                >
                  <div className="panel-body servicefaqbody">
                    {" "}
                    GST registration usually takes between 2-6 working days and
                    can also depend upon the number of documents given by you.
              ...
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    There are four different types of GST as listed below: The
                    Central Goods and Services Tax (CGST) The State Goods and
                    Services Tax (SGST) The Union Territory Goods and Services
                    Tax (UTGST) The Integrated Goods and Services Tax (IGST)
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    Application Reference Number (ARN) is an acknowledgement
                    issued by the GSTN system portal to the taxpayers who have
                    successfully submitted their application after completing
                    the full process. It has come to notice that some of the
                    taxpayers have made ARN mandatory for buying things from
                    their vendors.
                  </div>
                </div>
              </div>
          ...
          <div className="col-md-6 servicefaqcol2">
            <div className="panel-group" id="accordion2">
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse21"
                    >
                      Q6: What is the minimum turnover limit for the GST
                      registration?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20192.svg"
                        className="servicefaqimg"
                ...
                >
                  <div className="panel-body servicefaqbody">
                    A business whose aggregate turnover in a financial year
                    exceeds Rs 20 lakhs has to mandatorily register under Goods
                    and Services Tax. This limit is set at Rs 10 lakhs for North
                    Eastern and hilly states flagged as special category states.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The requirement of bank account details has been removed at
                    the time of GST Registration. Now it is required after the
                    first login because normally a bank account cannot be opened
              ...
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse23"
                    >
                      Q8: Do I need a commercial address to apply for GST?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    No, there is no need for a commercial address to apply for
                    GST, As per GST rules, you must apply for registration from
                    your Principal Place of business. If your home address is
                    different from your principal place of business, then you
                    have the option of adding your home as an additional place
                    of business. However, if both i.e. your home address and
                    principal place of business are the same then you can apply
                    for GST registration at your home address.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                ...
                >
                  <div className="panel-body servicefaqbody">
                    The Dual GST structure in India is essentially a simple tax
                    with different taxation rates – the Central Goods and
                    Service Tax (or CGST) and the State Goods and Service Tax
                    (or SGST). Overall, a dual GST structure is designed to
                    align with the Constitutional requirements of fiscal
                    federalism.
                  </div>
                </div>
              </div>
              <div className="panel panel-default servicefaqmainpanel">
                <div className="panel-heading servicefaqpanelheading">
                  <h4 className="panel-title">
                    <a
                      ...
                      href="#collapse25"
                    >
                      Q10: When is multiple GST required?
                      <img
                        src="https://legal251.com/images/gstregistration/Path_20191.svg"
                        className="servicefaqimg"
                      />
                ...
                >
                  <div className="panel-body servicefaqbody">
                    In case of multiple state operations a person needs to take
                    multiple registrations for the same business. Therefore,
                    when new GST number of different states arrives the PAN
                    number remains the same only state code and entity code will
                    change.
                  </div>
                </div>
              </div>
      ...
      <div className="owl-stage-outer">
        ...
        >
          <div className="owl-item cloned" style={{ width: "806.603px" }}>
            <div className="clientscard clientservicemargin" data-position={1}>
              <center>
                <img
                ...
                <div className="clientscardtextdiv">
                  <p className="clientscardtext">
                    ...
                    always be counted upon. The customer service is always up to
                    the mark and the advices and solutions are always promising.
                    Within 48 hrs of the query you can have your solution in
                    your hand, and all this, just a few clicks away and inside
                    your pocket. Legal work is now on a whole different level.
                    <img
          ...
          <div className="owl-item cloned" style={{ width: "806.603px" }}>
            <div className="clientscard clientservicemargin" data-position={2}>
              <center>
                <img
                ...
                <div className="clientscardtextdiv">
                  <p className="clientscardtext">
                    ...
                    convenient and also online makes it so easy for everyone to
                    work with. If talking about quality work, they have
                    absolutely no match. A platform as big as Today's Bharat
                    required a very complete and descriptive terms of condition
                    and privacy policy. This was greatly achieved with the help
                    of experts at <br className="hidden-md" /> Legal251.
                    <img
                      src="https://legal251.com/images/about/iconmonstr-quote-5.svg"
                      className="quoteimage2"
                    />
          ...
          <div className="owl-item cloned" style={{ width: "806.603px" }}>
            <div className="clientscard clientservicemargin" data-position={3}>
              <center>
                <img
                ...
                <div className="clientscardtextdiv">
                  <p className="clientscardtext">
                    ...
                    LEGAL251. Their top priority is evident: providing the best
                    and speediest solutions. Their professionalism and expertise
                    stood out. The remarkable speed at which LEGAL251 operates
                    truly sets them apart. Their responses were prompt, and
                    packed with insightful guidance. Any queries I had were
                    addressed immediately. For those seeking legal assistance
                    that's efficient and of the highest quality, I
          ...
          <div className="owl-item active" style={{ width: "806.603px" }}>
            <div className="clientscard clientservicemargin" data-position={0}>
              <center>
                <img
                ...
                <div className="clientscardtextdiv">
                  <p className="clientscardtext">
                    <img
                      ...
                      className="quoteimage1"
                    />{" "}
                    Legal251 is the best platform for getting consultancy be it
                    in any legal domain they provide best solution for your
                    query.I am satisfied with their work. What i was expecting i
                    got it from Legal251. And I would really appreciate their
                    cooperative work and how they deal and cooperate with their
                    customers. They are the best in business as you may know.
                    There are many complications in Filing GST &amp; Income Tax
                    returns for jewellery supply &amp; design business they make
