...
const faqs = [
  {
    id: 1,
    question: "Q1. Why do I need to register at the ICEGATE portal?",
    answer:
  ...
  {
    id: 2,
    question: "Q2. What transaction type can I get registered?",
    answer:
  ...
  {
    id: 3,
    question: "Q3.Can someone change their ICEGATE ID?",
    answer:
  ...
  },
  {
    id: 4,
    question:
      "Q4. What will happen if I send the file(s) in an incorrect format?",
    answer:
      "If you send the file with an incorrect format, it will get rejected as soon as it reaches ICEGATE for processing.",
  },
  {
    id: 5,
    question: "Q5. How do I check the status of my ICEGATE registration?",
    answer:
  ...
  },
  {
    id: 6,
    question:
      "Q6. Is there any difference between the Bill of Entry and the Bill of Lading?",
    answer:
    ...
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-10 mx-5 md:mx-20 lg:mx-28 mt-10 md:mt-14">
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">View and track document’s status</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Keeps you informed</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">24/7 Help Desk</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl  p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Privacy & Security</h1>
        </div>
        ...
        <div className="bg-white shadow-lg p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">E-payment of customs duties</h1>
        </div>
        ...
        <div className="bg-white shadow-2xl p-5 rounded-[12px] cursor-pointer hover:border-[#F89327] border-2 border-transparent transition duration-300">
          ...
          <h1 className="mt-3 text-center">Electronic IGST refund</h1>
        </div>
      </div>
      ...
      <div className="hidden lg:block">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28 mt-5 md:mt-14">
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              Our experts will review all the documents submitted by you to
              diminish the probability of incorrect or misleading information to
              avoid mistakes.
            </p>
          </div>
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium ">
              ...
              to apply for your ICEGATE Registration.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mx-5 md:mx-20 lg:mx-24 xl:mx-28  mt-5">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              After acceptance of the application, your business gets registered
              with ICEGATE. We will share the application no. with you and ask
              for the temporary OTP sent on your mobile no. and Email Id to
              proceed further.
            </p>
          </div>
          <div class="flex  justify-center items-center col-span-3">
          ...
          <div className="col-span-2 bg-white border-4 border-[#01355D] rounded-full  w-52 h-52 flex items-center justify-center p-8">
            <p className="text-center text-xs font-medium">
              You can wait until one of our experts reaches out to inform you of
              the ICEAGE registration for your business.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 mx-5 md:mx-20 lg:mx-28 mt-5 md:mt-14">
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                Our experts will review all the documents submitted by you to
                diminish the probability of incorrect or misleading information
                to avoid mistakes.
              </p>
            </div>
          </div>
          ...
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                ...
                registered with ICEGATE. We will share the application no. with
                you and ask for the temporary OTP sent on your mobile no. and
                Email Id to proceed further.
              </p>
            </div>
          </div>
          ...
          <div className="col-span-2 flex items-center justify-center">
            <div className="bg-white border-4 border-[#01355D] rounded-full w-52 h-52 flex items-center justify-center p-8">
              <p className="text-center text-xs font-medium">
                You can wait until one of our experts reaches out to inform you
                of the ICEAGE registration for your business.
              </p>
            </div>
          </div>
        </div>
