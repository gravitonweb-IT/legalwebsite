...
const IcegateRegistration = () => {
  ...
  <iframe
    ...
    data-load-time={1700123009593}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/367855087?random=1700123009579&cv=11&fst=1700123009579&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Ficegate-registration&ref=https%3A%2F%2Flegal251.com%2Fgumasta-licence&label=3o2zCK68lbIDEO-LtK8B&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20ICE%20GATE%20Registration&value=0&bttype=purchase&rdp=1&auid=1629897716.1699421317&fledge=1&capi=1&uaa=x86&uab=64&uafvl=Google%2520Chrome%3B119.0.6045.125%7CChromium%3B119.0.6045.125%7CNot%253FA_Brand%3B24.0.0.0&uamb=0&uap=Windows&uapv=15.0.0&uaw=0"
    booke65m3=""
  />
  <iframe
    allow="join-ad-interest-group"
    data-tagging-id="AW-11126145977/Remarketing Tag"
    data-load-time={1700123009609}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/11126145977?random=1700123009606&cv=11&fst=1700123009606&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Ficegate-registration&ref=https%3A%2F%2Flegal251.com%2Fgumasta-licence&label=Remarketing%20Tag&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20ICE%20GATE%20Registration&auid=1629897716.1699421317&fledge=1&uaa=x86&uab=64&uafvl=Google%2520Chrome%3B119.0.6045.125%7CChromium%3B119.0.6045.125%7CNot%253FA_Brand%3B24.0.0.0&uamb=0&uap=Windows&uapv=15.0.0&uaw=0"
    booke65m3=""
  />
  <div style={{ position: "relative", overflowX: "hidden" }}>
    ...
    <a
      href="https://legal251.com/icegate-registration-hindi"
      ...
      <div className="servicemaindiv" style={{ marginTop: 7 }}>
        <div className="row">
          <div className="col-md-6">
            <p className="serviceamainheading">ICE GATE Registration</p>
            <p
              style={{
                fontFamily: '"Roboto"',
                marginTop: 18,
            ...
            >
              Register with Indian Customs Electronic Gateway or ICE GATE
              (ICEGT) for the e-filing services of your Trade, Cargo carriers
                    ...
                    <center>
                      ...
                      >
                        <option
                          className="cities"
                          data-value=""
                          data-select2-id="select2-data-2-lxh6"
                        />
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-1-gisl"
        ...
        <p className="aboutustext">
          If you are an importer/exporter worried about managing all your
          billing-related data and filing online import and export-related
          documents and want all the information in one place, then you need to
          register under ICEGATE.
          <br />
          Being an exporter/importer comes with the enormous responsibility of
          having proper records and maintaining the same. Some
          importers/exporters have a large amount of data containing files of
          bills of lading, shipping bills, bills of entry and other documents.
          <br />
          ICEGATE, or Indian Customs and Central Excise Electronic Data
          Interchange or Electronic Commerce Gateway, is an online portal that
          helps easily manage these records. Every user gets a unique ICEGATE ID
          and password, which helps to keep all records private and intact.
          <br />
          Apart from maintaining all the records and preventing the entry of any
          non-registered user, ICEGATE is also helpful to the citizens to clear
          their taxes online without spending extra time on offline payment
          methods. If you are looking for someone to help you with your ICEGATE
          Registration, your search ends here.
        </p>
        <br />
        <br />
      </div>
    ...
    <div id="Howtoapply" className="page-section">
      ...
      <center>
        <img
          src="https://legal251.com/images/nda/ICE GATE Registration.png"
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Keeps you informed </p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> 24/7 Help Desk</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Privacy &amp; Security</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">E-payment of customs duties</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Electronic IGST refund </p>
              </center>
            </div>
          </div>
        </div>
              ...
              <div className="col-md-2 Registrationprocesscol1">
                <center>
                  <p className="Registrationprocesstext1 gstrtext1">
                    Our experts will review all the documents submitted by you
                    to diminish the probability of incorrect or misleading
              ...
              <div className="col-md-2 Registrationprocesscol2">
                <center>
                  <p className="Registrationprocesstext2 gstrtext2">
                    Our best ICEGATE experts are here to help you with document
              ...
              <div className="col-md-2 Registrationprocesscol3">
                <center>
                  <p className="Registrationprocesstext3 gstrtext3">
                    ...
                    documents to apply for your ICEGATE Registration.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscol4">
                <center>
                  <p className="Registrationprocesstext4 gstrtext4">
                    After acceptance of the application, your business gets
                    registered with ICEGATE. We will share the application no.
                    with you and ask for the temporary OTP sent on your mobile
                    no. and Email Id to proceed further.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscol5">
                <center>
                  <p className="Registrationprocesstext5 gstrtext5">
                    You can wait until one of our experts reaches out to inform
                    you of the ICEAGE registration for your business.
                  </p>
                </center>
              </div>
            </div>
            ...
            <div className="col-md-6 servicefaqcol1">
              ...
              >
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse1"
                      >
                        Q1. Why do I need to register at the ICEGATE portal?
                        <img
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Without getting registered, one can not file the documents
                      online. Therefore, to enable filing online Shipping Bills
                      and Bill of Entries and other documents, it is mandatory
                      to have a registered ICAGATE ID.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse2"
                      >
                        Q2. What transaction type can I get registered?
                        <img
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Exports, Imports, IGM, EGM, and Consol Manifest, are the
                      transaction types for which you can get registered. Also,
                      for more transaction types, you can check the transaction
                      type box on the registration page at
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse3"
                      >
                        Q3.Can someone change their ICEGATE ID?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Once created, one cannot change the ICEGATE ID since it is
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse4"
                      >
                        Q4. What will happen if I send the file(s) in an
                        incorrect format?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      If you send the file with an incorrect format, it will get
                      rejected as soon as it reaches ICEGATE for processing.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse5"
                      >
                        Q5. How do I check the status of my ICEGATE
                        registration?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      You have to login into the ICEGATE website using your
                      registered ID to check the status of your submitted
                      documents.
                    </div>
                  </div>
                </div>
            ...
            <div className="col-md-6 servicefaqcol2">
              <div className="panel-group" id="accordion2">
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse21"
                      >
                        Q6.Is there any difference between the Bill of Entry and
                        the Bill of Lading?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20192.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Importers-exporters create a Bill of Entry, a document
                      with details of the item they will ship. At the same time,
                      the shippers issue a Bill of Lading with the details of
                      items they accept to ship.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse22"
                      >
                        Q7.What does it mean by customs duty?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Customs duty is a tax imposed on the transportation of
                      goods and items from international borders. The traders
                      pay this tax over the imported goods. In India, customs
                      duty was imposed under Customs Act 1962, specifying
                      various guidelines related to import-export business. The
                      ICEGATE e-payment helps pay off the customs duty online.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse23"
                      >
                        Q8.What are the types of Bill of Entry procedures in
                        India?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      There are three types of Bill of Entry procedures in
                      India: Bill of Entry for domestic/home consumption,
                      warehousing Bill of Entry, and Ex-bond Bill of Entry.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse24"
                      >
                        Q9.What is customs clearance?s
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Taking goods through customs authority accelerates cargo
                      transportation into a country (import) and outside the
                      country (export).
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse25"
                      >
                        Q10. Who can register on ICEGATE?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Anyone who is an Import Export Code (IEC) holder or F-card
                      holder can register on ICEGATE.
                    </div>
                  </div>
                </div>
              </div>
