...
<div className="wrapper">
  <iframe
    ...
    data-load-time={1700123067766}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/367855087?random=1700123067755&cv=11&fst=1700123067755&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Fimport-export-license&ref=https%3A%2F%2Flegal251.com%2Ficegate-registration&label=3o2zCK68lbIDEO-LtK8B&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20Import%20Export%20License%20(IEC)&value=0&bttype=purchase&rdp=1&auid=1629897716.1699421317&fledge=1&capi=1"
    wdv884opp=""
  />
  <iframe
    allow="join-ad-interest-group"
    data-tagging-id="AW-11126145977/Remarketing Tag"
    data-load-time={1700123067786}
    height={0}
    width={0}
    style={{ display: "none", visibility: "hidden" }}
    src="https://td.doubleclick.net/td/rul/11126145977?random=1700123067781&cv=11&fst=1700123067781&fmt=3&bg=ffffff&guid=ON&async=1&gtm=45He3b81v861892986&gcd=11l1l1l1l1&dma=0&u_w=1366&u_h=768&url=https%3A%2F%2Flegal251.com%2Fimport-export-license&ref=https%3A%2F%2Flegal251.com%2Ficegate-registration&label=Remarketing%20Tag&hn=www.googleadservices.com&frm=0&tiba=Legal251.com%20-%20Import%20Export%20License%20(IEC)&auid=1629897716.1699421317&fledge=1"
    wdv884opp=""
  />
  <div style={{ position: "relative", overflowX: "hidden" }}>
    ...
    <a
      href="https://legal251.com/import-export-license-hindi"
    ...
    <div>
      ...
      >
        ...
        <hr
          ...
          id="nav_slide_click"
          style={{ top: "-35px", height: "33.5px", marginLeft: "0%" }}
        />
      </div>
      <br />
      <br />
      <div className="servicemaindiv" style={{ marginTop: 7 }}>
        <div className="row">
          <div className="col-md-6">
            <p className="serviceamainheading">Import Export License (IEC)</p>
            <p
              style={{
                fontFamily: '"Roboto"',
                marginTop: 18,
            ...
            >
              Get your Import Export Code and kick-start or extend your
              import-export business. Let Legal251 help you get IEC so you can
              focus on your future endeavours.
            </p>
            <br />
            <a href="#formpricediv">
                ...
                <div className="row">
                    ...
                    <center>
                      ...
                      >
                        <option
                          className="cities"
                          data-value=""
                          data-select2-id="select2-data-2-nr4t"
                        />
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-1-e0hx"
                  ...
                  <div className="col-md-6">
                    <center>
                      ...
                      >
                        <sup style={{ lineHeight: "1.5" }} />₹ 1751.00
                      </p>
                      <p
                        style={{
                          fontFamily: '"Roboto"',
        ...
        <p className="aboutustext">
          Are you bracing yourself to enter into the Import-Export business?
          Then get your Import-Export License or IEC and take your first step
          towards your goal. Finding it difficult to apply for the IEC? Let us
          get it done for you.
          <br />
          An Importer-Exporter Licence (IEC Code) is a key business
          identification number and is mandatory when you import in India or
          export from India. No one is allowed to do any Import-Export business
          in India without an IEC License except the ones who fall under the
          specifically exempted category. It is a 10-digit code with lifetime
          validity, and the Director-General of Foreign Trade (DGFT), Ministry
          of Commerce, issues it. As it is the most important thing you need to
          kick-start your import-export business, you must do it in the first
          place without delay. Our experts will help you get your IEC Licence so
          that you can focus on expanding your business.
        </p>
        <br />
        <br />
      </div>
    ...
    <div id="Howtoapply" className="page-section">
      ...
      <center>
        <img
          src="https://legal251.com/images/nda/Group 1.png"
          ...
          <div className="col-md-2 col-xs-4  firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                ...
                />
                <p className="benefitscardtext"> Global Market Reach</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext"> Online Registration</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">PAN-Based Registration</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Lifetime Validity</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 firstcarddivcol">
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">No Compliance</p>
              </center>
            </div>
          </div>
        </div>
            ...
            <div className="servicebenefitscard">
              <center>
                <img
                  ...
                  className="benefitscardimg"
                />
                <p className="benefitscardtext">Legally Clean</p>
              </center>
            </div>
          </div>
          <div className="col-md-2 col-xs-4 secondcarddivcol">
              ...
              <div className="col-md-2 Registrationprocesscol1">
                <center>
                  <p className="Registrationprocesstext1 gstrtext1">
                    Our team of experts will carefully scrutinize all the
                    documents submitted by you to lessen the chances of
                    incorrect or misleading information to make the process
                    smooth.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscol2">
                <center>
                  <p className="Registrationprocesstext2 gstrtext2">
                    Our best Import-Export professionals are here to help you
              ...
              <div className="col-md-2 Registrationprocesscol4">
                <center>
                  <p className="Registrationprocesstext4 gstrtext4">
                    If your application, along with the submitted documents,
                    gets approved by the concerned department, your import
                    export business will get registered with the DGFT.
                  </p>
                </center>
              </div>
              <div className="col-md-2 Registrationprocesscol5">
                <center>
                  <p className="Registrationprocesstext5 gstrtext5">
                    ...
                    to let you know your licence is ready.
                  </p>
                </center>
              </div>
            </div>
            ...
            <div className="col-md-6 servicefaqcol1">
              ...
              >
                <div className="panel panel-default servicefaqmainpanel">
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      The IEC or Import-Export Code is a 10-digit number issued
                      by the DGFT (Director General of Foreign Trade) Department
                      of Commerce, the government of India. This registration
                      number is mandatory for traders importing or exporting
                      goods and services to or from India.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Any person or entity indulging in international trade of
                      import or export goods and services must register for an
                      IEC licence.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse3"
                      >
                        Q3. Is there a tax imposed based on IE Code?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      No. IEC is not a tax registration, so no tax is levied
                      based on the IE code during importing or exporting goods
                      and services. However, there might be customs duty
                      applicable depending upon the services.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse4"
                      >
                        Q4. Can individuals obtain IE code?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Anyone who is or acting as a sole proprietor of a business
                      can obtain an IEC licence.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      No. IEC Licence is not mandatory for all. Only importers
                      and exporters of goods and services must have it. Hence,
                      there’s no such penalty for not having an IE code, but
                      import/export is impossible without obtaining an IEC
                      licence.
                    </div>
                  </div>
                </div>
            ...
            <div className="col-md-6 servicefaqcol2">
              <div className="panel-group" id="accordion2">
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse21"
                      >
                        Q6. For how long is the IE code valid?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20192.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      The IE code is valid for life ( of the entity), and
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse22"
                      >
                        Q7. How much time does it take to obtain the IE code in
                        India?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      With Legal251, one can obtain the IEC registration in 3-5
                      working days from DGFT after submitting all required
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse23"
                      >
                        Q8. Does the customs department use IEC?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      Yes. The IEC number is visible in all customs documents
                  ...
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse24"
                      >
                        Q9. Do I need to file any returns for IE Code?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                ...
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse25"
                      >
                        Q10. How can someone cancel their IEC licence?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
                  ...
                  >
                    <div className="panel-body servicefaqbody">
                      One must initiate a formal request to the DGFT online to
                      cancel the IEC. After receiving such information, the
                      authorities will cancel it electronically.
                    </div>
                  </div>
                </div>
                <div className="panel panel-default servicefaqmainpanel">
                  <div className="panel-heading servicefaqpanelheading">
                    <h4 className="panel-title">
                      <a
                        ...
                        href="#collapse26"
                      >
                        Q11. How many IECs can a person get?
                        <img
                          src="https://legal251.com/images/gstregistration/Path_20191.svg"
                          className="servicefaqimg"
                        />
